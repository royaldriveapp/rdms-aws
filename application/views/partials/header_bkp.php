     ...
     <div class="left_col scroll-view">
          ...
          <div class="profile clearfix">
               ...
               <div class="profile_info">
                    <span>Welcome,</span>
                    <h2><?php echo $this->session->userdata('usr_username'); ?></h2>
               </div>
          </div>
          <!-- /menu profile quick info -->
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
               <div class="menu_section">
                    ...
                    <ul class="nav side-menu">
                         ...
                         <?php } if (can_access_module('investors')) { ?>
                         ...
                         if (can_access_module('enquiry') || can_access_module('customer_grade')) { ?>
                              <li><a><i class="fa fa-cab"></i> Enquiry <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        <?php } if (check_permission('booking', 'index')) { ?>
                                             <li><a href="<?php echo site_url('booking/index'); ?>"> Booking enquires
                                                       <?php echo !empty($analytics['count_sale_req']) ? '<span class="label label-success pull-right">' . $analytics['count_sale_req'] . '</span>' : ''; ?>
                                                 </a>
                                             </li>
                                        <?php } if (check_permission('booking', 'deliverdvehicle')) { ?>
                                             <li><a href="<?php echo site_url('booking/deliverdvehicle/40'); ?>">Deliverd vehicle</a></li>
                                        <?php } if (check_permission('enquiry', 'courtesycalllist')) { ?>
                                             <li><a href="<?php echo site_url('enquiry/courtesycalllist'); ?>">Courtesy Call List</a></li>
                                        <?php } ?>
                                   </ul>
                              </li>
                         <?php
                              ...
                              <li><a><i class="fa fa-calendar-check-o"></i> Followup <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        /* if (check_permission('followup', 'running')) {
                                            ...
                                            <?php echo!empty($analytics['count_running_followup']) ? '<span class="label label-success pull-right">' . $analytics['count_running_followup'] . '</span>' : '';?></a></li>
                                            <?php
                                            } */
                         ...
                         <?php } if (can_access_module('insurance')) { ?>
                              <li><a><i class="fa fa-bar-chart"></i> Insurance <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        <?php } if (check_permission('insurance', 'stockvehicle')) { ?>
                                             <li><a href="<?php echo site_url('insurance/stockVehicle'); ?>">Stock Vehicles</a></li>
                                        <?php } ?>
                                   </ul>
                              </li>
                         <?php } if (can_access_module('evaluation')) { ?>
                              <li><a><i class="fa fa-eye"></i> Evaluate <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        <?php }
                                        if (check_permission('evaluation', 'add')) { ?>
                              ...
                              <li><a><i class="fa fa-bar-chart"></i> Reports <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        <?php if (check_permission('reports', 'quickVehicleSearch')) { ?>
                                             <li><a href="<?php echo site_url('reports/quickVehicleSearch'); ?>">Quick Vehicle Search</a></li>
                                        <?php }
                                        ...
                                        if (check_permission('reports', 'enquiries')) { ?>
                                             <li><a href="<?php echo site_url('reports/enquiries'); ?>">Inquiries (Vehicle based)</a></li>
                                        <?php }
                                        if (check_permission('reports', 'enquiries_enq')) { ?>
                                             <li><a href="<?php echo site_url('reports/enquiries_enq'); ?>">Inquiries (Inquiry based)</a></li>
                                        <?php }
                                        ...
                                        <?php }
                                        if (check_permission('reports', 'homevisitneeded')) { ?>
                                             <!--  <li><a href="<? php // echo site_url('reports/homeVisitNeeded');
                                                                 ?>">Home Visit Needed</a></li>-->
                                             <?php if (can_access_module('home_visit_report')) { ?>
                                                  <li><a href="<?php echo site_url('followup/home_visit_report'); ?>"> Home visit Report<?php } ?>
                                                       </a></li>
                                             <?php }
                                        ...
                                        if (check_permission('reports', 'voxbaydailyreport')) { ?>
                                                  <li><a href="<?php echo site_url('reports/voxbayDailyReport'); ?>">Voxbay daily report</a></li>
                                             <?php }
                                        if (check_permission('reports', 'quickenquiryfedBack')) { ?>
                                                  <li><a href="<?php echo site_url('reports/quickEnquiryFedBack'); ?>">Quick followup report</a></li>
                                             <?php }
                                        if (check_permission('reports', 'voxbaypunchreprt')) { ?>
                                                  <li><a href="<?php echo site_url('reports/voxbayPunchReprt'); ?>">Voxbay punch report</a></li>
                                             <?php }
                                        if (check_permission('reports', 'telcalrperformancereport')) { ?>
                                                  <li><a href="<?php echo site_url('reports/telcalrperformancereport'); ?>">Telecaller performance report</a></li>
                                             <?php }
                                        if (check_permission('reports', 'registerpendingreport')) { ?>
                                                  <li><a href="<?php echo site_url('reports/registerPendingReport'); ?>">Register pending report</a></li>
                                             <?php }
                                        ...
                                        if (check_permission('reports', 'enquiry_pool_list')) { ?>
                                                  <li><a href="<?php echo site_url('reports/enquiry_pool_list'); ?>">Vehicle demand report</a></li>
                                             <?php }
                                        if (check_permission('reports', 'stockagainstvehicle')) { ?>
                                                  <li><a href="<?php echo site_url('reports/stockagainstvehicle'); ?>">Stock against enquiry</a></li>
                                             <?php } ?>
                                   </ul>
                              </li>
                         <?php
                              ...
                              <li><a><i class="fa fa-bus"></i> Website Vehicle <span class="fa fa-chevron-down"></span></a>
                                   <ul class="nav child_menu">
                                        ...
                                        if (check_permission('product', 'upldphotostockvehicle')) { ?>
                                             <li><a href="<?php echo site_url('product/upldphotostockvehicle'); ?>">Update stock images</a></li>
                                        <?php }
                              ...
                              <li>
                                   ...
                                   <ul class="nav child_menu">
                                        ...
                                        if (check_permission('registration', 'waitingforreply')) { ?>
                                             <li><a href="<?php echo site_url('registration/waitingforreply/'); ?>">Waiting for reply</a></li>
                                        <?php }
                                        if (check_permission('registration', 'informstocktocustomer')) { ?>
                                             <li><a href="<?php echo site_url('registration/informStockToCustomer'); ?>">Stock matching register</a></li>
                                        <?php }
                                        if (check_permission('registration', 'reassignedregisters')) { ?>
                                             <li><a href="<?php echo site_url('registration/reassignedregisters'); ?>">Reassigned registers</a></li>
                                        <?php }
                                        if (check_permission('registration', 'droppedregisters')) { ?>
                                             <li><a href="<?php echo site_url('registration/droppedregisters'); ?>">Dropped registers</a></li>
                                        <?php } ?>
                                   </ul>
                              </li>
                         <?php
                         ...
                         if (
                              can_access_module('tools') || can_access_module('divisions') ||
                              ...
                              <li>
                                   ...
                                   <ul class="nav child_menu">
                                        <?php if (check_permission('tools', 'sendWhatsAppMessage')) { ?>
                                             <li><a href="<?php echo site_url('tools/sendWhatsAppMessage'); ?>">Send WhatsApp Message</a></li>
                                        <?php }
                              ...
                              <li>
                                   ...
                                   <ul class="nav child_menu">
                                        <?php if (check_permission('analytics', 'enquirydroppedpulse')) { ?>
                                             <li><a href="<?php echo site_url('analytics/enquirydroppedpulse'); ?>">Dropped cases</a></li>
                                        <?php } ?>
                                   </ul>
                              </li>
                         <?php } ?>
     ...
     <div class="nav_menu">
          <nav>
               <div class="nav toggle" style="width: 50%;float: left;">
                    ...
                    <?php } if (check_permission('registration', 'eventlistener')) { ?>
               ...
               <ul class="nav navbar-nav navbar-right" style="width: 50%;">
                    <li class="">
                         ...
                         <ul class="dropdown-menu dropdown-usermenu pull-right">
                              <li><a href="<?php echo site_url('emp_details/updateProfile/' . encryptor($this->uid)); ?>"> Profile</a></li>
                              <!-- <li>
                                   <a href="javascript:;">
                    ...
                    /* $recentEnquires = $this->common_model->recentEnquiry();
                        ...
                        <span class="message">
                        <a href="<?php echo site_url('enquiry/view/' . encryptor($enq['enq_id']));?>">Added By : <?php echo $enq['enq_added_by_name'];?></a>
                        </span>
                        </li>
                        <?php
                        }
                    ...
                    if (check_permission('notification', 'upcommingfollowup')) {
                         ...
                         ?>
                              <li role="presentation" class="dropdown">
                                   <a title="Pending DAR verification" href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <span class="badge bg-green"><?php echo count($TLDARforApproval); ?></span>
                                   </a>
                                   <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu" style="height: 233px;overflow-y: scroll;">
                                        <?php
                                        /* foreach ((array) $TLDARforApproval as $key => $enq) {
                                            ...
                                            <span class="message">
                                            <a href="<?php echo site_url('dar/verifydar/' . encryptor($enq['darm_id']));?>">Submitted on : <?php echo date('j M Y', strtotime($enq['darm_added_on']));?></a>
                                            </span>
                                            </li>
                                            <?php
                                            } */
                    ...
                    /*if (check_permission('customer_grade', 'custgrdpendingnotification')) {
                           ...
                           if (!empty($pendingNotification)) {
                                ?>
                                <li role="presentation" class="dropdown">
                                     <a title="Pending customer grade verification" href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                                     ...
                                     <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu" style="height: 233px;overflow-y: scroll;">
                                          ...
                                          foreach ((array) $pendingNotification as $key => $enq) {
                                               ?>
                                               <li>
                                                    <a href="<?php echo site_url('customer_grade/verificationView/' . encryptor($enq['enq_id']));?>">
                                     ...
                                     <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu" style="height: 233px;overflow-y: scroll;">
                                          ...
                                          foreach ((array) $assignedEnquires as $key => $enq) {
                                               ...
                                               <li>
                                                    ...
                                                    <span class="message">
                                                         <a href="<?php echo site_url('enquiry/view/' . encryptor($enq['enq_id']));?>">
                                                              <?php echo 'Assigned by ' . $enq['enq_added_by_name'];?></a>
                                                    </span>
                                               </li>
                                               <?php
                                          }
...
?>
          <div class="alert alert-success alert-dismissible fade in msgBox" role="alert" style="max-height: 500px;overflow-y: scroll;background-color: rgba(12, 12, 12, 0.88);border-color: rgba(12, 12, 12, 0.88);">
               <div style="margin-bottom: 20px;border-bottom: 2px solid;">
                    <strong>Pending Contact to punch enquiry <?php echo isset($alerts['pendingRegisters']) ? ' (' . count($alerts['pendingRegisters']) . ')' : 0; ?></strong>
