<?php
  ...
  class Excel {
       ...
       private $excel;
       private $excelLocation = "assets/uploads/export/";
       ...
       public function stream($filename, $data = null) {
            ...
            $objWriter = PHPExcel_IOFactory::createWriter($this->excel, 'Excel5');
            $objWriter->save($this->excelLocation . "$filename");
            header("location: " . base_url() . $this->excelLocation . "$filename");
            unlink(base_url() . $this->excelLocation . "$filename");
       }
