...
<?php if (check_permission('evaluation_new', 'update')) { ?>
                                                       <ul class="dropdown-menu" role="menu">
                                                            <li><a target="blank" href="<?php echo site_url('evaluation_new/view/' . encryptor($vehicles['val_id'])); ?>">Edit</a>
                                                            </li>
                                                       </ul>
<?php } ?>
                                             </li>
...
<?php if (check_permission('evaluation_new', 'showplacetimerefer') || is_roo_user() || ($vehicles['val_added_by'] == $this->uid)) { ?>
                                                       <tbody>
                                                            <tr>
                                                                 <td>Purchase type</td>
                                                                 <td>
...
<?php if (!empty($vehicles['val_acc_history_remarks'])) { ?>
                                                       ...
                                                       if (check_permission('evaluation_new', 'updatedocumentdetails') && !empty($vehicles['val_document_details'])) {
                                                            ?>
                                                            <tr>
...
<?php echo ($vehicles['val_battery_warranty'] == 1) ? 'YES' : 'NO'; ?>
                                             ...
                                             <!-- -->
<?php if (check_permission('evaluation_new', 'showrefurbdetails') || is_roo_user() || ($vehicles['val_added_by'] == $this->uid)) { ?>
                                                  <table class="table table-striped">
                                                       <thead>
                                                            <tr>
    ...
    <div class="panel panel-default">
                                   ...
                                   <table class="wrp table table-striped table-bordered bg-clr "  id="table_detail">
                                        <thead style="background-color: gray; color: white;">
                                             <tr class="hdr singleline">
                                                  <?php if ((check_permission('evaluation_new','viewrefurbreqs'))) {?>   <th class="lbl-blk">  </th> <?php }?>
     ...
     <!---@pnl--->                             
                                   <div class="page" id="printRefrb">
                                         <?php  if (check_permission('evaluation_new','can_see_refurb_job_added_by_other_staff')){?>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                             <div class="x_panel">
                                                  <button type="submit" class="btn btn-info no-print" id="printBtn_rfrb"><i class="fa fa-print" style="color:white"></i> Print</button>
                                                  <a href="<?php echo site_url('evaluation_new/refurbisheReturn/' . encryptor($vehicles["val_id"])) ?>" 
...
<?php $description = isset($result['masterData']['pcl_description']) ? json_decode($result['masterData']['pcl_description']) : ''; ?>
                                             ...
                                             <div class="row">
                                                  <form action="<?php echo site_url('checklist/add_purchase_check_list'); ?>" 
                                                        method="post" class="x_content frmNewValuation" id="chk_list_form" data-url="<?php echo site_url('evaluation_new/add_purchase_check_list'); ?>">
                                                       <div class="row">
                                                            <div class="col-md-12 col-sm-12 col-xs-12">
...
<?php echo $vehicles['mod_title'] . ' ' . $vehicles['var_variant_name']; ?></h5></center>  
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                             <div class="x_panel">
<?php echo form_open_multipart("evaluation_new/add_offer_price", array('id' => "frmOfferPrice", 'class' => "frmOfferPrice form-horizontal form-label-left")) ?>
      ...
      function load_rf_approved_reqs(page)
          {
               ...
               $.ajax({
                    url: "<?php echo site_url('evaluation_new/approved_refurb_reqs');?>/" + page,
                    method: "POST",
                    dataType: "JSON",
                   // data: form.serialize(),
