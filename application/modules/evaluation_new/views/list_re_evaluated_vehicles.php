               ...
               <div class="x_panel">
                    ...
                    <p>
                         <a class="btn btn-primary" data-toggle="collapse" href="#multiCollapseExample1" 
                          ...
                          <a class="btn btn-primary"  href="<?php echo site_url('evaluation/reEvaluation').'/'.encryptor($val_id, 'E');?>" 
                            ><i class="fa fa-plus-circle"></i> ADD
                         </a>
                         <a class="btn btn-primary"  href="<?php echo site_url('evaluation/compare').'/'.encryptor($val_id, 'E');?>" 
                            ><i class="fa fa-sliders"></i> Compare
                         </a>
                    </p>
                    <div class="row">
                         <div class="col">
                                   ...
                                   <div class="card card-body">
                                        <form class="x_content frmValuationFilter">
                                             <div style="float: left;width: 100%;">
                                                  <input name="val_id" type="hidden" value="<?php echo $val_id;?>">
     ...
     function valuationList(canDelete, frmData) {
         ...
         // alert(enqStstus);
          ...
          $('#tblValuation').DataTable({
               ...
               "ajax": {
                    "type": "POST",
                    "url": site_url + "evaluation/re_evaluation_ajax?" + frmData
               },
               "columnDefs": [
                    {
                         "targets": [0],
