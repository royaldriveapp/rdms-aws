                                   ...
                                   <div id="step-1" class="step-1">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <select required="true" <?php echo ($readOnly == 1) ? 'disabled' : '';?> 
                                                                    class="select2_group form-control" name="valuation[val_added_by]" id="val_added_by">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required data-url="<?php echo site_url('enquiry/bindVarient');?>" 
                                                                    ...
                                                                    name="valuation[val_model]" id="val_model"><option value="">Select brnad first</option></select>
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="chk-container" style="float: left;width: 100%;">
                                                  ...
                                                  <i style="cursor: pointer;" type="button" class="fa fa-plus" data-toggle="modal" data-target="#exampleModal"></i></h3>
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td colspan="4">
                                                                 <input type="text" class="form-control dtpDatePickerEvaluation" style="width: 100%;" 
