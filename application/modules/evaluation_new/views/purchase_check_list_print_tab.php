     ...
     <div class="page" id="printDiv">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <a href="<?php echo site_url('evaluation/edit_purchase_check_list/1/' . $result["masterData"]["pcl_val_id"]) . '/' . $result['masterData']['pcl_check_list_id'] ?>" class="btn btn-info no-print" id="edit_btn" style="float: right;"><i class="fa fa-edit" style="color:White"></i> Edit</a>
                    <div class="x_title">
                    ...
                    <div class="x_content">
                         <div class="chk-container" style="float: left;width: 100%;">
                              ...
                              <span class="float-right">
                                   ...
                                   ?>
                                   <p><h5><b>Purchase type: <?php echo isset($purchaseTypes[$purchase_type]) ? $purchaseTypes[$purchase_type] : ''; ?></b></h5></p>
                                   <p>DOC NO: </p>
               ...
               <div class="row">
                    <form action="<?php echo site_url('checklist/add_purchase_check_list'); ?>" method="post" class="x_content frmNewValuation" 
                          id="chk_list_form" data-url="<?php echo site_url('evaluation/add_purchase_check_list'); ?>">
...
<style>
     ...
     .toptable>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th {
          padding: 8px;
          line-height: 1.777;
          vertical-align: top;
