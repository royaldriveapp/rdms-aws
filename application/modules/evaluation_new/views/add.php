...
<div class="right_col" role="main">
  ...
  ?>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       <label class="control-label col-md-4 col-sm-3 col-xs-12">Manager (PM/SM)</label>
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="row">
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select class="select2_group form-control" name="valuation[val_mis]" id="val_mis">
                                                                      <option value="0">Select MIS</option>
                                                                      <?php
                                                                      if (!empty($mis)) {
                                                                           foreach ($mis as $key => $value) {
                                                                                ?>
                                                                                <option value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' ' . $value['usr_last_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                                      ?>
                                                  ...
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            <label class="control-label col-md-4 col-sm-3 col-xs-12">Delivery Coordinator</label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select required class="select2_group form-control" name="valuation[val_delco]" id="val_manager">
                                                                      <option value="">Select Delivery Coordinator</option>
                                                                      <?php
                                                                      if (!empty($delco)) {
                                                                           foreach ($delco as $key => $value) {
                                                                                ?>
                                                                                <option value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_first_name'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                                <?php
                                                                           }
                                                                      }
                                                                      ?>
                                                                      <option <?php echo ($this->uid == 844) ? 'selected="selected"' : '';?> value="844">Ronish Jose (Ernakulam)</option>
                                                                 </select>
                                                            </div>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_cust_phone]" 
                                                                    data-url="<?php echo site_url('evaluation_new/matchingInquiry'); ?>" required id="val_cust_phone" placeholder="Phone Number"/>
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
...
<input type="text" class="form-control col-md-7 col-xs-12 numOnly " name="referal_phone3" id="referal_phone3"
                           ...
                           autocomplete="off" placeholder="Referal phone"/>
                                        ...
                                        <div class="col-sm-6">
                                                  <div class="form-group">
                                                       <label class="control-label col-md-4 col-sm-3 col-xs-12">Initial delivery state</label>
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12"
                                                                   name="valuation[val_first_dlvry_state]" id="val_reference" placeholder="Initial delivery state"/>
                                                       </div>
                                                  </div>
                                             </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       <label class="control-label col-md-4 col-sm-3 col-xs-12">First delivery location</label>
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12"
                                             ...
                                             <div class="col-sm-6">
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select required class="select2_group form-control" name="valuation[val_admin]" id="val_admin">
                                        ...
                                        <div class="row"> 
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            <label class="control-label col-md-4 col-sm-3 col-xs-12">Purchase admin</label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select class="select2_group form-control" name="valuation[val_purchase_admin]" id="val_purchase_admin">
                                                  ...
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select class="select2_group form-control" name="valuation[val_apm_asm]" id="val_apm_asm">
                                             ...
                                             <div class="row"> 
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select class="select2_group form-control" name="valuation[val_tele_caller]" id="val_tele_caller">
                                                  ...
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            <label class="control-label col-md-4 col-sm-3 col-xs-12">Tele Purchase Coordinator</label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select class="select2_group form-control" name="valuation[val_tsc]" id="val_tsc">
                                             ...
                                             <div class="col-sm-12">
                                                  <div class="form-group">
                                                       <label class="control-label col-md-2 col-sm-3 col-xs-12">RC owner name</label>
                                                       <div class="col-md-9 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12"
                                                                   name="valuation[val_rc_owner]" id="val_rc_owner" placeholder="RC owner name"/>
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 numOnly" 
                                                                   placeholder="No.of Owner(s)" type="number" name="valuation[val_no_of_owner]" id="val_no_of_owner">
                                                       </div>
                                                  </div>
                                             </div>
                                             <!--                                             <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                                  <div class="form-group">
                                                       <label class="control-label col-md-4 col-sm-3 col-xs-12">Cubic Capacity</label>
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12" name="valuation[val_eng_cc]" 
                                                                  required id="val_eng_cc" placeholder="Cubic Capacity"/>
                                                       </div>
                                                  </div>
                                             </div>
                                             <!-- <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 numOnly" 
                                                                   placeholder="No.of Seats"  type="number" name="valuation[val_no_of_seats]" id="val_no_of_seats">
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_km]" 
                                       ...
                                       <!-- new -->
                                        ...
                                        <div class="row">
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tr>
                                                       <td>Comprehensive</td>
                                                       <td><input placeholder="Valid UP to (comprehensive)" type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" name="valuation[val_insurance_comp_date]"/></td>
                                                       <td><input placeholder="IDV Value (comprehensive)" type="text" class="form-control col-md-7 col-xs-12 decimalOnly" name="valuation[val_insurance_comp_idv]"/></td>
                                                  </tr>
                                                  <tr>
                                                       <td>Limited Liability</td>
                                                       <td><input placeholder="Limited Liability (Limited Liability)" type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" name="valuation[val_insurance_ll_date]"/></td>
                                                       <td><input placeholder="NCB" type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_insurance_ll_idv]"/></td>
                                                  </tr>
                                                  <tr>
                                                       <td>NCB need by Customer</td>
                                                       <td><input value="1" type="checkbox" name="valuation[val_insurance_need_ncb]"/></td>
                                                       <td>
...
<div class="col-sm-6">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 decimalOnly txtValHypoLoanAmt" 
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 decimalOnly txtValHypoFrclosVal" 
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="number" class="form-control col-md-7 col-xs-12 decimalOnly txtValHypoDailyInt" 
                                        ...
                                        <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <input name="valuation[val_last_service_km]" id="val_last_service_km" type="number" class="form-control numOnly" style="width: 100%;"/>
                                                            </td>
                                                       </tr>
                                                       ...
                                                       <tr class="tdNxtSerDtKM" style="display: none;">
                                                            ...
                                                            <td colspan="2">
                                                                 <input type="number" class="form-control numOnly" style="width: 100%;" id="val_next_service_km" 
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><input type="number" class="form-control numOnly txtNextServiceDays" 
                                                                       ...
                                                                       placeholder="Next service in days" name="valuation[val_next_serv_days]"/></td>
                                                            <td colspan="4">
                                                                 <input type="text" class="form-control dtpDatePickerEvaluation txtNxtServiceDate" style="width: 100%;" 
                                                                        placeholder="Next service date" name="valuation[val_next_serv_date]"/>
                                                            </td>
                                                            <td colspan="3">
                                                                 <input type="number" class="form-control" style="width: 100%;" id="" 
                                                                        placeholder="Next service KM" name="valuation[val_next_serv_km]"/>
                                                            </td>
                                                       </tr>
                                                  </tbody>
                                             </table>
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>
                                                            <input class="form-control numOnly" type="number"  name="valuation[val_battery_year]" placeholder="Year"/>
                                                            </td>
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody class="tbDamages">
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td colspan="2">
                                                                 <input class="form-control decimalOnly" style="width: 50%;float: left;" type="number" name="valuation[val_suspt_purchase_price]" placeholder="Suspected purchase price" id="val_suspt_purchase_price"/>
                                                                 <input class="form-control decimalOnly" style="width: 50%;float: left;"type="number" name="valuation[val_suspt_price_road_tax]" placeholder="Road tax" id="val_suspt_prs_road_tax"/>
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> New Vehicle Price</td>
                                                            <td colspan="2">
                                                                 <input placeholder="New Vehicle Price" class="decimalOnly form-control" type="number" name="valuation[val_new_vehicle_price]" id="val_new_vehicle_price">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> Best Market sale Price</td>
                                                            <td colspan="2">
                                                                 <input placeholder="Best Market sale Price" class="decimalOnly form-control" type="number" name="valuation[val_price_market_est]" id="val_price_market_est">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> Refreshment Cost</td>
                                                            <td colspan="2">
                                                                 <input placeholder="Refreshment Cost" class="decimalOnly form-control" type="number" name="valuation[val_refurb_cost]" id="val_refurb_cost">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> Adj For Condition +/-</td>
                                                            <td colspan="2">
                                                                 <input placeholder="Adj For Condition +/-" class="decimalOnly form-control" type="number" name="valuation[val_adj_ond_pm]" id="val_adj_ond_pm">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> Profit</td>
                                                            <td colspan="2">
                                                                 <input placeholder="Profit" class="decimalOnly form-control" type="number" name="valuation[val_profit]" id="val_profit">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head"> Trade in Price</td>
                                                            <td colspan="2">
                                                                 <input placeholder="Trade in Price" class="decimalOnly form-control" type="number" name="valuation[val_trade_in_price]" id="val_trade_in_price">
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td colspan="3">
