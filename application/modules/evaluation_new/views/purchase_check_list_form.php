     ...
     <div class="row">
          <div class="page" id="printDiv">
               <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                         <form action="<?php echo site_url('evaluation_new/add_purchase_check_list');?>" method="post"
                                                              ...
                                                              <tr>
                                                                   ...
                                                                   <td>
                                                                        ...
                                                                        <input type="checkbox" name="item[<?php echo $value->chitem_id;?>][yn]"
                                                                               ...
                                                                               value="<?php echo $value->chitem_id;?>">


                                                                   </td>
                                                                   <td><input placeholder="Enter Remarks" type="text"
          ...
          $.ajax({
               ...
               success: function (data) {
                    ...
                    if (data.status == "success") {
                         ...
                         $('.msgBox').show();
                         setTimeout(function () {
                              window.location.replace(site_url + "evaluation_new/purchase_check_list_print/" + data.check_listMasterId);
                         }, 1500);
                    } else {
                         $('.ErrorMsgBox').show();
                    }
