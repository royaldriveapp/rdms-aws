...
<script>
     ...
     function valuationList(canDelete, frmData) {
          ...
          var updateEvalUrl = "<?php echo site_url('evaluation_new/view');?>";
               ...
               'columns': [
                    ...
                    ,
                    {
                         ...
                         "mRender": function (data, type, row) {
                              ...
                              return '<a class="prnt-btn tip" href="' + updateEvalUrl + '/' + data.val_id + '"><i class="fa fa-bar-chart ficon"></i><span> Evaluate Vehicle </span></a>';
