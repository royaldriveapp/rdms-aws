...
<script>
     ...
     function valuationList(canDelete, frmData) {
        //  alert(5465);
          ...
          //var reEvaluationUrl = "<?php echo site_url('evaluation_new/reEvaluation'); ?>"  ;
          var reEvaluationUrl = "<?php echo site_url('evaluation_new/re_evaluated'); ?>";
          var compareUrl = "<?php echo site_url('evaluation_new/compare'); ?>";
