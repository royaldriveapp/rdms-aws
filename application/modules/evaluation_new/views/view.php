                         ...
                         <ul class="nav navbar-right panel_toolbox">
                              <li class="dropdown" style="float: right;">
                                   ...
                                   <ul class="dropdown-menu" role="menu">
                                        <li><a target="blank" href="<?php echo site_url('evaluation_new/refurbisheReturn/' . encryptor($vehicles['val_id'])); ?>">Refurbish job</a></li>
                                        <li><a target="blank" href="<?php echo site_url('evaluation_new/printevaluation_new/' . encryptor($vehicles['val_id'])); ?>">Print evaluation</a></li>
                                   </ul>
                              </li>
                         </ul>
                              ...
                              <div>
                                   <div id="step-1" class="">
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="select2_group form-control cmbBindShowroomByDivision" name="valuation[val_division]" id="vreg_division" data-url="<?php echo site_url('enquiry/bindShowroomByDivision'); ?>" data-bind="cmbShowroom" data-dflt-select="Select Showroom">
                                                                 <option value="">Select division</option>
                                                                 <?php
                                                                 foreach ($division as $key => $value) {
                                                                 ?>
                                                                      <option <?php echo ($vehicles['val_division'] == $value['div_id']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['div_id']; ?>"><?php echo $value['div_name']; ?></option>
                                                                 <?php
                                                                 }
                                                                 ?>
                                                            </select>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select id="cmbRegisterAssignTo" class="cmbRegisterAssignTo select2_group form-control enq_se_id" name="valuation[val_sales_officer]">
                                                                 <option value="">Select executive</option>
                                                                 <?php foreach ($salesExe as $key => $value) { ?>
                                                                      <option <?php echo ($slsOficer == $value['usr_id']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['usr_id']; ?>"><?php echo $value['usr_username']; ?></option>
                                                                 <?php } ?>
                                                            </select>
                                                       </div>
                                                  </div>
                                        ...
                                        <div class="row">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="select2_group form-control cmbShowroom" name="valuation[val_showroom]" id="val_showroom">
                                                                 <?php foreach ($showroom as $key => $value) { ?>
                                                                      <option <?php echo ($vehicles['val_showroom'] == $value['shr_id']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['shr_id']; ?>"><?php echo $value['shr_location']; ?></option>
                                                                 <?php } ?>
                                                            </select>
                                                       </div>
                                                  </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerDMY" value="<?php
                                        ...
                                        <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <select <?php //echo ($readOnly == 1) ? 'disabled' : '';      
                                                                 ...
                                                                 ?>
                                                                           <option <?php echo ($vehicles['val_evaluator'] == $value['col_id']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['col_id']; ?>"><?php echo $value['col_title']; ?></option>
                                                                 <?php
                                                                      }
                                                                 }
                                                                 ?>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $vehicles['val_location']; ?>" name="valuation[val_location]" id="val_location" placeholder="Evaluation Location" />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="select2_group form-control" name="valuation[val_manager]" id="val_manager">
                                                                 ...
                                                                 ?>
                                                                           <option <?php echo ($vehicles['val_manager'] == $value['col_id']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['col_id']; ?>"><?php echo $value['col_title'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                 <?php
                                                                      }
                                                                 }
                                                                 ?>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-4 col-xs-6 hourPicker" style="width: 50%;" value="<?php echo $vehicles['val_in_time']; ?>" name="valuation[val_in_time]" id="val_in_time" placeholder="IN Time" />

                                                            <input type="text" class="form-control col-md-4 col-xs-6 hourPicker" style="width: 50%;" value="<?php echo $vehicles['val_out_time']; ?>" name="valuation[val_out_time]" id="val_out_time" placeholder="Out Time" />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_cust_name]" value="<?php echo $vehicles['val_cust_name']; ?>" required id="val_cust_name" placeholder="Customer Name" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_cust_phone]" value="<?php echo $vehicles['val_cust_phone']; ?>" required id="val_cust_phone" placeholder="Phone Number" />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-4 col-xs-6" value="<?php echo $vehicles['val_cust_email']; ?>" placeholder="Email" name="valuation[val_cust_email]" id="val_cust_email" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required="" class="select2_group form-control" name="valuation[val_type]" id="val_fuel">
                                                                 ...
                                                                 <?php foreach (unserialize(EVALUATION_TYPES) as $key => $value) { ?>
                                                                      <option <?php echo ($vehicles['val_type'] == $key) ? 'selected="selected"' : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                                                 <?php } ?>
                                                            </select>
                                                       </div>
                                                  </div>
                                        ...
                                        <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="select2_group form-control cmbModeOfContact" name="valuation[val_cust_source]">
                                                                 ...
                                                                 ?>
                                                                      <option <?php echo ($vehicles['val_cust_source'] == $key) ? 'selected="selected"' : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                                                 <?php
                                                                 }
                                                                 ?>
                                                            </select>
                                             ...
                                             <div class="col-sm-6">
                                                  ...
                                                  ?>
                                                  <div class="form-group referal_type" <?php echo ($vehicles['val_cust_source'] != 30) ? 'style="display: none"' : ''; ?>>
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="form-control col-md-7 col-xs-12 referal_type" name="valuation[val_refferal_type]">
                                                                 ...
                                                                 <?php foreach (unserialize(REFERAL_TYPES) as $key => $value) { ?>
                                                                      <option value="<?php echo $key; ?>" <?php echo $vehicles['val_refferal_type'] == $key ? 'selected' : '' ?>> <?php echo  $value; ?> </option>
                                                                 <?php } ?>
                                                            </select>
                                                       </div>
                                                  </div>
                                        ...
                                        <div class="rfrl_div" <?php echo ($vehicles['val_cust_source'] != 30) ? 'style="display: none"' : ''; ?>>
                                             <div class="row" <?php echo $vehicles['val_refferal_type'] == 4 ? '' : ' style="display: none"'  ?> id="referal_details">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 ...
                                                                 <select id="referalRdStaffs" class="referalRdStaffs select2_group form-control staff_select" name="referal_name1">
                                                                      <?php foreach ($rdStaffs as $value) { ?>
                                                                           <option data-phone="<?php echo $value['satff_phone'] ?>" value="<?php echo $value['col_id']; ?>" <?php echo $vehicles['val_refferer_name'] == $value['col_id'] ? 'selected' : '' ?>><?php echo $value['col_title'] . ' (' . $value['shr_location'] . ')'; ?></option>
                                                                      <?php } ?>
                                                  ...
                                                  <div class="col-sm-6 ">
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 ...
                                                                 <input type="text" class="form-control col-md-7 col-xs-12 numOnly " value="<?php echo $vehicles['val_refferal_phone'] ?>" name="referal_phone1" id="referal_phone1" autocomplete="off" placeholder="Referal phone" />
                                                            </div>
                                                       </div>
                                                  </div>
                                             ...
                                             <div class="row" <?php echo $vehicles['val_refferal_type'] == 5 ? '' : ' style="display: none"'  ?> id="referal_details2">
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            <label class="control-label col-md-4 col-sm-3 col-xs-12">Referal Name</label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <input type="text" value="<?php echo $vehicles['val_refferer_name'] ?>" class="form-control col-md-7 col-xs-12" name="referal_name2" id="referal_customer_name" autocomplete="off" placeholder="Referal Name" />
                                                            </div>
                                                       </div>
                                                  </div>
                                                  <div class="col-sm-6">
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 ...
                                                                 <input type="text" class="form-control col-md-7 col-xs-12 numOnly customer_phone" value="<?php echo $vehicles['val_refferal_phone'] ?>" name="referal_phone2" id="customer_phone" data-url="<?php echo site_url('registration_1/customerByPhone'); ?>" autocomplete="off" placeholder="Referal phone(Customer)" value="" />
                                             ...
                                             <div class="row" <?php echo ($vehicles['val_refferal_type'] == 1 or $vehicles['val_refferal_type'] == 2 or $vehicles['val_refferal_type'] == 3) ? '' : ' style="display: none"'  ?> id="referal_details3">

                                                  <div class="col-sm-6 ">
                                                       <div class="form-group">
                                                            <label class="control-label col-md-4 col-sm-3 col-xs-12">Referal Name</label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <input type="text" class="form-control col-md-7 col-xs-12" name="referal_name3" value="<?php echo $vehicles['val_refferer_name'] ?>" id="referal_name3" autocomplete="off" placeholder="Referal Name" />
                                                            </div>
                                                       </div>
                                                  </div>
                                                  <div class="col-sm-6 ">
                                                       <div class="form-group">
                                                            <label class="control-label col-md-4 col-sm-3 col-xs-12">Reference Phone</label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <input type="text" class="form-control col-md-7 col-xs-12 numOnly " value="<?php echo $vehicles['val_refferal_phone'] ?>" name="referal_phone3" id="referal_phone3" autocomplete="off" placeholder="Referal phone" />
                                                            </div>
                                                       </div>
                                                  </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $vehicles['val_first_dlvry_state']; ?>" name="valuation[val_first_dlvry_state]" id="val_reference" placeholder="First delivery state" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $vehicles['val_first_dlvry_dlrship']; ?>" name="valuation[val_first_dlvry_dlrship]" id="val_reference" placeholder="Dealership" />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                             ...
                                             <div class="col-sm-12">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-9 col-sm-6 col-xs-6">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $vehicles['val_first_dlvry_location']; ?>" name="valuation[val_first_dlvry_location]" id="val_reference" placeholder="Location" />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_prt_1]" value="<?php echo $vehicles['val_prt_1']; ?>" maxlength="2" style="text-transform: uppercase;width: 49px;" required placeholder="KL" />

                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_prt_2]" value="<?php echo $vehicles['val_prt_2']; ?>" maxlength="2" style="text-transform: uppercase;width: 49px;" required placeholder="00" />

                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_prt_3]" value="<?php echo $vehicles['val_prt_3']; ?>" maxlength="2" style="text-transform: uppercase;width: 49px;" required placeholder="AA" />

                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_prt_4]" value="<?php echo $vehicles['val_prt_4']; ?>" maxlength="4" style="text-transform: uppercase;width: 80px;" required placeholder="0000" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required="true" data-url="<?php echo site_url('enquiry/bindModel'); ?>" data-bind="cmbEvModel" data-dflt-select="Select Model" class="select2_group form-control bindToDropdown" name="valuation[val_brand]" id="val_brand">
                                                                 <option value="">Select Brand</option>
                                                                 <?php
                                                                 if (!empty($brand)) {
                                                                      foreach ($brand as $key => $value) {
                                                                 ?>
                                                                           <option <?php echo $value['brd_id'] == $vehicles['val_brand'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['brd_id']; ?>"><?php echo $value['brd_title']; ?></option>
                                                                 <?php
                                                                      }
                                                                 }
                                                                 ?>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required data-url="<?php echo site_url('enquiry/bindVarient'); ?>" data-bind="cmbEvVariant" data-dflt-select="Select Variant" class="cmbEvModel select2_group form-control bindToDropdown" name="valuation[val_model]" id="val_model">

                                                                 <?php foreach ((array) $model as $key => $value) { ?>
                                                                      <option <?php echo $value['mod_id'] == $vehicles['val_model'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['mod_id']; ?>"><?php echo $value['mod_title']; ?></option>
                                                                 <?php } ?>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required class="select2_group form-control cmbEvVariant" name="valuation[val_variant]" id="val_variant">
                                                                 <?php foreach ((array) $variant as $key => $value) { ?>
                                                                      <option <?php echo $value['var_id'] == $vehicles['val_variant'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['var_id']; ?>"><?php echo $value['var_variant_name']; ?></option>
                                                                 <?php } ?>
                                                            </select>
                                                       </div>
                                                  </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" value="<?php echo date('d-m-Y', strtotime($vehicles['val_delv_date'])); ?>" type="text" name="valuation[val_delv_date]" id="val_delv_date">
                                                       </div>
                                                  </div>
                                             </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" value="<?php echo date('d-m-Y', strtotime($vehicles['val_reg_date'])); ?>" name="valuation[val_reg_date]" id="val_reg_date" placeholder="1ST Reg Date" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" required value="<?php echo $vehicles['val_rc_color']; ?>" name="valuation[val_rc_color]" id="val_rc_color" placeholder="RC Color" />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-4 col-xs-6 numOnly val_model_year" value="<?php echo $vehicles['val_model_year']; ?>" maxlength="4" style="width: 50%;" name="valuation[val_model_year]" id="val_model_year" placeholder="Model Year" />

                                                            <input type="text" class="form-control col-md-4 col-xs-6 numOnly val_minif_year" value="<?php echo $vehicles['val_minif_year']; ?>" maxlength="4" style="width: 50%;" name="valuation[val_minif_year]" id="val_minif_year" placeholder="Mnf Year" required />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <input type="text" class="form-control col-md-4 col-xs-6 numOnly" value="<?php echo $vehicles['val_ac_zone']; ?>" style="width: 50%;" name="valuation[val_ac_zone]" id="val_model_year" placeholder="No of zone" required />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 numOnly" value="<?php echo $vehicles['val_no_of_owner']; ?>" placeholder="No.of Owner(s)" type="text" name="valuation[val_no_of_owner]" id="val_no_of_owner">
                                                       </div>
                                                  </div>
                                             </div>
                                             <!--                                             <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_eng_cc]" value="<?php echo $vehicles['val_eng_cc']; ?>" id="val_eng_cc" placeholder="Eng CC" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <!-- <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="select2_group form-control" name="valuation[val_veh_type]" required>
                                                                 ...
                                                                 <?php foreach (unserialize(ENQ_VEHICLE_TYPES) as $key => $value) { ?>
                                                                      <option <?php echo ($vehicles['val_veh_type'] == $key) ? 'selected="selected"' : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                                                 <?php } ?>
                                                            </select>
                                                       </div>
                                                  </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12 numOnly" value="<?php echo $vehicles['val_no_of_seats']; ?>" placeholder="No.of Seats" type="text" name="valuation[val_no_of_seats]" id="val_no_of_seats">
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $vehicles['val_engine_no']; ?>" placeholder="Engine Number" type="text" name="valuation[val_engine_no]" id="val_engine_no">
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $vehicles['val_chasis_no']; ?>" placeholder="Chassis Number" type="text" name="valuation[val_chasis_no]" id="val_chasis_no">
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_km]" value="<?php echo $vehicles['val_km']; ?>" id="val_km" placeholder="KM Reading" required />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td><input value="<?php
                                                                           ...
                                                                           ?>" placeholder="Valid UP to (comprehensive)" type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" name="valuation[val_insurance_comp_date]" /></td>
                                                       <td><input value="<?php echo $vehicles['val_insurance_comp_idv']; ?>" placeholder="IDV Value (comprehensive)" type="text" class="form-control col-md-7 col-xs-12 decimalOnly" name="valuation[val_insurance_comp_idv]" /></td>
                                                  </tr>
                                                  <tr>
                                                       <td>Limited Liability</td>
                                                       <td><input value="<?php echo !empty($vehicles['val_insurance_ll_date']) ? date('d-m-Y', strtotime($vehicles['val_insurance_ll_date'])) : ''; ?>" placeholder="Limited Liability (Limited Liability)" type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" name="valuation[val_insurance_ll_date]" /></td>
                                                       <td><input value="<?php echo $vehicles['val_insurance_ll_idv']; ?>" placeholder="NCB" type="text" class="form-control col-md-7 col-xs-12" name="valuation[val_insurance_ll_idv]" /></td>
                                                  </tr>
                                                  <tr>
                                                       <td>NCB need by Customer</td>
                                                       <td><input <?php echo ($vehicles['val_insurance_need_ncb'] == 1) ? 'checked' : ''; ?> value="1" type="checkbox" name="valuation[val_insurance_need_ncb]" /></td>
                                                       <td>
                                                            <span style="float: left;">Type</span>
                                                            <div style="float: left;width: 200px;margin-left: 20px;">
                                                                 <select class="col-md-2 col-xs-5 select2_group form-control" name="valuation[val_insurance]" id="val_insurance">
                                                                      <option value="0">Select Insurance Type</option>
                                                                      <?php foreach (unserialize(INSURANCE_TYPES) as $key => $value) { ?>
                                                                           <option <?php echo ($vehicles['val_insurance'] == $key) ? 'selected="selected"' : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                                                      <?php } ?>
                                                                 </select>
                                                            </div>
                                                       </td>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-12">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 txtValHypoBankBranch" value="<?php echo $vehicles['val_insurance_company']; ?>" name="valuation[val_insurance_company]" id="val_hypo_bank_branch" placeholder="Insurance company Name" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <!--                                             <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="checkbox" <?php echo ($vehicles['val_finance'] == 1) ? 'checked' : ''; ?> name="valuation[val_finance]" value="1" id="val_finance" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12"><input <?php echo ($vehicles['val_hypo_close_by_cust'] == 1) ? 'checked' : ''; ?> type="checkbox" name="valuation[val_hypo_close_by_cust]" value="1" id="val_hypo_close_by_cust" /></div>
                                                  </div>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="cmbSearchList select2_group form-control" name="valuation[val_hypo_bank]" id="val_hypo_bank">
                                                                 ...
                                                                 <?php foreach ($banks as $key => $value) { ?>
                                                                      <option <?php echo ($vehicles['val_hypo_bank'] == $value['bnk_id']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['bnk_id']; ?>"><?php echo $value['bnk_name']; ?></option>
                                                                 <?php } ?>
                                                            </select>
                                                       </div>
                                                  </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       <label class="control-label col-md-4 col-sm-3 col-xs-12">Branch</label>
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $vehicles['val_hypo_bank_branch']; ?>" name="valuation[val_hypo_bank_branch]" id="val_hypo_bank_branch" placeholder="Branch" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 decimalOnly" value="<?php echo $vehicles['val_hypo_loan_amt']; ?>" name="valuation[val_hypo_loan_amt]" id="val_hypo_loan_amt" placeholder="Loan amount" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" value="<?php echo !empty($vehicles['val_hypo_loan_date']) ? date('d-m-Y', strtotime($vehicles['val_hypo_loan_date'])) : ''; ?>" name="valuation[val_hypo_loan_date]" id="val_hypo_loan_date" placeholder="Loan date" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 decimalOnly" value="<?php echo $vehicles['val_hypo_frclos_val']; ?>" name="valuation[val_hypo_frclos_val]" id="mod_title" placeholder="Foreclosure value" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" value="<?php echo !empty($vehicles['val_hypo_frclos_date']) ? date('d-m-Y', strtotime($vehicles['val_hypo_frclos_date'])) : ''; ?>" name="valuation[val_hypo_frclos_date]" id="val_hypo_frclos_date" placeholder="Foreclosure date" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 decimalOnly" value="<?php echo $vehicles['val_hypo_daily_int']; ?>" name="valuation[val_hypo_daily_int]" id="val_hypo_daily_int" placeholder="Daily interest" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" value="<?php echo !empty($vehicles['val_hypo_loan_end_date']) ? date('d-m-Y', strtotime($vehicles['val_hypo_loan_end_date'])) : ''; ?>" name="valuation[val_hypo_loan_end_date]" id="val_hypo_loan_end_date" placeholder="Loan ending date" />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-12">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-9 col-sm-6 col-xs-12">
                                                            <textarea id="val_finance_remark" class="form-control col-md-7 col-xs-12" rows="4" name="valuation[val_finance_remark]"><?php echo $vehicles['val_finance_remark']; ?></textarea>
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-12">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-9 col-sm-6 col-xs-12">
                                                            <input type="checkbox" name="valuation[val_top_up_loan]" value="1" <?php echo ($vehicles['val_top_up_loan'] == 1) ? 'checked' : ''; ?> />
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="chk-container" style="float: left;width: 100%;">
                                                  ...
                                                  <ul class="ks-cboxtags ulVehicleFeatures">
                                                       ...
                                                       ?>
                                                                 <li>
                                                                      <input <?php echo (in_array($value['vftr_id'], $features)) ? 'checked' : ''; ?> type="checkbox" name="features[<?php echo $value['vftr_id']; ?>]" id="checkboxOne<?php echo $value['vftr_id']; ?>" value="<?php echo $value['vftr_id']; ?>">
                                        ...
                                        <div class="row">
                                             <div class="col-sm-4">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_air_bags]" value="<?php echo $vehicles['val_air_bags']; ?>" id="val_air_bags" placeholder="Air Bags" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-4">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_exhaust]" value="<?php echo $vehicles['val_exhaust']; ?>" id="val_exhaust" placeholder="No of Exhaust" />
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-sm-4">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 numOnly" name="valuation[val_no_of_pw]" value="<?php echo $vehicles['val_no_of_pw']; ?>" id="val_exhaust" placeholder="No of power window" />
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                   ...
                                   <div id="step-2" class="">
                                        <table class="table table-striped table-bordered">
                                             ...
                                             <tbody>
                                                  <?php
                                                  //  echo json_encode(array('data' => $vehicles['bdChkup'])); 
                                                  //  exit;
                                                            ...
                                                            <?php foreach ($fullBodyCheckupDetails as $dk => $dtls) { ?>
                                                                 <td>
                                                                      <label class="ctrl-container"><?php echo $dtls['vfbcd_title']; ?>
                                                                           <input <?php echo (in_array($dtls['vfbcd_id'], $bdChkup)) ? 'checked' : ''; ?> type="radio" value="<?php echo $dtls['vfbcd_id']; ?>" id="fulbdchk<?php echo $dtls['vfbcd_id']; ?>" name="fulbdchk[<?php echo $mstr['vfbcm_id']; ?>]">
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 ...
                                                                 <label class="ctrl-container">Valid
                                                                      <input type="radio" name="valuation[val_wrnty]" value="1" id="val_wrnty_y" <?php echo ($vehicles['val_wrnty'] == 1) ? 'checked' : ''; ?> onclick="$('.tdValidityKM').show();">
                                                                      <span class="checkmark"></span>
                                                                 </label>
                                                            </td>
                                                            <td>
                                                                 <label class="ctrl-container">Not Valid
                                                                      <input type="radio" name="valuation[val_wrnty]" value="0" id="val_wrnty_n" <?php echo ($vehicles['val_wrnty'] == 0) ? 'checked' : ''; ?> onclick="$('.tdValidityKM').hide();">
                                                                      <span class="checkmark"></span>
                                                                 </label>
                                                            </td>
                                                            <td class="td-head"> Ser History ; LS Date</td>
                                                            <td>
                                                                 <input value="<?php echo !empty($vehicles['val_last_service']) ? date('d-m-Y', strtotime($vehicles['val_last_service'])) : ''; ?>" name="valuation[val_last_service]" id="val_last_service" type="text" class="form-control dtpDatePickerEvaluation" style="width: 100%;" />
                                                            </td>
                                                       ...
                                                       <tr class="tdValidityKM" style="<?php echo ($vehicles['val_wrnty'] == 0) ? 'display: none;' : ''; ?>">
                                                            ...
                                                            <td colspan="2">
                                                                 <input class="form-control dtpDatePickerEvaluation" type="text" id="val_wrnty_validity" value="<?php echo $vehicles['val_wrnty_validity']; ?>" style="width: 100%;" name="valuation[val_wrnty_validity]" />
                                                            </td>
                                                            <td colspan="2" class="td-head"> Warranty Validity KM up to</td>
                                                            <td colspan="2">
                                                                 <input value="<?php echo $vehicles['val_wrnty_km']; ?>" type="text" class="form-control numOnly" style="width: 100%;" id="val_wrnty_km" name="valuation[val_wrnty_km]" />
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <label class="ctrl-container">Reg
                                                                      <input value="1" <?php echo ($vehicles['val_wrnty_extra'] == 1) ? 'checked' : ''; ?> name="valuation[val_wrnty_extra]" onclick="$('.tdExtraWarDetails').show();" id="val_wrnty_extra_y" value="1" type="radio">
                                                                      <span class="checkmark"></span>
                                                                 </label>
                                                            </td>
                                                            <td>
                                                                 <label class="ctrl-container">Not Reg
                                                                      <input type="radio" name="valuation[val_wrnty_extra]" onclick="$('.tdExtraWarDetails').hide();" <?php echo ($vehicles['val_wrnty_extra'] == 0) ? 'checked' : ''; ?> id="val_wrnty_extra_n" value="0">
                                                                      <span class="checkmark"></span>
                                                                 </label>
                                                            </td>
                                                            <td class="td-head"> Service Req A.O.D</td>
                                                            <td>
                                                                 <input type="text" name="valuation[val_wrnty_service_req_aod]" id="val_wrnty_service_req_aod" value="<?php echo $vehicles['val_wrnty_service_req_aod']; ?>" class="form-control" style="width: 100%;" />
                                                            </td>
                                                            <td class="td-head"> Act Serv A.O.D</td>
                                                            <td>
                                                                 <input type="text" name="valuation[val_wrnty_act_serv_aod]" id="val_wrnty_act_serv_aod" value="<?php echo $vehicles['val_wrnty_act_serv_aod']; ?>" class="form-control" style="width: 100%;" />
                                                            </td>
                                                       </tr>
                                                       <tr class="tdExtraWarDetails" style="<?php echo ($vehicles['val_wrnty_extra'] == 0) ? 'display: none;' : ''; ?>">
                                                            ...
                                                            <td colspan="2">
                                                                 <input class="form-control dtpDatePickerEvaluation" type="text" id="val_wrnty_validity" value="<?php echo !empty($vehicles['val_ex_wrnty_validity']) ? date('d-m-Y', strtotime($vehicles['val_ex_wrnty_validity'])) : ''; ?>" style="width: 100%;" name="valuation[val_ex_wrnty_validity]" />
                                                            </td>
                                                            <td colspan="2" class="td-head"> Ex Warranty Validity KM up to</td>
                                                            <td colspan="2">
                                                                 <input type="text" class="form-control numOnly" style="width: 100%;" id="val_wrnty_km" value="<?php echo $vehicles['val_ex_wrnty_km']; ?>" name="valuation[val_ex_wrnty_km]" />
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <label class="ctrl-container">Yes
                                                                      <input type="radio" name="valuation[val_ser_package]" id="val_ser_package_y" onclick="$('.tdNxtSerDtKM').show();" <?php echo ($vehicles['val_ser_package'] == 1) ? 'checked' : ''; ?> value="1">
                                                                      <span class="checkmark"></span>
                                                                 </label>
                                                            </td>
                                                            <!--<td>
                                                            ...
                                                            <td>
                                                                 <label class="ctrl-container">No
                                                                      <input type="radio" name="valuation[val_ser_package]" id="val_ser_package_n" <?php echo ($vehicles['val_ser_package'] == 0) ? 'checked' : ''; ?> value="0" onclick="$('.tdNxtSerDtKM').hide();">
                                                                      <span class="checkmark"></span>
                                                                 </label>
                                                            </td>
                                                            <td class="td-head"> Spl Ser Observations</td>
                                                            <td colspan="3">
                                                                 <input type="text" class="form-control" style="width: 100%;" id="val_wrnty_spl_ser_observ" value="<?php echo $vehicles['val_wrnty_spl_ser_observ']; ?>" name="valuation[val_wrnty_spl_ser_observ]" />
                                                            </td>
                                                       </tr>
                                                       <tr class="tdNxtSerDtKM" style="<?php echo ($vehicles['val_ser_package'] == 0) ? 'display: none;' : ''; ?>">
                                                            ...
                                                            <td colspan="2">
                                                                 <input class="form-control dtpDatePickerEvaluation" type="text" id="val_next_service_date" value="<?php echo !empty($vehicles['val_wrnty_nxt_ser_date']) ? date('d-m-Y', strtotime($vehicles['val_wrnty_nxt_ser_date'])) : ''; ?>" style="width: 100%;" name="valuation[val_wrnty_nxt_ser_date]" />
                                                            </td>
                                                            <td colspan="2" class="td-head"> Service package KM up to </td>
                                                            <td colspan="2">
                                                                 <input type="text" class="form-control numOnly" style="width: 100%;" id="val_next_service_km" value="<?php echo $vehicles['val_wrnty_nxt_ser_km']; ?>" name="valuation[val_wrnty_nxt_ser_km]" />
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                            <td class="td-head">Accident history remarks</td>
                                                            <td colspan="7">
                                                                 <input type="text" class="form-control" style="width: 100%;" id="val_wrnty_im_observ" value="<?php echo $vehicles['val_acc_history_remarks']; ?>" placeholder="Accident history remarks" name="valuation[val_acc_history_remarks]" />
                                                            </td>
                                                       </tr>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td colspan="7">
                                                                 <input type="text" class="form-control" style="width: 100%;" id="val_wrnty_spl_comments" value="<?php echo $vehicles['val_wrnty_ser_remarks']; ?>" placeholder="Warranty service remarks" name="valuation[val_wrnty_ser_remarks]" />
                                                            </td>
                                                       </tr>
                                                  </tbody>
                                             </table>
                                                                 ...
                                                                 <tr>
                                                                      <td>
                                                                           ...
                                                                           if (!empty($comvalue['comp_pic'])) {
                                                                                echo img(array('src' => './assets/uploads/evaluation_new/' . $comvalue['comp_pic'], 'height' => '80', 'width' => '100', 'id' => 'imgBrandImage'));
                                                                           } else {
                                                                           ?>
                                                                      ...
                                                                      <td>
                                                                           <a data-url="<?php echo site_url($controller . '/removeImage/' . $comvalue['comp_id']); ?>" href="javascript:void(0);" style="width: 100px;" class="btn btn-block btn-danger btn-xs btnDeleteImage">Delete</a>
                                                                      </td>
                                                                 </tr>
                                                       <?php
                                                            }
                                                            ...
                                                            <div class="gallery deleteRow<?php echo $value['vdoc_id']; ?> col-md-6 col-sm-6 col-xs-12" style="padding: 10px;">
                                                                 <a target="_blank" href="javascript:;">
                                                                      ...
                                                                      if (is_image($value['vdoc_doc'])) {
                                                                           echo img(array('class' => 'img', 'src' => 'https://royaldrive.in/assets/uploads/evaluation_new/' . $value['vdoc_doc'], 'style' => "width:200px;float:left;"));
                                                                      } else {
                                                                 ...
                                                                 <div class="col-md-3 col-sm-3 col-xs-12">
                                                                      <select name="document_type[]" class="form-control cmbCommonPlane" data-url="<?php echo site_url('evaluation_new/updateDocumentType/' . $value['vdoc_id']); ?>" data-confmsg="Are you sure want to change this?" data-meta="0"><?php foreach (unserialize(VAL_DOCUMENT_TYPE) as $dkey => $dtypes) { ?>
                                                                                <option <?php echo ($dkey == $value['vdoc_doc_type']) ? 'selected="selected"' : ''; ?> value="<?php echo $dkey; ?>"><?php echo $dtypes; ?></option>
                                                                           <?php } ?>
                                                                      </select>
                                                                 ...
                                                                 <div style="float: left;width: 100%;text-align: center;margin-top: 10px;">
                                                                      <a href="<?php echo '../../assets/uploads/evaluation_new/' . $value['vdoc_doc']; ?>" target="_blank" class="btn btn-primary btn-xs" style="margin-bottom: 0px;">
                                                                           <i class="fa fa-file-o"></i> View</a>
                                                                      <?php if (check_permission('evaluation', 'deletedocument')) { ?>
                                                                           <a data-url="<?php echo site_url('evaluation_new/deleteDocument/' . encryptor($value['vdoc_id'])); ?>" data-id="<?php echo $value['vdoc_id']; ?>" href="javascript:;" class="deleteRow btn btn-danger btn-xs" style="margin-bottom: 0px;">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div class="frame01 dropzone" id="fileupload" action="<?= base_url('index.php/evaluation_new/uploadFile?frame=1') ?>">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                                      ?>
                                                                      <img data-url="<?php echo site_url('evaluation_new/deleteValuationVehicleImage/' . encryptor($imgId)); ?>" style="font-size: 25px;color: red;position: absolute;top: 0px;right: 0px;cursor: pointer;" data-id="<?php echo $imgId; ?>" class="deleteRow" href="javascript:void(0);" src="../assets/images/delete.png" />
                                                                 </div>
                                                            <?php } ?>
                                                       </div>
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div class="frame02 dropzone" action="<?= base_url('index.php/evaluation_new/uploadFile?frame=2') ?>" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                                      ?>
                                                                      <img data-url="<?php echo site_url('evaluation_new/deleteValuationVehicleImage/' . encryptor($imgId)); ?>" style="font-size: 25px;color: red;position: absolute;top: 0px;right: 0px;cursor: pointer;" data-id="<?php echo $imgId; ?>" class="deleteRow" href="javascript:void(0);" src="../assets/images/delete.png" />
                                                                 </div>
                                                            <?php } ?>
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div class="frame03 dropzone" id="fileupload" action="<?= base_url('index.php/evaluation_new/uploadFile?frame=3') ?>">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=4') ?>" class="frame04 dropzone" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=5') ?>" class="frame05 dropzone" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=6') ?>" class="frame06 dropzone" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=7') ?>" class="dropzone frame07" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=8') ?>" class="dropzone frame08" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=9') ?>" class="dropzone frame09" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=10') ?>" class="dropzone frame10" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=11') ?>" class="dropzone frame11" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=12') ?>" class="dropzone frame12" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('index.php/evaluation_new/uploadFile?frame=13') ?>" class="dropzone frame13" id="fileupload">
                                                            <?php if (!empty($img)) { ?>
                                                                 <div style="position: relative;" class="deleteRow<?php echo $imgId; ?>">
                                                                      <?php
                                                                      echo img(array('src' => '../assets/uploads/evaluation_new/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                              ...
                              <?php foreach ((array) $vehicles['documents'] as $key => $value) { ?>
                                   <div class="form-group" style="float: left;width: 100%;">
                                        ...
                                        <div class="gallery deleteRow<?php echo $value['vdoc_id']; ?> col-md-6 col-sm-6 col-xs-12" style="padding: 10px;">
                                             ...
                                             <div>
                                                  <a href="<?php echo 'https://royaldrive.in/assets/uploads/evaluation_new/' . $value['vdoc_doc']; ?>" target="_blank" class="btn btn-primary btn-xs" style="margin-bottom: 0px;">
                                                       <i class="fa fa-file-o"></i> View</a>
                                                  <?php if (check_permission('evaluation', 'deletedocument')) { ?>
                                                       <a data-url="<?php echo site_url('evaluation_new/deleteDocument/' . encryptor($value['vdoc_id'])); ?>" data-id="<?php echo $value['vdoc_id']; ?>" href="javascript:;" class="deleteRow btn btn-danger btn-xs" style="margin-bottom: 0px;">
                                                            <i class="fa fa-trash-o"></i> Delete</a>
...
<div class="modal fade mdlNewFeature" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document">
          <form class="modal-content frmNewFeature" action="<?php echo site_url('evaluation_new/newvehiclefature'); ?>">
                    ...
                    <div class="col-sm-12">
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-12 col-xs-12">
                                   <input required type="text" class="vftr_feature form-control col-md-7 col-xs-12" name="vftr_feature" placeholder="Feature name" />
                              </div>
                         </div>
                    </div>
                    <div class="col-sm-12">
