                                                            ...
                                                            <form class="form-inline frmValuationFilter" role="form">
                                                                 ...
                                                                 <table class="table table-striped table-bordered">
                                                                      ...
                                                                      <tr>
                                                                           <td>
                                                                                <span>KM from</span>
                                                                                <input style="width:100px;" autocomplete="off" name="val_valuation_date_from" type="text"
                                                                                       placeholder="KM from" value="<?php echo isset($_GET['val_valuation_date_from']) ? $_GET['val_valuation_date_from'] : ''; ?>"/>
                                                                           </td>

                                                                           <td>
                                                                                <span>KM to </span>
                                                                                <input style="width:100px;" autocomplete="off" name="val_valuation_date_to" type="text"
...
<div class="modal fade" id="UpdrefurbSts" role="dialog">
     <div class="modal-dialog test_drive">
          <?php echo form_open_multipart("evaluation_new/update_refurb_status", array('id' => "update-refurb-status", 'class' => "update-refurb-status  modal-content form-horizontal form-label-left"))?>
 ...
 //  debug($refurbStatus);
  ?>
                              ...
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <select  required class="tdriveSearchList select2_group form-control cmbStock form-control col-md-7 col-xs-12" 
...
<script>
     $(document).ready(function () {
          ...
          $(document).on('click', '.btnExport', function (e) {
               $.ajax({
                    type: 'post',
                    url: site_url + "evaluation_new/xlsx_valuation?" + $('.frmValuationFilter').serialize(),
                    dataType: 'json',
     ...
     function valuationList(canDelete, frmData) {
          ...
          var printUrl = "<?php echo site_url('evaluation_new/printevaluation'); ?>";
          var prchsChkListUrl = "<?php echo site_url('evaluation_new/purchase_check_list'); ?>";
          ...
          $('#tblValuation').DataTable({
               ...
               "ajax": {
                    "type": "POST",
                    "url": site_url + "evaluation_new/evaluation_ajax?" + frmData
               },
               "columnDefs": [
                    {
                         "targets": [0],
               ...
               'columns': [
                    ...
                    {data: 'val_book_sts_title'},
                    {
                         ...
                         "mRender": function (data, type, row) {
                            ...
                            //  if (data.val_status == 39 || data.val_status == 43 || data.val_status == 66) {//
                              if (data.val_status == 39 || data.val_status == 43 || data.val_status == 66) {
               ...
               "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                    if (aData['val_status'] == "0") {
                         ...
                         $('td', nRow).css('color', '#fff');
                    } else if (aData['val_status'] == "39" || aData['val_status'] == "43" || aData['val_status'] == "66") {//
          ...
          $('#tblValuationj tbody').on('click', 'tr', function () {
               ...
               var url = "<?php echo site_url('evaluation_new/printevaluation'); ?>" + "/" + data.val_id;
