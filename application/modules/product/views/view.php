<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Edit Vehicle - <?php echo $productsDetails['product_details']['prd_regno_prt_1'] . '-' .
                                            $productsDetails['product_details']['prd_regno_prt_2'] . '-' .
                                            $productsDetails['product_details']['prd_regno_prt_3'] . '-' .
                                            $productsDetails['product_details']['prd_regno_prt_4']; ?></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    <?php echo form_open_multipart("product/update", array('id' => "frmProduct", 'class' => "form-horizontal form-label-left", "onsubmit" => "document.getElementById('submit').disabled=true;")) ?>
                    <input type="hidden" name="prd_id"
                        value="<?php echo $productsDetails['product_details']['prd_id']; ?>" />
                    <!-- STK -->
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Stock</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="product[prd_valuation_id]"
                                class="cmbSearchList select2_group form-control cmbUser" placeholder="Veh No.">
                                <option value="">Select Stock</option>
                                <?php

                                foreach ($valDetails as $key => $value) { ?>
                                <option
                                    <?php echo ($value['val_id'] == $productsDetails['product_details']['prd_valuation_id']) ? "selected='selected'" : ''; ?>
                                    value="<?php echo $value['val_id']; ?>">
                                    <?php echo $value['val_stock_num'] . '-' . $value['val_veh_no'] ?>
                                </option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input readonly type="text" class="form-control" name="product[prd_number]" id="prd_number"
                                value="<?php echo !empty($productsDetails['product_details']['prd_number']) ?
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" name="product[prd_regno_prt_1]"
                                value="<?php echo $productsDetails['product_details']['prd_regno_prt_1']; ?>"
                                maxlength="2" style="text-transform: uppercase;width: 49px;" required
                                placeholder="KL" />

                            <input type="text" class="form-control col-md-7 col-xs-12 numOnly"
                                name="product[prd_regno_prt_2]"
                                value="<?php echo $productsDetails['product_details']['prd_regno_prt_2']; ?>"
                                maxlength="2" style="text-transform: uppercase;width: 49px;" required
                                placeholder="00" />

                            <input type="text" class="form-control col-md-7 col-xs-12" name="product[prd_regno_prt_3]"
                                value="<?php echo $productsDetails['product_details']['prd_regno_prt_3']; ?>"
                                maxlength="3" style="text-transform: uppercase;width: 49px;" placeholder="AA" />

                            <input type="text" class="form-control col-md-7 col-xs-12 numOnly"
                                name="product[prd_regno_prt_4]"
                                value="<?php echo $productsDetails['product_details']['prd_regno_prt_4']; ?>"
                                maxlength="4" style="text-transform: uppercase;width: 80px;" required
                                placeholder="0000" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select required name="product[prd_location]" class="select2_group form-control"
                                ...
                                <option
                                    <?php echo ($value['shr_id'] == $productsDetails['product_details']['prd_location']) ? "selected='selected'" : ''; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="product[prd_brand]" id="prd_brand"
                                ...
                                ?>
                                <option
                                    <?php echo ($productsDetails['product_details']['prd_brand'] == $value['brd_id']) ? "selected='selected'" : ''; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select required data-url="<?php echo site_url('enquiry/bindVarient'); ?>"
                                ...
                                ?>
                                <option
                                    <?php echo ($productsDetails['product_details']['prd_model'] == $value['mod_id']) ? "selected='selected'" : ''; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select required class="select2_group form-control cmbVariant" name="product[prd_variant]"
                                ...
                                ?>
                                <option
                                    <?php echo ($productsDetails['product_details']['prd_variant'] == $value['var_id']) ? "selected='selected'" : ''; ?>
                                    value="<?php echo $value['var_id']; ?>"><?php echo $value['var_variant_name']; ?>
                                </option>
                                <?php
                                    }
                                }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="1" type="checkbox" name="product[prd_loan_avail]" class="" id="prd_loan_avail"
                                <?php echo ($productsDetails['product_details']['prd_loan_avail']) ? "checked='true'" : ''; ?> />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Description</label>
                        <div class="col-md-6 col-sm-6 col-xs-12" style="width: 50%;">
                            <textarea placeholder="Design feature" class="editor1 form-control col-md-7 col-xs-12"
                                name="product[prd_desc]"><?php echo strip_tags($productsDetails['product_details']['prd_desc']); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="width: 50%;">
                            <textarea placeholder="Safety feature" class="form-control col-md-7 col-xs-12 editor1"
                                name="product[prd_safety_feture]"><?php echo strip_tags($productsDetails['product_details']['prd_safety_feture']); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="width: 50%;">
                            <textarea placeholder="Comfort & Convenience feature"
                                ...
                                name="product[prd_cmfort_cnvnent_feture]"><?php echo strip_tags($productsDetails['product_details']['prd_cmfort_cnvnent_feture']); ?></textarea>
                        </div>
                    </div>
                    <?php } ?>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_warranty_upto']; ?>"
                                type="text" name="product[prd_warranty_upto]" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="col-md-2 col-xs-5 select2_group form-control"
                                ...
                                <option
                                    <?php echo ($productsDetails['product_details']['prd_insurance_type'] == $key) ? 'selected="selected"' : ''; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select required class="select2_group form-control" name="product[prd_transmission]"
                                ...
                                <option
                                    <?php echo ($productsDetails['product_details']['prd_transmission'] == $key) ? 'selected="selected"' : ''; ?>
                                    value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_arai_mileage']; ?>"
                                type="text" name="product[prd_arai_mileage]" class="numOnly form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_acc_ftd']; ?>" type="text"
                                name="product[prd_acc_ftd]" class="form-control" id="prd_acc_ftd"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_or_road_price']; ?>"
                                type="text" name="product[prd_or_road_price]" class="numOnly form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select name="product[prd_year]" class="select2_group form-control"
                                ...
                                <option
                                    <?php echo ($productsDetails['product_details']['prd_year'] == $i) ? "selected='true'" : ''; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select name="product[prd_color_id]" class="select2 select2_group form-control"
                                ...
                                <option
                                    <?php echo ($value['vc_id'] == $productsDetails['product_details']['prd_color_id']) ? "selected='selected'" : ''; ?>
                                    value="<?php echo $value['vc_id']; ?>"><?php echo $value['vc_color']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text"
                                value="<?php echo $productsDetails['product_details']['prd_wrapp_color']; ?>"
                                name="product[prd_wrapp_color]" class="form-control col-md-7 col-xs-12"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_km_run']; ?>" type="text"
                                name="product[prd_km_run]" class="numOnly form-control" id="prd_km_run"
                                placeholder="Km" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_insurance_validity']; ?>"
                                type="text" name="product[prd_insurance_validity]"
                                class="dtpDatePickerEvaluation form-control" id="prd_insurance_validity"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text"
                                value="<?php echo $productsDetails['product_details']['prd_insurance_idv']; ?>"
                                name="product[prd_insurance_idv]" class="numOnly form-control col-md-7 col-xs-12"
                                id="prd_insurance_idv" placeholder="Insurance IDV" />
                        </div>
                    </div>
                    <!-- <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select name="product[prd_fual]" id="prd_fual"  class="select2_group form-control">
                                        ...
                                        <option <?php //echo ($productsDetails['product_details']['prd_fual'] == 'diesel') ? "selected='selected'" : '';
                                                ?> value="diesel">Diesel</option>
                                        <option <?php //echo ($productsDetails['product_details']['prd_fual'] == 'petrol') ? "selected='selected'" : '';
                                                ?> value="petrol">Petrol</option>
                                        <option <?php //echo ($productsDetails['product_details']['prd_fual'] == 'gas') ? "selected='selected'" : '';
                                                ?> value="gas">Gas</option>
                                        <option <?php //echo ($productsDetails['product_details']['prd_fual'] == 'Hybrid') ? "selected='selected'" : '';
                                                ?> value="Hybrid">Hybrid</option>
                                        <option <?php //echo ($productsDetails['product_details']['prd_fual'] == 'Electric') ? "selected='selected'" : '';
                                                ?> value="Electric">Electric</option>
                                        <option <?php //echo ($productsDetails['product_details']['prd_fual'] == 'CNG') ? "selected='selected'" : '';
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select required="true" style="width: 170px;"
                                ...
                                <option
                                    <?php echo ($productsDetails['product_details']['prd_fual'] == $key) ? "selected='selected'" : ''; ?>
                                    value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_price']; ?>" type="text"
                                placeholder="Price" class="numOnly form-control" name="product[prd_price]" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_mileage']; ?>" type="text"
                                name="product[prd_mileage]" class="numOnly form-control" id="prd_mileage"
                                placeholder="Mileage" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_owner']; ?>" type="text"
                                name="product[prd_owner]" class="numOnly form-control" id="prd_owner"
                                placeholder="Owner" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_engine_cc']; ?>"
                                type="text" name="product[prd_engine_cc]" class="numOnly form-control"
                                id="prd_engine_cc" placeholder="Engine in cc" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $productsDetails['product_details']['prd_order']; ?>" type="text"
                                name="product[prd_order]" class="form-control" id="prd_order" placeholder="Priority" />
                            <?php /*if (!empty($order)) {?>
                            <select name="product[prd_order]" id="exp_order" class="select2_group form-control">
                                <option value="">Select Priority</option>
                                <?php for ($i = 1; $i <= $order; $i++) {?>
                                <option
                                    <?php echo ($i == $productsDetails['product_details']['prd_order']) ? "selected='selected'" : '';?>
                                    value="<?php echo $i;?>"><?php echo $i;?></option>
                                <?php }?>
                            </select>
                            <?php }*/ ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="1"
                                <?php echo ($productsDetails['product_details']['prd_new_arrivals']) ? "checked='true'" : ''; ?>
                                type="checkbox" name="product[prd_new_arrivals]" id="prd_new_arrivals"
                                placeholder="Model" />
                        </div>
                    </div>
                    ...
                    <!-- -->
                    <?php
                    if ($productsDetails['product_images']) {
                        foreach ($productsDetails['product_images'] as $key => $value) {
                    ?>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <span class="help-block">
                                <a data-url="<?php echo site_url('product/removeImage/' . $value['pdi_id']); ?>"
                                    href="javascript:void(0);" style="width: 100px;"
                                    class="btn btn-block btn-danger btn-xs btnDeleteImage">Delete</a>
                            </span>
                            <div>
                                <input <?php echo ($value['pdi_is_default'] == 1) ? "checked" : ''; ?>
                                    data-url="<?php echo site_url('product/setDefaultImage/' . $value['pdi_id'] . '/' . $productsDetails['product_details']['prd_id']); ?>"
                                    class="radSetDefaultUpdate" type="radio" name="setdefault" />&nbsp;Set default
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group grp-specification">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <input value="<?php echo $value['spe_specification']; ?>" type="text"
                                class="form-control col-md-7 col-xs-12" placeholder="Technical Details Key"
                                name="specification[spe_specification][]">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <input value="<?php echo $value['spe_specification_detail']; ?>" type="text"
                                class="form-control col-md-7 col-xs-12" placeholder="Technical Details Value"
                                name="specification[spe_specification_detail][]">
                        </div>

                        <div class="col-md-1 col-sm-1 col-xs-12">
                            <span style="float: right;cursor: pointer;"
                                class="glyphicon glyphicon-minus btnRemoveMoreSpecification"></span>
                        </div>
                    </div>
                    <?php
                        }
                    ...
                    <?php if (!empty($features)) {
                        $productFeatures = explode(',', $productsDetails['product_features']['features']);
                            ...
                            <div class="span4">
                                <div class="form-group no-margin-bot">
                                    <div class=" col-md-6 col-sm-6 col-xs-12-row">
                                        <input
                                            <?php echo (!empty($productFeatures) && in_array($value['ftr_id'], $productFeatures)) ? "checked='true'" : ''; ?>
                                            type="checkbox" class="input-block-level"
