<div class="right_col" role="main">
     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    <div class="x_title">
                         <h2>Create Health Card</h2>
                         <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                    <form class="x_content createhealth" action="<?php echo site_url($controller . '/saveHealthCard'); ?>" method="post">
                         <div class="row">
                         ...
                         <div class="row">
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input required="" type="number" class="form-control col-md-7 col-xs-12 numOnly" name="hc_km" value="<?php echo $valuation['val_km']; ?>" id="val_km" placeholder="Km">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                         ...
                         <div class="row">
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input required="" type="number" class="form-control col-md-7 col-xs-12 numOnly" name="hc_minif_month" value="<?php echo $valuation['val_minif_month']; ?>" id="val_km" placeholder="Manufacture Month">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input required="required" class="form-control col-md-7 col-xs-12 numOnly" name="hc_minif_year" value="<?php echo $valuation['val_minif_year']; ?>" placeholder="Manufacture Year" type="number" id="val_no_of_owner">
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                       ...
                                       // debug(unserialize(FUAL));
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <!-- val js -->
                                             <select class="select2_group form-control bindToDropdown" name="hc_prd_fual" i="val_fuel">
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name">ARAI Tested
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name">RD Price</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">
                                             Torque</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input required="" type="number" class="form-control col-md-7 col-xs-12 numOnly" name="hc_torque" value="<?php echo $valuation['val_torque']; ?>" id="val_eng_cc" placeholder="Torque">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                         ...
                         <div class="row">
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
      <select class="col-md-2 col-xs-5 select2_group form-control" name="hc_drive_train" id="hc_drive_train">
                              ...
                              <div class="col-sm-6">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <select class="col-md-2 col-xs-5 select2_group form-control" name="hc_insurance" id="hc_insurance">
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name">Insurance IDV</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">
                                             Warranty Date</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" value="<?php echo $valuation['val_wrnty_validity'] ?>" name="hc_wrnty_validity" id="hc_wrnty_validity" placeholder="Warranty Validiy" required="required">
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">
                                             Warranty KM</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12 numOnly" value="<?php echo $valuation['val_wrnty_km'] ?>" name="hc_wrnty_km" id="hc_wrnty_km" placeholder="Warranty KM" required="required">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-6">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">
                                             Warranty Type</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $valuation['val_wrnty_type'] ?>" name="hc_wrnty_type" id="hc_wrnty_type" placeholder="Warranty Type" required="required">
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="col-sm-4">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">
                                             Valid upto</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" value="<?php echo $valuation['val_wrnty_nxt_ser_date'] ?>" name="hc_wrnty_nxt_ser_date" id="hc_wrnty_nxt_ser_date" placeholder="Warranty Next Service date" required="required">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-4">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">
                                             KM</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-7 col-xs-12 " value="<?php echo $valuation['val_wrnty_nxt_ser_km'] ?>" name="hc_wrnty_nxt_ser_km" id="hc_wrnty_nxt_ser_km" placeholder="Warranty Next Service KM" required="required">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-4">
                                   <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">
                                             Service Type</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-12 col-xs-12 " value="<?php echo $valuation['val_service_type'] ?>" name="hc_service_type" id="hc_service_type" placeholder="Service Type" required="required">
                                        </div>
                                   </div>
                              </div>
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-4">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-12 col-xs-12 " value="<?php echo $valuation['val_lst_service_place'] ?>" name="hc_lst_service_place" id="hc_lst_service_place" placeholder="Last Service done at (Service centre)" required="required">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-sm-4">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-12 col-xs-12 dtpDatePickerEvaluation" value="<?php echo $valuation['val_next_serv_date'] ?>" name="hc_next_serv_date" id="hc_next_serv_date" placeholder="Next Service due Date" required="required">
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="col-sm-4">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" class="form-control col-md-12 col-xs-12 " value="<?php echo $valuation['val_next_serv_km'] ?>" name="hc_next_serv_km" id="hc_next_serv_km" placeholder="Next Service KM" required="required">
                                        </div>
                                   </div>
                              </div>
                         </div>
                              ...
                              <table class="table table-striped table-bordered">
                                   ...
                                   <tbody>
                                        ...
                                        <tr>
                                             ...
                                             <td>
                                                  <input value="" class="form-control numOnly" type="number" id="val_tyre_2_wek" name="valuation[val_battery_year]" placeholder="Year">
                                             </td>
                                             <td class="td-head"> Description</td>
                                             <td>
                                                  <input value="" class="form-control" type="text" id="val_tyre_1_wek" name="valuation[val_battery_desc]" placeholder="Description">
                                             </td>
                                        </tr>
