...
<div class="right_col" role="main">
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    <div class="x_title">
                         <h2>Procurement demand report</h2>
                                   ...
                                   <table class="table table-striped table-bordered "  id="rowClick">
                                        <thead style="background-color: gray; color: white;">
                                             <tr class="hdr">
                                                  ...
                                                  <th>HOT+</th><th class="hot" id='hot' data-th="hot" data-order="DESC ht">HOT</th><th data-th="warm" data-order="DESC">WARM</th><th>COLD</th><th>Inquired  veh NOS</th><th>Total Enquiry</th><th>Drop</th><th>Available in Purchase</th>
                                             </tr>
                                        </thead>
...
<script>
     ...
     $(document).ready(function () {
          ...
          function filter_data(page)
          {
               ...
               $.ajax({
                    url: "<?php echo site_url('reports/enquiry_pool_list');?>/" + page,
                    method: "POST",
                    dataType: "JSON",
                    data: form.serialize(),
                    success: function (data)
