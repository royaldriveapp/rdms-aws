+
<?php
  if (!empty($reports['InsrncPendings'])) {
       foreach ($reports['InsrncPendings'] as $key => $report) {
            ?>
            <tr  class="bdy singleline txtBlk" data-url="#">
                 <td  class="details-control"><?php echo @$key + 1;?></td>
                 <td class="details-control"><?php echo date('M-Y', strtotime($report['vbk_rfi_rc_tranfd_date'])); //vbk_rfi_rc_tranfd_date?></td>
            ...
            ?>
                 ...
                 <td class="details-control"><?php echo date('d-m-Y', strtotime($report['vbk_rfi_rc_tranfd_date']));?></td>
            ...
            ?></td>
                 ...
                 <td class="details-control">inform cus by wrtn </td>
                 <td class="details-control"><?php echo date('d-m-Y', strtotime($report['vbk_ins_trans_exp_date']));?></td>
