...
<div class="right_col" role="main">
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    <div class="x_title">
                         <h2>PURCHASE REPORT  [ <?php echo date("Y"); ?> ]
</h2>
                                   ...
                                   <table class="table table-striped table-bordered bg-clr "  id="rowClick">
                                        <thead style="background-color: gray; color: white;">
                                              <tr class="hdr singleline">
                                                   <th>Sl No</th> <th>Location</th>  <th>Stock date</th> <th>Days in stock</th><th>months in stock</th><th>Source Of Purchase</th><th>Executive</th><th>Customer Name</th><th>Broker or referal</th><th>    Broker,NVS, Referal Name</th><th>Reg No</th> <th>Make</th><th>Model</th><th>variant</th> <th>Prod Year </th> <th>KM</th> 
                                                  <th>Stock Status</th><th class="hot" id='hot' data-th="hot" data-order="DESC ht">Next Service KM</th><th>Pending Refurbishment</th><th>Remarks</th> <th> Delivery Date </td>
                                             </tr>
                                        </thead>
     ...
     $(document).ready(function () {
        ...
        //  filter_data(1,2);
          function filter_data(page,month)
          {
               ...
               $.ajax({
                    url: "<?php echo site_url('reports_1/purchase_report');?>/" + page,
                    method: "POST",
                    dataType: "JSON",
