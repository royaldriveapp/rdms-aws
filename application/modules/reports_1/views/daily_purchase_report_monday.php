...
<!--                                             <tr class="hdr singleline">-->
                                             <tr class="hdr singleline">
                                                  <th>Emp Name</th>
                                                  <th colspan="3">Weekly Target</th>
                                                  <th colspan="3">Weekly Achievement </th>
                                                  <th></th>
                                                  <th></th>
                                                  <th></th>
                                                  <th></th>
                                                  ...
                                                  <th colspan="3">Monthly Target Achievement </th>
                                              ...
                                              <tr class="hdr singleline">
                                                  ...
                                                  <th>Purchase</th>
                                                  <th>Park</th>
                                                  <th>Purchase with Loan</th>
                                                  <th>Purchase</th>
                                                  <th>Park</th>
                                                  <th>Purchase with Loan</th>
                                                  <th>Weekly Evaluation Target </th>
                                                  <th>Weekly Evaluation Target Achievement</th>
                                                  <th>Unsolved Bottle Necks</th>
                                                     <th>Action Plan to solve Bottle Necks</th>
                                                  <th>Resnponsible Person </th>
                              ...
                              <div class="row">
                              <h5  class="lbl-blk"><center>Enquiry Status</center>
                                   </h5>
                              <div class="table-responsive">
                                   <table class="table table-striped table-bordered bg-clr tbl"  id="rowClick">
                                             <thead class="t-head">
...
<script>
     ...
     function load_data()
     {
          ...
          var form = $("#filterForm");
          $.ajax({
               url: "<?php echo site_url('reports/daily_purchase_report');?>",
               method: "POST",
               dataType: "JSON",
               data: form.serialize(),
