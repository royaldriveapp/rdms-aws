...
<div class="right_col" role="main">
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    <div class="x_title">
                         <h2>Summary Enquiry(Purchase)</h2>

                         <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                         <div class="row filter">
                              <form action="reports/summary_enq_purchase" method="get" id="filterForm">
...
<script>
     $("#filterForm").submit(function (e) {
          ...
          $.ajax({
               type: "POST",
               url: site_url + "reports/summary_enq_purchase",
               data: form.serialize(),
               dataType: "JSON",
               beforeSend: function () {
                    $('.divLoading').show();
     ...
     $(document).ready(function () {
          ...
          function filter_data(page)
          {
               ...
               $.ajax({
                    url: "<?php echo site_url('reports/summary_enq_purchase');?>/" + page,
                    method: "POST",
                    dataType: "JSON",
                    data: form.serialize(),
                    success: function (data)
