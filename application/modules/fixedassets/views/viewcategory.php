                    ...
                    <div class="x_content">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <?php
                                   build_category_tree($categories['fac_id'], $categories['fac_parent'], $this, $locations, 0);
                                   ?>

                                   <select name="category[fac_parent]" id="fac_parent" class="form-control col-md-7 col-xs-12">
                                   ...
                                   function build_category_tree($catId, $selectedId, $f, &$output, $preselected, $parent = 0, $indent = "") {
                                        $parentCategories = $f->fixedassets->getCategoryChaild($parent, $catId);
                                        foreach ($parentCategories as $key => $value) {
                                             $selected = ($value["fac_id"] == $selectedId) ? "selected=\"selected\"" : "";
                                             $output .= "<option value=\"" . $value["fac_id"] . "\" " . $selected . ">" . $indent . $value["fac_title"] . "</option>";
                                             if ($value["fac_id"] != $parent) {
                                                  build_category_tree($catId, $selectedId, $f, $output, $preselected, $value["fac_id"], $indent . "&nbsp;&nbsp;");
                                             }
                                        }
                                   }
                                   ?>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input type="text" class="form-control col-md-7 col-xs-12" name="category[fac_title]" id="fac_title" placeholder="Category Title"/>
                              </div>
                         </div>
