                                                                                                      ...
                                                                                                      <div class="col-md-6 col-sm-12 col-xs-12">
                                                                                                           <div class="x_panel">
                                                                                                                ...
                                                                                                                <div class="row" style="text-align: center;font-weight: bolder;font-size: 18px;">Followup/New enquiry</div>
                                                                                                                     ...
                                                                                                                     if (!empty($call)) {
                                                                                                                          //http://45.249.170.209:8080/content/incomingrecordings/
                                                                                                                          ?>
                                                                                                                          <div class="form-group" style="width: 100%;float: left;white-space: normal;">
                                                                                          ...
                                                                                          <div class="modal-body">
                                                                                               ...
                                                                                               <table class="table table-striped" style="color:#000;">
                                                                                                    <tr>
                                                                                                         <td>Customer name</td>
                                                                                                         <td>
                                                                                                             <input type="text" class="form-control col-md-7 col-xs-12" name="vreg_cust_name" id="vreg_cust_name"
                                                                                                                                value="<?php echo $value['vreg_cust_name'] ?>" autocomplete="off" placeholder="Customer name"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                             <input type="text" class="form-control col-md-7 col-xs-12" name="vreg_cust_place" id="vreg_cust_place"
                                                                                                                                value="<?php echo $value['vreg_cust_place'] ?>" autocomplete="off" placeholder="Customer place"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                             <input type="text" class="form-control col-md-7 col-xs-12" name="vreg_existing_vehicle" id="vreg_existing_vehicle"
                                                                                                                                value="<?php echo $value['vreg_existing_vehicle'] ?>" autocomplete="off" placeholder="Existing vehicle"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                         <td>Occupation</td>
                                                                                                         <td>
                                                                                                             <input type="text" class="form-control col-md-7 col-xs-12" name="vreg_occupation" id="vreg_occupation"
                                                                                                                                value="<?php echo $value['vreg_occupation'] ?>" autocomplete="off" placeholder="Occupation"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                         <td>Brand</td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         <td>Year</td>
                                                                                                         <td>
                                                                                                              <input type="text" class="form-control col-md-7 col-xs-12" name="vreg_year" id="vreg_year"
                                                                                                                     value="<?php echo $value['vreg_year'] ?>" autocomplete="off" placeholder="Year 2010-2011"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         <td>Investment</td>
                                                                                                         <td>
                                                                                                              <input type="text" class="form-control col-md-7 col-xs-12" name="vreg_investment" id="vreg_investment"
                                                                                                                     value="<?php echo $value['vreg_investment'] ?>" autocomplete="off" placeholder="Investment 10,00000-20,00000"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                              <input type="text" class="form-control col-md-7 col-xs-12" 
                                                                                                                     value="<?php echo $value['vreg_km'] ?>" name="vreg_km" id="vreg_km" autocomplete="off" placeholder="KM 10000-20000"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         <td>Appointment</td>
                                                                                                         <td>
                                                                                                              <input type="text" class="dtpRegAppntmnt form-control col-md-7 col-xs-12" 
