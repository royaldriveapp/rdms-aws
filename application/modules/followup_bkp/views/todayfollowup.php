                    ...
                    <div class="x_content">
                         <div class="" role="tabpanel" data-example-id="togglable-tabs">
                              <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="background: none;">
                                   ...
                                   <?php } if (check_permission('notify_todayfollowup', 'showystrdayfollowup')) {?>
                                   <li role="presentation">
                                        <a href="#tab_yesterdayfollowup" id="dar-tab" role="tab" data-toggle="tab" aria-expanded="true">Yesterday's followup</a>
                                   </li>
                                   <?php } ?>
                              </ul>
                              <div id="myTabContent" class="tab-content">
                                   ...
                                   <?php } if (check_permission('notify_todayfollowup', 'showystrdayfollowup')) {?>
                                   <div role="tabpanel" class="tab-pane fade" id="tab_yesterdayfollowup" aria-labelledby="dar-tab">
                                        <table class="datatableFollowup datatable-resp table table-striped table-bordered">
                                             <thead>
                                                  <tr>
                                                       <th>Customer</th>
                                                       <th>Sales officer</th>
                                             ...
                                             <tbody>
                                                  <?php
                                                    if (!empty($yesterdayFollowups)) {
                                                         foreach ((array) $yesterdayFollowups as $key => $yfol) {
                                                              $canEdit = 'trVOE';
                                                              $trColor = empty($yfol['foll_customer_feedback_added_date']) ? 'style="background-color:red;color:#fff;"' : '';
                                                              ?>
                                                              <tr <?php echo $trColor; ?> data-url="<?php echo site_url('enquiry/printTrackCard/' . encryptor($yfol['enq_id']));?>">
                                                                   <td class="trVOE"><?php echo $yfol['enq_cus_name'];?></td>
                                                                   <td class="trVOE"><?php echo $yfol['usr_first_name'];?></td>
                                                                   <td class="<?php echo $canEdit;?>">
                                                                        <?php
                                                                        $mods = unserialize(MODE_OF_CONTACT);
                                                                        echo isset($mods[$yfol['enq_mode_enq']]) ? $mods[$yfol['enq_mode_enq']] : '';
                                                                        ?>
                                                                   </td>
                                                                   <td class="<?php echo $canEdit;?>">
                                                                        <?php
                                                                        $mods = unserialize(FOLLOW_UP_STATUS);
                                                                        echo isset($mods[$yfol['enq_cus_when_buy']]) ? $mods[$yfol['enq_cus_when_buy']] : '';
                                                                        ?>
                                                                   </td>
                                                                   <td class="<?php echo $canEdit;?>"><?php echo $yfol['foll_customer_feedback'];?></td>
                                                                   <td class="trVOE"><?php echo date('j M Y', strtotime($yfol['foll_next_foll_date']));?></td>
                                                                   <td class="trVOE"><?php echo !empty($yfol['foll_customer_feedback_added_date']) ?
                                                                    date('j M Y', strtotime($yfol['foll_customer_feedback_added_date'])) : '';?></td>
                                                              </tr>
                                                              <?php
                                                         }
                                                    }
