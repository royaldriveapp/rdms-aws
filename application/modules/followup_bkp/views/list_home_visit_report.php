          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    <div class="x_title">
                         ...
                         <?php
                           $hot_status = unserialize(ENQUIRY_UP_STATUS);
                         ?>
                         <form action="<?php echo site_url('/followup/home_visit_report');?>" method="get" id="filterForm">
                              ...
                              <table>
                                   <tbody>
                                        <tr>
                                             ...
                                             <td>
                                                  <select  class="select2_group form-control cmbShowroom shorm_stf" name="is_visited" ><option value="">Select</option><option <?php echo $_GET['is_visited'] == 1 ? 'selected' : ''?> value="1">Visited</option></select>
                                             </td>
                                             <td>
                                                  <input autocomplete="off" name="hmv_date_frm" type="text" class="dtpDatePickerDMY form-control col-md-7 col-xs-12" 
                                                         placeholder="Date from" value="<?php echo isset($_GET['hmv_date_frm']) ? $_GET['hmv_date_frm'] : '';?>"/>
                                             </td>
                                             <td style="padding-left: 10px;">
                                                  <input autocomplete="off" name="hmv_date_to" type="text" class="dtpDatePickerDMY form-control col-md-7 col-xs-12" 
                                                         placeholder="Date to" value="<?php echo isset($_GET['hmv_date_to']) ? $_GET['hmv_date_to'] : '';?>"/>
                                             </td>
                                             ...
                                             <td>
                                                  <select class="select2_group form-control enq_se_id" name="staff">
                                                       ...
                                                       <?php foreach ($staff as $key => $value) {?>
                                                              ...
                                                              <?php echo (isset($_GET['staff']) && ($_GET['staff'] == $value['col_id'])) ? 'selected="selected"' : '';?>
