...
{//from registration popup
    ...
    $formData = [
        ...
        'cusd_whatsapp'=> $this->input->post('new_cus_whatsapp'),
...
public function add() {//detailed form
    ...
    $customerData = [
        ...
        'cusd_profession' => $data['cusd_profession'] ?? null,
...
public function update($id) {
    ...
    'cusd_profession' =>$this->input->post('cusd_profession'),
