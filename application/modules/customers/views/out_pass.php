                              ...
                              <div class="form-horizontal form-label-left">
                                   ...
                                   <?php if (check_permission('tracking', 'showbookingno')) { ?>
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="user-name">Booking No</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <select class="select2_group form-control select2" name="trk_booking_no" required="required" onchange="$('.cmbVehicleNo').select2().select2('val',$(this).find(':selected').data('valid'));">
                                                       <option value="">Booking number</option>
                                                       <?php foreach ((array) $bookings as $key => $value) { ?>
                                                            <option value="<?php echo $value['vbk_id']; ?>" data-valid="<?php echo $value['val_id']; ?>">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control cmbVehicleNo" name="trk_vehicle_no" required="required">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input placeholder="DD-MM-YYYY H:M AM/PM" value="<?php echo date('d-m-Y h:i:A'); ?>" id="trk_out_date" name="trk_out_pass_time" type="text" required="required" class="dtpDateTimePicker form-control col-md-7 col-xs-12">
                                        </div>
                                   </div>
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" id="trk_purpose" name="trk_out_pass_purpose" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                   </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select class="select2_group form-control cmbSearchList" name="trk_out_pass_rd_driver" required="required" onchange="if ($(this).val() == -1) {
                                                                    $('.divDriver').show();
                                   ...
                                   <div class="form-group divDriver" style="display: none;">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input id="trk_veh_driver_out" class="form-control col-md-7 col-xs-12" name="trk_out_pass_other_driver" required="required">
                                   ...
                                   <div class="form-group divOutPassToPlace" style="display: none;">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input id="trk_out_pass_to_place" class="form-control col-md-7 col-xs-12" type="text" name="trk_out_pass_to_place">
                                        </div>
                                   </div>
                                   <div class="form-group">
                                        <label for="enq_cus_whatsapp" class="control-label col-md-3 col-sm-3 col-xs-12">Current KM (OUT)</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input id="trk_km_out" class="form-control col-md-7 col-xs-12 numOnly" type="number" name="trk_out_pass_km" required="required">
                                        </div>
                                   </div>
                                   <div class="form-group">
                                        <label for="enq_cus_whatsapp" class="control-label col-md-3 col-sm-3 col-xs-12">Estimate Arrival Date and Time</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input id="trk_est_date" class="form-control col-md-7 col-xs-12 dtpDateTimePicker" type="text" name="trk_out_pass_est_return_time" required="required" placeholder="DD-MM-YYYY H:M AM/PM">
                                        </div>
                                   </div>
