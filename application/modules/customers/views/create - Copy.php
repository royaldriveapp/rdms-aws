                                   ...
                                   <div class="panel-body">
                                        ...
                                        <div id="phoneContainer">
                                             <div class="form-group phoneField">
                                                  ...
                                                  <button type="button" class="addPhone btn btn-warning" id="addPhone">+Phone
                                                       <!-- Button stays here -->
                                                  </button>
                                             </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12 cusd_email " name="cusd_email " id="cusd_email " placeholder="Email" value="<?php echo isset($customerEmail) ? $customerEmail : ''; ?>" />
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Fb </label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12 cusd_email " name="cusd_fb " id="cusd_fb " placeholder="Facebook" />
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Age </label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" class="form-control col-md-7 col-xs-12 numOnly cusd_age" name="cusd_age " id="cusd_age " placeholder="Age" />
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <label for="cusd_gender" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Gender</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <select class="select2_group form-control form-control-enq cusd_gender" name="cusd_gender">
                                        ...
                                        <div class="form-group">
                                             <label for="cusd_gender" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Company</label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
