    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="x_panel tile">
                            <div class="x_title">
                                ...
                                <?php if($this->uid == 100) {?>
                                <span><a href="<?php echo site_url('settings/wishesAlert'); ?>">Send wishes</a></span>
                                <?php } ?>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content" style="height:240px; overflow-y: scroll;overflow-x: hidden;">
                                ...
                                <table class="display nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            <?php echo (date('j M') == date('j M', strtotime($value['usr_dob']))) ? 'style="color:green;background:#f0eded;"' : ''; ?>>
                            ...
                            <div class="x_content" style="height:240px; overflow-y: scroll;overflow-x: hidden;">
                                ...
                                <table class="display nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            <?php echo (date('j M') == date('j M', strtotime($value['usr_doj']))) ? 'style="color:green;background:#f0eded"' : ''; ?>>
                                            <td><?php echo $value['usr_username'] . ' (' . $value['shr_location'] . ')'; ?>
                                            </td>
                            ...
                            <div class="x_content" style="height:240px; overflow-y: scroll;overflow-x: hidden;">
                                ...
                                <table class="display nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            <?php echo (date('j M') == date('j M', strtotime($value['usr_marriage_date']))) ? 'style="color:green;background:#f0eded"' : ''; ?>>
                                            <td><?php echo $value['usr_username'] . ' (' . $value['shr_location'] . ')'; ?>
                                            </td>
                ...
                <div class="x_content">
                    <form id="demo-form2" method="post"
                        action="<?php echo site_url($controller . '/newstaffrequest'); ?>" data-parsley-validate
                        class="form-horizontal form-label-left frmEmployee" enctype="multipart/form-data">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <select required class="cmbShowRoom select2_group form-control" id="usr_showroom"
                                    name="usr_showroom" data-url="<?php echo site_url('emp_details/getTeamLeads'); ?>"
                                    onchange="$('.usr_division').val(($('#usr_showroom option:selected').attr('data-div')))">
                                    <option value="">Select Branch</option>
                                    <?php foreach ($showroom as $key => $value) { ?>
                                    <option data-div="<?php echo $value['div_id']; ?>"
                                        value="<?php echo $value['shr_id']; ?>">
                                        <?php echo $value['shr_location'] . ' (' . $value['div_name'] . ')'; ?></option>
                                    <?php } ?>
                                </select>
                                <input type="hidden" name="usr_division" class="usr_division" value="0" />
                            </div>

                            <div class="form-group col-md-2">
                                <label for="inputPassword4">RD Mobile</label>
                                <input type="text" id="last-name" name="usr_phone" data-past=".usr_whatsapp"
                                    class="pastContent numOnly form-control">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="inputEmail4">RD WhatsApp</label>
                                <input type="text" id="last-name" name="usr_whatsapp"
                                    class="numOnly form-control usr_whatsapp">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="inputEmail4">Personal Mobile <span class="required">*</span></label>
                                <input type="text" id="last-name" name="usr_mobile_personal"
                                    class="numOnly form-control usr_mobile_personal">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Personal email </label>
                                <input type="text" id="last-name" name="usr_persnl_email"
                                    class="pastContent form-control">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input autocomplete="off" value="India" type="text" name="usr_country" required
                                    class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input autocomplete="off" type="text" value="Kerala" name="usr_state"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select required class="select2_group form-control" name="usr_district"
                                    id="vreg_district">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" id="usr_father_name" name="usr_father_name" required
                                    class="form-control">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="inputPassword4">Marriage date</label>
                                <input type="text" id="usr_marriage_date" name="usr_marriage_date"
                                    class="dtpDatePickerDMY form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-2">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" id="usr_previous_exp" name="usr_previous_exp" required
                                    class="form-control">
                            </div>
                            <div class="form-group col-md-2">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" name="usr_doj" required="required"
                                    class="dtpDatePickerDMY form-control">
                            </div>
                            <div class="form-group col-md-2">
                ...
                <div class="x_content">
                                ...
                                <div class="card card-body">
                                    <form class="x_content frmFilter">
                                        <div style="float: left;width: 100%;">
                                            <select name="desig[]" multiple="multiple"
                                                class="cmbMultiSelect select2_group filter-form-control cmbType style="
                                                float: left;width: 30%;">
                                                <option value="">Select designation</option>
                                                <?php foreach ($designation as $key => $value) { ?>
                                                <option value="<?php echo $value['desig_id']; ?>">
                                            ...
                                            <select class="filter-form-control cmbBindShowroomByDivision"
                                                ...
                                                <option
                                                    <?php echo (isset($_GET['division']) && ($_GET['division'] == $value['div_id'])) ? 'selected="selected"' : ''; ?>
                                            ...
                                            <div class="div-filter-form-control">
                                                <select
                                                    class="filter-form-control cmbBindShowroomByDivision cmbShowroom shorm_stf"
                                                    name="showroom" id="showroom">
                                                    <option value="">Select showroom</option>
                                                    <?php foreach ($showroom['associatedShowroom'] as $key => $value) { ?>
                                                    <option
                                                        <?php echo (isset($_GET['showroom']) && ($_GET['showroom'] == $value['col_id'])) ? 'selected="selected"' : ''; ?>
                                            ...
                                            <div class="div-filter-form-control">
                                                <select data-placeholder="resigned" name="resigned"
                                                    class="select2_group filter-form-control  ">
                    ...
                    <table id="staff-table" class="display nowrap table table-striped table-bordered"
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="extension" class="display nowrap"
                        style="font-size:15px;width:100%;white-space: nowrap;font-weight: bolder;">
                        <thead>
                            <tr>
                                <th>Ext</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td title="<?php echo $title; ?>">
                                    <a target="blank"
                                        href="sip:<?php echo $value['ext_number']; ?>"><?php echo $value['ext_number']; ?></a>
                                </td>
                                <td title="<?php echo $title; ?>">
                                    <a target="blank"
                                        href="sip:<?php echo $value['ext_name']; ?>"><?php echo $value['ext_name']; ?></a>
                                </td>
    ...
    var darTable = $('#staff-table').DataTable({
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, full, meta) {
                    return '<a href="https://api.whatsapp.com/send?phone=' + full.usr_mobile_personal +
                        '">' +
                        full.usr_mobile_personal + '</a>';
                }
            },
            {
                "data": "usr_doj",
