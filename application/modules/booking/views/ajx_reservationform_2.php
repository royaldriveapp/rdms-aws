                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><input required type="text" class="txtVehiclePrice form-control col-md-7 col-xs-12 decimalOnly" name="bm[vbk_vehicle_amt]" value="0.00" id="mod_title" placeholder="Vehicle sold price" />
                                                                <?php if (get_settings_by_key('show_bl_on_sales') == 1) { ?>
                                                                    <spam style="font-size:9px; font-style: italic;">Bank
                                                                        part</spam>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="txtBlAmt form-control col-md-7 col-xs-12 decimalOnly" name="bm[vbk_bl_amt]" value="0.00" id="mod_title" placeholder="Discount" />
                                                                <?php if (get_settings_by_key('show_bl_on_sales') == 1) { ?>
                                                                    <spam style="font-size:9px; font-style: italic;">Bank part remove three zero from last</spam>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
