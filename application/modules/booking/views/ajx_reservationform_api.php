                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table class="table table-bordered" style="margin-bottom: 0px;">
                                            <tr>
                                                <td>Customer name : <input name="bm[vbk_cust_name]" class="select2_group form-control" value="<?php echo ($is_api == 1) ? $booking['ab_name'] : @$enquiry['enq_cus_name']; ?>" /></td>
                                            ...
                                            <tr>
                                                <td colspan="">Permanent address :
                                                    <textarea name="bm[vbk_per_address]" class="form-control col-md-7 col-xs-12">
                                                    <?php echo ($is_api == 1) ? $booking['ab_address'] . ',' . $booking['ab_district'] : @$enquiry['enq_cus_address'] . ',' . $enquiry['cit_name']; ?> 
                                                   </textarea>
                                                </td>
                                                <td>
                                                    RC Transfer address :
                                                    <textarea name="bm[vbk_rd_trans_address]" class="form-control col-md-7 col-xs-12">
                                                    <?php echo ($is_api == 1) ? $booking['ab_address'] . ',' . $booking['ab_district'] : @$enquiry['enq_cus_address'] . ',' . $enquiry['cit_name']; ?> 
                                                    </textarea><br>
                                            ...
                                            <tr>
                                                <td>Phone number (Official) : <input name="bm[vbk_off_ph_no]" class="numOnly select2_group form-control" value="<?php echo ($is_api == 1) ? '' : @$enquiry['enq_cus_mobile']; ?>" /></td>
                                                <td>Phone number (Personal) : <input name="bm[vbk_per_ph_no]" class="numOnly select2_group form-control" value="<?php echo ($is_api == 1) ? '' : @$enquiry['enq_cus_mobile']; ?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>Email ID : <input type="email" required name="bm[vbk_email]" class="select2_group form-control" value="<?php echo ($is_api == 1) ? '' : @$enquiry['enq_cus_email']; ?>" /></td>
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="txtAdvanceAmt form-control col-md-7 col-xs-12 decimalOnly" name="bm[vbk_advance_amt]" value="<?php echo ($is_api == 1) ? $booking['ab_advance_amount'] : '0.00'; ?>" id="mod_title" placeholder="Advance Amount" />
                                                            </td>
                                                        </tr>
                                                        <tr>
