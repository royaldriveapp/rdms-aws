                         ...
                         <form method="post" action="<?php echo site_url('booking/decisionMaking'); ?>" 
                              ...
                              <table class="table table-bordered">
                                   <tr>
                                        ...
                                        <td>
                                             ...
                                             <input <?php echo ($bookingDetails['vbk_rfi_dsa'] == 1) ? 'checked' : ''; ?> 
                                                  style="margin:6px;" type="checkbox" name="bm[vbk_rfi_dsa]" value="1"/> DSA <br>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                             <span class="small">Expecting payout amount</span>
                                             <input type="text" title="Expecting payout amount" placeholder="Expecting payout amount" 
                                                    value="<?php echo $bookingDetails['vbk_rfi_exp_payout']; ?>" name="bm[vbk_rfi_exp_payout]" class="select2_group form-control"/>
                                        </td>
                                        <td>
                              ...
                              <table class="table table-bordered tblRFIPaprColtd">
                                   <tr>
                                        <th colspan="3" style="text-align: center;">Papers collected</th>
                              ...
                              <!-- -->
                              <div class="modal fade" id="rcstatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                   <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                             <div class="modal-header">
                                                  <h5 style="float: left;" class="modal-title" id="exampleModalLabel">RC Status</h5>
