<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Order Booking From
                    </h2>
                    <div class="clearfix"></div>
                </div>

                <div class="x_content">
                    <form class="frmReserveVehicle1" action="<?php echo site_url('booking/reserveVehicle'); ?>" enctype="multipart/form-data" method="post">
                        <div class="row">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table class="table table-bordered" style="margin-bottom: 0px;">
                                            <tr>
                                                <td>Customer name : <input name="bm[vbk_cust_name]" class="select2_group form-control" value="<?php echo $enquiry['enq_cus_name']; ?>" /></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    RC Transfer address :
                                                    <textarea name="bm[vbk_rd_trans_address]" class="form-control col-md-7 col-xs-12"><?php echo $enquiry['enq_cus_address'] . ', ' . $enquiry['cit_name']; ?></textarea><br>
                                                    PIN : <input required class="numOnly" type="text" name="bm[vbk_pin]" value="" />
                                                    ...
                                                    PIN : <input required class="numOnly" type="text" name="bm[vbk_rc_trns_pin]" value="" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Phone number (Official) : <input name="bm[vbk_off_ph_no]" class="numOnly select2_group form-control" value="<?php echo $enquiry['enq_cus_mobile']; ?>" /></td>
                                                <td>Phone number (Personal) : <input name="bm[vbk_per_ph_no]" class="numOnly select2_group form-control" value="<?php echo $enquiry['enq_cus_mobile']; ?>" /></td>
                                            </tr>
                                            <tr>
                                                <td>Email ID : <input type="email" required name="bm[vbk_email]" class="select2_group form-control" value="<?php echo $enquiry['enq_cus_email']; ?>" /></td>
                                        ...
                                        <table class="table table-bordered tblBokDocs">
                                            ...
                                            <tr class="trBokDocsn">
                                                ...
                                                <label for="foll_status" class="control-label col-md-3 col-sm-3 col-xs-12">Aadhaar
                                                    ...
                                                    <input class="select2_group form-control" type="text" name="ap[vbd_doc_number][]" placeholder="Aadhaar Number" />
                                                </td>
                                                
                                                <td>
                                                    <input type="file" name="vbd_doc_file[]" required />
                                                </td>
                                        ...
                                        <table class="table table-bordered tblBokDocs">
                                            ...
                                            <tr class="trBokDocsn">
                                                ...
                                                <label for="foll_status" class="control-label col-md-3 col-sm-3 col-xs-12">PAN
                                                    ...
                                                    <input class="select2_group form-control" type="text" name="ap[vbd_doc_number][]" placeholder="PAN Number" />
                                                </td>
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="txtVehiclePrice form-control col-md-7 col-xs-12 decimalOnly" name="bm[vbk_vehicle_amt]" value="0.00" id="mod_title" placeholder="Vehicle sold price" />
                                                                <?php if (get_settings_by_key('show_bl_on_sales') == 1) { ?>
                                                                    <spam style="font-size:9px; font-style: italic;">Full amount</spam>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php if (get_settings_by_key('show_bl_on_sales') == 1) { ?>
                                                            <tr>
                                                                <td>Discount</td>
                                                                <td><input type="text" class="form-control col-md-7 col-xs-12 decimalOnly" name="bm[vbk_bl_amt]" value="0.00" id="mod_title" placeholder="Discount" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="txtAdvanceAmt form-control col-md-7 col-xs-12 decimalOnly" name="bm[vbk_advance_amt]" value="0.00" id="mod_title" placeholder="Advance Amount" />
                                                            </td>
                                                        </tr>
                                                        <tr>
