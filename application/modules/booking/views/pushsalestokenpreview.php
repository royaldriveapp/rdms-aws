    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?php echo form_open_multipart($controller . "/pushsalestoken", array('id' => "frmBrand", 'class' => "form-horizontal form-label-left")) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" name="postfields[dueDate]" value="<?php echo $saleData['vbk_added_on']; ?>" />
                        </div>
                    </div>
