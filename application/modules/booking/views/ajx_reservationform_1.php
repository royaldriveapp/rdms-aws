<div class="popReservationForm_1 modal fade" id="exampleModal" tabindex="-1" role="dialog"
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="tblStockVehicle table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr title="<?php echo $value['val_id']; ?>">
                                        ...
                                        <td>
                                            <?php if($enqId==0){ ?>
                                                <a
                                                href="<?php echo site_url('booking/bindVehicleDetails/' . encryptor($value['val_id']) . '/' . encryptor($enqId). '/' . encryptor($ab_id)); ?>">
                                                <i class="fa fa-arrow-right btnReserveVehicle"></i>
                                            </a>
                                                <?php }else{?>
                                                    <a
                                                href="<?php echo site_url('booking/bindVehicleDetails/' . encryptor($value['val_id']) . '/' . encryptor($enqId)); ?>">
                                                <i class="fa fa-arrow-right btnReserveVehicle"></i>
                                            </a>
