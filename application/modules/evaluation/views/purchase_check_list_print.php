          ...
          <div class="page" id="printDiv">
               <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                         ...
                         <div class="x_title">
                              <h2>Purchase check list
                                   <p style="float:right;font-size: 10px;">
                                        <?php echo (isset($result['masterData']['pcl_stock_num']) && !empty($result['masterData']['pcl_stock_num'])) 
                                             ...
                                             <table class="toptable table table-stripedk table-borderedj">
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><b>Vehicle Received Date :</b><?php echo date('d-m-Y', strtotime($result['masterData']['pcl_created_at']));?> </td>
                                                       </tr>
                                                  </tbody>
                                             </table>
                                        </div>
                                                    ...
                                                    foreach ($result['detailsData'] as $key => $value) {
                                                         if ($key % 2 != 0) {
                                                              ...
                                                              <tr <?php echo $hilighter; ?>>
                                                                   ...
                                                                   <td><?php 
                                                                  echo unserialize(PURCHASE_CHK_LIST_VALUE)[$value->pcld_check_list_item_value];
                                                                   ?>
                                                                   </td>
                                                         ...
                                                         if ($key % 2 == 0) {
                                                             $hilighter = ($value->pcld_check_list_item_value == 0) ? 'style="color:red;font-weight: bolder;"' : '';
                                                              ...
                                                              <tr <?php echo $hilighter; ?>>
                                                                   <td><?php echo $slno++?></td>
                                                                   <td><?php echo $value->chitem_name;?></td>
                                                                   <td><?php echo unserialize(PURCHASE_CHK_LIST_VALUE)[$value->pcld_check_list_item_value];?></td>
                                                                   <td><?php echo $value->pcld_remarks;?></td>
                                                              </tr>
                                                              <?php
                                                         }
