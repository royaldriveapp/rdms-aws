<div class="right_col" role="main">
                                               ...
                                               if (!empty($result['items'])) {
                                                    ...
                                                    foreach ($result['items'] as $key => $value) {
                                                         if ($key % 2 != 0) {
                                                              ...
                                                              //https://vestletech.com/demo/api/mob/getChkDtls?grp_slug=TL&user_id=333&usr_showroom=2&chitem_id=19&check_list_mstrId=6
                                                           ?>
     ...
     <option value="1" <?php echo ($chkLstData->pcld_check_list_item_value == 1) ? 'selected' : '';?> >Yes</option>
     <option value="0" <?php echo ($chkLstData->pcld_check_list_item_value == 0) ? 'selected' : '';?>>No</option>
     <option value="2" <?php echo ($chkLstData->pcld_check_list_item_value == 2) ? 'selected' : '';?>>NA</option>
</select>     
                                                                 </td>
