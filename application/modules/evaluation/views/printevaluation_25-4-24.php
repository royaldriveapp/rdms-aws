                                        ...
                                        <?php if (check_permission('evaluation', 'update') || is_roo_user()) { ?>
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <?php if ($vehicles['val_can_edit'] == 1) { ?>
                                                    <li><a target="blank" href="<?php echo site_url('evaluation/view/' . encryptor($vehicles['val_id'])); ?>">Evaluate</a>
                                                    </li>
                                                <?php }
                                                if (is_roo_user()) { ?>
                                                    <li><a target="blank" href="<?php echo site_url('evaluation/printevaluation_blank/'); ?>">Print blank page</a></li>
                                                    <li><a target="blank" href="<?php echo site_url('evaluation/pushpurchase/' . encryptor($vehicles['val_id'])); ?>">Push Purchase</a></li>
                                                <?php }
                                    ...
                                    <div style="margin-top: 300px;">
                                        ...
                                        <?php if (!empty($vehicles['complaints'])) { ?>
                                            <div class="row">
                                                ...
                                                ?>
                                                        <div class="gallery">
                                                            <a target="_blank" href="<?php echo site_url('../assets/uploads/evaluation/' . $img); ?>">
                                                                <?php echo img(array(
                                                                    'src' => site_url('../assets/uploads/evaluation/' . $img), 'width' => "200",
                                                                    'height' => "200", 'width' => '600', 'height' => '400'
                                                                )); ?>
                                                            </a>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel tile overflow_hidden">
                                            ...
                                            <div class="x_content">
                                                    ...
                                                    <div class="form-group" style="float: left;">
                                                        <div class="gallery deleteRow<?php echo $value['vdoc_id']; ?> col-md-6 col-sm-6 col-xs-12" style="padding: 10px;">
                                                            ...
                                                            <div style="float: left;">
                                                                <a href="<?php echo $fl; ?>" target="_blank" class="btn btn-primary btn-xs" style="margin-bottom: 0px;"><i class="fa fa-file-o"></i> View</a>
                                                                <?php if (check_permission('evaluation', 'deletedocument')) { ?>
                                                                    <a data-url="<?php echo site_url('evaluation/deleteDocument/' . encryptor($value['vdoc_id'])); ?>" data-id="<?php echo $value['vdoc_id']; ?>" href="javascript:;" class="deleteRow btn btn-danger btn-xs" style="margin-bottom: 0px;">
                                                                        <i class="fa fa-trash-o"></i> Delete</a>
                                                                <?php } ?>
                                                ...
                                                <?php } ?>
                                                <form id="demo-form2" method="post" action="<?php echo site_url($controller . '/uploadvehicledocument'); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                ...
                                <div class="page" id="printRefrb">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <a href="<?php echo site_url('evaluation/refurbisheReturn/' . encryptor($vehicles["val_id"])); ?>" class="btn btn-info no-print refurbRetBtnk" id="edit_btn" style="float: right;"><i class="fa fa-edit" style="color:White"></i>
                                                Edit</a>
                                            <div class="x_content">
                                                <div class="chk-container" style="float: right;width: 100%;">
                                                    <h1 style="color: red;">Under Maintenance :(</h1>
                                                    <h3 class="border-bottom border-gray pb-2 text-center">Refurbishment
                                                    </h3>
                                                    <div class="row">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td><b>Date of Stocking :</b>
                                                                            <?php echo $result['masterData']['pcl_created_at'] ? date('d-m-Y', strtotime($result['masterData']['pcl_created_at'])) : ''; ?>
                                                                        </td>
                                                                        <td></td>
                                                                    </tr>
                                                                    <!-- <tr>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <table class="tabled table-striped refrftable">
                                                            <tr>
                                                                ...
                                                                <th style="width:3%;" class="no-print">Date</th>
                                                            ...
                                                            if (!empty($refurbDetails)) {
                                                                foreach ($refurbDetails as $key => $value) {
                                                                    $ttlEst = $ttlEst + (int) $value->upgrd_value;
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        <td><?php echo $slno++ ?></td>
                                                                        <td class="no-print"><?php echo $value->upgrd_added_on; ?></td>
                                                                        ...
                                                                        <td><?php echo ($value->upgrd_refurb_actual_cost > 0) ? get_in_currency_format($value->upgrd_refurb_actual_cost) : ''; ?></td>
                                                                        <td><?php echo $value->ven_name; ?></td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="border: none !important;font-size: 16px;font-weight: bold;">
                                                                    Total</td>
                                                                <td style="border: none !important;" class="no-print"></td>
                                                                <td style="border: none !important;font-size: 16px;font-weight: bold;">
                                                                    <?php echo get_in_currency_format($ttlEst) > 0  ? get_in_currency_format($ttlEst) : ''; ?>
                                                                </td>
                                                                <td style="border: none !important;"></td>
                                                                <td colspan="2" style="border: none !important;font-size: 16px;font-weight: bold;">
                                                                    <?php
                                                                    $ttlAct = array_sum(array_column($refurbDetails, 'upgrd_refurb_actual_cost'));
                                                                    echo ($ttlAct > 0) ? get_in_currency_format($ttlAct) : '';
                                                                    ?>
                                                                </td>
                                                            </tr>
                                                        </table>
                                        ...
                                        <table class="toptable table table-stripedk table-borderedj refrb-bottom-tbl">
                                            <tbody>
                                                <tr class="top-tbl-tr">
                                                    ...
                                                    <td>
                                                        <h5>Checked BY ( Delivery Co Ordinator / <br>Dy Manager - Inventory
                                                            )
                                                        </h5>
                                                    </td>
                                                    <td>
                    ...
                    <div class="tmpDocuments">
                        <div class="form-group" style="float: left;width: 100%;">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-8">
                                ...
                                <button value="28" name="status" type="submit" data-url="<?php echo site_url('evaluation/chgevstatusmanualy'); ?>" class="btnSubmitValuationAjax btn btn-success">Submit status <i class="fa fa-comments"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
