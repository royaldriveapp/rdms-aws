...
?>
<div class="purVeh purch-<?php echo $count?>">
     <hr class="dot-line">
     <span style="cursor: pointer;font-size: 18px;" class="glyphicon glyphicon-remove btnRemovePur"></span>
              <div class="table-responsive divVehDetailsBuy" >
                                        <table id="datatable-responsive" class="req_add_new vehDetailsBuy table table-stripedj table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                             <thead>
                                                  <tr>
                                                       <th colspan="11">
...
<!-- <input required="true" placeholder="KL-00-AA-0000" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12" type="text" name="vehicle[buy][veh_reg][]">-->
                                                  ...
                                                  <tr>
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td colspan="2">
                                                             <input placeholder="IDV"  class=" form-control col-md-7 col-xs-12 numOnly" 
                                                                   type="text" name="vehicle[buy][idv][]">
                                                       </td>
                                                       <td colspan="2">
                                                             <input placeholder="NCB%"  class=" form-control col-md-7 col-xs-12 numOnly" 
                                   ...
                                   <script>
                                         ...
                                         $(document).on('click', '.btnRemovePur', function () {                                   
                                      //  $(this).parent('.purVeh').remove();
                                       //$(this).parent('.purVeh').fadeOut();
                                        $(this).parent('.purVeh').hide('slow',function(){ 
    $(this).slideUp(150, function() {
        $(this).remove(); 
    }); 
});
                                         }); 
                                          $('.dtpDatePickerEvaluation').datetimepicker({format: "DD-MM-YYYY"});
