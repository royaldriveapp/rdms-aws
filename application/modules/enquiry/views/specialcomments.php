                         ...
                         <form class="form_wizard wizard_horizontal" action="#" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
                                   ...
                                   <tbody>
                                        ...
                                        <tr style="height: 35px;">
                                             <td style="width: 292px; height: 35px;" colspan="3">
                                                  <p><strong>District: <?php echo $trackCard['dit_name']?></strong></p>
                                             </td>
                              ...
                              <div class="form-horizontal form-label-left">
                                   <div id="form-step-0" role="form" data-toggle="validator">
                                        <div class="qstSell">
                                             <?php
                                               foreach ((array) $questions as $k => $value) {
                                                    ?>
                                                    <div class="form-group">
                                                         ...
                                                         <div class="col-md-6 col-sm-3 col-xs-12">
                                                              <?php if ($value['qus_is_togler'] == 1) { // Radio?>
                                                                   <input type="checkbox"  <?php echo $required;?> name="questions[<?php echo $value['qus_id'];?>]" value="1"/>
                                                              <?php } else { // Text box ?>
                                                                   <textarea autocomplete="off" <?php echo $required;?>  id="enq_cus_need" type="text" class="form-control col-md-7 col-xs-12" name="questions[<?php echo $value['qus_id'];?>]"></textarea>
                                                              <?php }?>
