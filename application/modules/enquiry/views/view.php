            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                         ...
                         ?>
                    <form id="wizard" data-url="<?php echo site_url('enquiry/update'); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="select2_group form-control cmbEnqStatus"
                                                        name="enquiry[enq_cus_status]" disabled="true">
                                                        <option
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select required="true"
                                                        class="select2_group form-control enq_se_id cmbSearchList"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo $enquiry['enq_cus_name'] ?>"
                                                        ...
                                                        class="enq_cus_name form-control col-md-7 col-xs-12" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input
                                                        ...
                                                        id="enq_cus_mobile"
                                                        class="enq_cus_mobile form-control col-md-7 col-xs-12 numOnly"
                                                        type="text" name="enquiry[enq_cus_mobile]">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="enq_cus_mobile"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Office No
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo $enquiry['enq_cus_office_no'] ?>"
                                                        id="enq_cus_office_no"
                                                        class="form-control col-md-7 col-xs-12 numOnly enq_cus_office_no"
                                            ...
                                            <div class="form-group">
                                                <label for="enq_cus_city"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Place<span
                                                        class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo $enquiry['enq_cus_city'] ?>"
                                                        id="enq_cus_city"
                                                        class="autoComCity form-control col-md-7 col-xs-12" type="text"
                                                        name="enquiry[enq_cus_city]">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input required value="<?php echo $enquiry['enq_cus_email'] ?>"
                                                        id="enq_cus_email"
                                                        class="form-control col-md-7 col-xs-12 emailOnly" type="text"
                                                        name="enquiry[enq_cus_email]">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="enq_cus_whatsapp"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Whatsapp</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo $enquiry['enq_cus_whatsapp'] ?>"
                                                        id="enq_cus_whatsapp"
                                                        class="form-control col-md-7 col-xs-12 numOnly enq_cus_whatsapp"
                                                        type="text" name="enquiry[enq_cus_whatsapp]">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="enq_cus_fbid"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Customer FB
                                                    Id</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo $enquiry['enq_cus_fbid'] ?>"
                                                        id="enq_cus_fbid" class="form-control col-md-7 col-xs-12"
                                                        type="text" name="enquiry[enq_cus_fbid]">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="enq_cus_age"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Age</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo $enquiry['enq_cus_age'] ?>"
                                                        class="form-control col-md-7 col-xs-12" type="text"
                                                        name="enquiry[enq_cus_age]">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group"><?php // print_r($Profession); 
                                                ...
                                                <label for="enq_cus_age_group"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Profession</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="select2_group form-control"
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="select2_group form-control"
                                                        ...
                                                        <option value="<?php echo $value['occ_cat_id']; ?>"
                                                            <?php echo $value['occ_cat_id'] == $enquiry['enq_cus_occu_category'] ? 'selected' : '' ?>>
                                            ...
                                            <div class="form-group">
                                                <label for="enq_cus_company"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Company <span
                                                        class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input required id="enq_cus_company"
                                                        value="<?php echo $enquiry['enq_cus_company']; ?>"
                                                        class="form-control col-md-7 col-xs-12" type="text"
                                                        name="enquiry[enq_cus_company]">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="enq_cus_phone_res"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Resi phone</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label for="enq_cus_state"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">State</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_country" value="91"
                                                        class="autoComCountry form-control col-md-7 col-xs-12"
                                                        type="hidden" name="enquiry[enq_cus_country]">
                                                    <select data-placeholder="Select State"
                                                        name="enquiry[enq_cus_state]"
                                                        class="BindDistirct select2_group form-control cmbMultiSelect"
                                                        data-url="<?php echo site_url('enquiry/bindDistrict'); ?>">
                                                        <option selected>-Select State-</option>
                                                        <?php foreach ($states as $state) { ?>
                                                        <option
                                                            <?php echo $state['sts_id'] == $enquiry['enq_cus_state'] ? 'selected' : '' ?>
                                                            value="<?php echo $state['sts_id'] ?>">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">District</label>
                                            ...
                                            <div class="form-group">
                                                <label for="enq_cus_pin"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Pin</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_pin"
                                                        class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                        value="<?php echo $enquiry['enq_cus_pin']; ?>"
                                                        name="enquiry[enq_cus_pin]">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="enq_budget"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Budget</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" class="form-control col-md-7 col-xs-12 numOnly"
                                                        name="enquiry[enq_budget]"
                                                        value="<?php echo $enquiry['enq_budget'] ?>" required
                                                        gtrzro="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="enq_vehicle_type"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Vehicle
                                                    type</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="select2_group form-control enq_cus_when_buy"
                                                        name="enquiry[enq_vehicle_type]" required>
                                                        <option value="">Select one</option>
                                                        <?php foreach (unserialize(ENQ_VEHICLE_TYPES) as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>"
                                                            <?php echo $key == $enquiry['enq_vehicle_type'] ? 'selected' : '' ?>>
                                                            <?php echo $value; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label for="enq_cus_status"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Mode of
                                                    enquiry</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select required
                                                        class="select2_group form-control enq_mode_enq cmbModeOfContact"
                                            ...
                                            <div class="form-group">
                                                <label for="enq_cus_age_group"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Purpose of the
                                                    Purchase</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="select2_group form-control"
                                            ...
                                            <div class="form-group" style="display: none" id="otherPurpose">
                                                <label for="enq_cus_remarks"
                                                    class="control-label col-md-3 col-sm-3 col-xs-12">Enter
                                                    purpose</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input placeholder="Enter purpose" value="" type="text"
                                                        class="form-control col-md-7 col-xs-12"
                                                        name="enq[other_purpose]" />
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>Money</th>
                                                    <td><input class="form-control col-md-7 col-xs-12"
                        ...
                        <div id="step-2" class="step2">
                            <div class="form-horizontal form-label-left">
                                <div id="form-step-0" role="form" data-toggle="validator">
                                    <div class="qstSell"
                                        style="<?php echo ($enquiry['enq_cus_status'] == 1) ? 'display: block;' : 'display: none;'; ?>">
                                        <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <textarea autocomplete="off" <?php echo $required; ?> id="enq_cus_need"
                                                    ...
                                                    name="saquestions[<?php echo $value['qus_id']; ?>]"><?php echo $answer; ?></textarea>
                                                <?php } ?>
                                    ...
                                    <div class="qstBuy"
                                        style="<?php echo ($enquiry['enq_cus_status'] == 2) ? 'display: block;' : 'display: none;'; ?>">
                                        <?php
                                    ...
                                    <div class="qstExch"
                                        style="<?php echo ($enquiry['enq_cus_status'] == 3) ? 'display: block;' : 'display: none;'; ?>">
                                        <?php
                        ...
                        <div id="step-3">
                            <?php //print_r($enquiry['vehicle_exist']);   
                                   ?> <h2 class="StepTitle lblSale"
                                style="<?php echo ($enquiry['enq_cus_status'] == 1 || $enquiry['enq_cus_status'] == 3) ? "" : "display:none;"; ?> width: 100%;">
                                Customer required vehicle<span style="float: right;cursor: pointer;"
                                    class="glyphicon glyphicon-plus btnAddVehDetailsRqVeh"></span></h2>
                            <div class="table-responsive divVehDetailsSale"
                                style="<?php echo ($enquiry['enq_cus_status'] == 1 || $enquiry['enq_cus_status'] == 3) ? "" : "display:none;"; ?>">
                                <?php
                                ...
                                $(document).ready(function() {
                                    $(".tblVehicleSales" + <?php echo $sales['veh_id']; ?> + " :input").prop(
                                        "disabled", false);
                                });
                                </script>
                                <?php } else { ?>
                                ...
                                <table id="datatable-responsive"
                                    class="req_color lbl vehDetailsSale tblVehicleSales<?php echo $sales['veh_id']; ?> tblVehicle<?php echo $sales['veh_id']; ?> table table-stripedj table-bordered dt-responsive nowrap"
                                        ...
                                        <tr class="req_head">
                                            <th colspan="11">
                                                ...
                                                <input type="hidden" name="vehicle[sale][veh_id][]"
                                                    value="<?php echo isset($sales['veh_id']) ? $sales['veh_id'] : ''; ?>" />
                                            </th>
                                        </tr>
                                        <tr class="">
                                            <th>Brand</th>
                                    ...
                                    <tbody>
                                        <tr class="lbl">
                                            <td>
                                                <select required="true" style="width: 170px;"
                                                    ...
                                                    <option
                                                        <?php echo (isset($sales['veh_brand']) && ($value['brd_id'] == $sales['veh_brand'])) ? 'selected="selected"' : ''; ?>
                                            ...
                                            <td>
                                                ...
                                                <select style="width: 170px;" required=""
                                                    ...
                                                    <option
                                                        <?php echo (isset($sales['veh_model']) && ($value['mod_id'] == $sales['veh_model'])) ? 'selected="selected"' : ''; ?>
                                            ...
                                            <td><?php $variant = $this->myEnquiry->bindVarient($sales['veh_model'], 'array'); ?>
                                                <select style="width: 170px;" required=""
                                                    ...
                                                    <option
                                                        <?php echo (isset($sales['veh_varient']) && ($value['var_id'] == $sales['veh_varient'])) ? 'selected="selected"' : ''; ?>
                                            ...
                                            <td>
                                                <select required="true" style="width: 170px;"
                                                    ...
                                                    <option
                                                        <?php echo (isset($sales['veh_fuel']) && ($key == $sales['veh_fuel'])) ? 'selected="selected"' : ''; ?>
                                            ...
                                            <td>
                                                ...
                                                <select data-placeholder="Select Year"
                                                    ...
                                                    <option value=""><?php echo $sales['veh_manf_year_from'] ?>From
                                                    </option>
                                                    <?php
                                                                           ...
                                                                           ?>
                                                    <option
                                                        <?php echo @$sales['veh_manf_year_from'] == $i ? 'selected' : '' ?>
                                            ...
                                            <td> <select data-placeholder="Select Year"
                                                    ...
                                                    <?php
                                                                           ...
                                                                           ?>
                                                    <option
                                                        <?php echo @$sales['veh_manf_year_to'] == $i ? 'selected' : '' ?>
                                                        value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                            ...
                                            <td>
                                                <select data-placeholder="Select Color"
                                                    ...
                                                    <option
                                                        <?php echo @$sales['veh_color'] == $vehicleColor['vc_id'] ? 'selected' : '' ?>
                                            ...
                                            <td>
                                                <select data-placeholder="Select KM"
                                                    ...
                                                    <option
                                                        <?php echo @$sales['veh_price_id'] == $price_range['pr_id'] ? 'selected' : '' ?>
                                            ...
                                            <td>
                                                <select data-placeholder="Select KM" name="vehicle[sale][veh_km_id][]"
                                                    ...
                                                    <option
                                                        <?php echo @$sales['veh_km_id'] == $km['kmr_id'] ? 'selected' : '' ?>
                                                        value="<?php echo $km['kmr_id']; ?>">
                                        ...
                                        <tr class="">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input placeholder="Prefer Number"
                                                    value="<?php echo @$sales['veh_prefer_no'] ?>" id="enq_cus_loan_emi"
                                            ...
                                            <td colspan="1">
                                                ...
                                                <input placeholder="Expected Date of Purchase"
                                                    value="<?php echo @$sales['veh_exptd_date_purchase'] ?>"
                                            ...
                                            <td colspan="5">
                                                ...
                                                <input placeholder="Remarks"
                                                    value="<?php echo @$sales['veh_remarks'] ?>" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12" type="text"
                                ...
                                <?php
                                             ...
                                             ?>
                                <table id="datatable-responsive"
                                    class="req vehDetailsSale table table-stripedj table-bordered dt-responsive nowrap"
                                    cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th colspan="11">
                                        ...
                                        <tr>
                                            <th colspan="11">
                                                ...
                                                <select style="width: 170px;"
                                                    ...
                                                    data-url="<?php echo site_url('enquiry/bindSalesTable'); ?>">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <select data-placeholder="Select Year" name="vehicle[sale][veh_year][]"
                                                    style="width: 170px;"
                                                    class="select2_group form-control cmbMultiSelectmm">
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                <!--                                                                   <input placeholder="Registration" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12" type="text" name="vehicle[sale][veh_reg][]">-->
                                                <input required="true" placeholder="KL" id="enq_cus_loan_emi"
                                                    style="width: 50px;text-transform:uppercase;"
                                                    class="form-control col-md-3 col-xs-3" type="text"
                                                    name="vehicle[sale][veh_reg1][]" autocomplete="off">
                                                <input required="true" placeholder="00" id="enq_cus_loan_emi"
                                                    style="width: 60px;" class="form-control col-md-3 col-xs-3 numOnly"
                                                    type="text" name="vehicle[sale][veh_reg2][]" autocomplete="off">
                                                <input required="true" placeholder="AA" id="enq_cus_loan_emi"
                                                    style="width: 60px;text-transform:uppercase;"
                                                    class="form-control col-md-3 col-xs-3" type="text"
                                                    name="vehicle[sale][veh_reg3][]" autocomplete="off">
                                                <input required="true" placeholder="0000" id="enq_cus_loan_emi"
                                                    style="width: 99px;" class="form-control col-md-3 col-xs-3 numOnly"
                                                    type="text" name="vehicle[sale][veh_reg4][]" autocomplete="off">
                                            </td>
                                            <td colspan="5">
                                                <input placeholder="Owner" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12" type="number"
                                                    name="vehicle[sale][veh_owner][]">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="11">
                            ...
                            <div class="table-responsive divVehDetailsSale" style="">
                                <h2 class="StepTitle lblSale"
                                    style="<?php echo ($enquiry['enq_cus_status'] == 1 || $enquiry['enq_cus_status'] == 3) ? "" : "display:none;"; ?> width: 100%;">
                                    2Existing vehicle<span style="float: right;cursor: pointer;"
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-responsive"
                                        class="existing lbl vehDetailsBuy table table-stripedj table-bordered dt-responsive nowrap"
                                        cellspacing="0" width="100%">
                                        <thead>
                                            ...
                                            <tr>
                                                <th class="labl"><?php //print_r($enquiry['vehicle_exist']); 
                                                                                          ?>Make</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select style="width: 170px;" class="select2_group form-control"
                                                        ...
                                                        <?php foreach (unserialize(FUAL) as $key => $value) { ?>
                                                        <option
                                                            <?php echo (isset($exist['veh_fuel']) && ($key == $exist['veh_fuel'])) ? 'selected="selected"' : ''; ?>
                                                            value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select data-placeholder="Select Year"
                                                        ...
                                                        <?php
                                                                                ...
                                                                                ?>
                                                        <option
                                                            <?php echo (isset($exist['veh_manf_year']) && ($i == $exist['veh_manf_year'])) ? 'selected="selected"' : ''; ?>
                                                            value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                        <?php } ?>
                                                ...
                                                <td>
                                                    <select data-placeholder="Select Color"
                                                        ...
                                                        <option value="<?php echo $key; ?>"
                                                            <?php echo $exist['veh_exchange_intrested'] == $key ? 'selected' : '' ?>>
                                                            <?php echo $value; ?></option>
                                                        <?php } ?>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <input value="<?php echo $exist['veh_exch_cus_expect']; ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <input value="<?php echo $exist['veh_owner']; ?>"
                                                        placeholder="Ownership" class="form-control col-md-7 col-xs-12"
                                                        type="number" name="vehicle[existing][veh_owner][]">
                                                </td>
                                                <td colspan="2">
                                                    <p class="labl">Insurance Validity</p>
                                                    <input value="<?php echo $exist['veh_insurance_validity']; ?>"
                                                        placeholder=" Insurance Validity "
                                                        class="dtpDatePickerDMY form-control col-md-7 col-xs-12"
                                                        type="text" name="vehicle[existing][insurance_validity][]">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="8">
                                                    <p class="labl">Tyre condition</p>
                                                    <input value="<?php echo $exist['tyre_condition']; ?>"
                                            ...
                                            <tr>
                                                <td colspan="8">
                                                    <p class="labl">Remarks</p>
                                                    <input value="<?php echo $exist['veh_remarks']; ?>"
                                                        placeholder="Remarks" class="form-control col-md-7 col-xs-12"
                                                        type="text" name="vehicle[existing][veh_remarks][]">
                                                </td>
                                            </tr>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-responsive"
                                        class="exssting_new vehDetailsBuy table table-stripedj table-bordered dt-responsive nowrap"
                                        cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th colspan="11">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <input placeholder="Market value" id="enq_cus_loan_emi"
                                                        class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                        name="vehicle[existing][market_value][]">

                                                </td>
                                                <td colspan="2">
                                                    <input placeholder="Our Offer" id="enq_cus_loan_emi"
                                                        class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                        name="vehicle[existing][our_offer][]">
                                                </td>
                                                <td colspan="2">
                                                    <input placeholder="Customer expectation" id="enq_cus_loan_emi"
                                                        class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                        name="vehicle[existing][veh_exch_cus_expect][]">
                                                </td>
                                            </tr>
                            ...
                            <?php
                                        ...
                                        ?>
                            <table id="datatable-responsive"
                                class="pitched lbl vehDetailsSale table table-stripedj table-bordered dt-responsive nowrap tbl"
                                cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" value="<?php echo $pitchedVehData['val_id']; ?>"
                                                name="vehicle[pitched][veh_val_id][]">
                                            <input type="hidden" name="vehicle[pitched][veh_id][]"
                                                value="<?php echo $pitched['veh_id']; ?>" />
                                        ...
                                        <td>
                                            ...
                                            <input value="<?php echo $pitched['veh_exch_cus_expect']; ?>"
                                                placeholder="Customer Offer" style="width: 100%;"
                                                class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input value="<?php echo $pitched['veh_remarks']; ?> "
                                                placeholder="Executive Remarks " class="form-control col-md-7 col-xs-12"
                                                type="text" name="vehicle[pitched][veh_remarks][]">
                                        </td>
                                        <td colspan="3">
                                            <input value="<?php echo $pitched['veh_tl_remarks']; ?>"
                                                placeholder="TL remarks " class="form-control col-md-7 col-xs-12"
                                                type="text" name="vehicle[pitched][veh_tl_remarks][]">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            <input value="<?php echo $pitched['veh_sm_remarks']; ?>"
                                                placeholder="SM Remarks " class="form-control col-md-7 col-xs-12"
                                                type="text" name="vehicle[pitched][veh_sm_remarks][]">
                                        </td>
                                        <td colspan="6">
                                            <input value="<?php echo $pitched['veh_gm_remarks']; ?>"
                                                placeholder="Gm Reamrk " class="form-control col-md-7 col-xs-12"
                                                type="text" name="vehicle[pitched][veh_gm_remarks][]">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="11">
                                            <label>Evaluated By :
                                                <?php echo $pitchedVehData['usr_first_name'] . ' ' . $pitchedVehData['usr_last_name']; ?></label>
                                        </td>
                                    </tr>
                            ...
                            <!-- @pitched1-->
                            <!-- pitched2 -->
                            <h2 class="StepTitle lblSale" style="width: 100%;">Add Pitched vehicle <span
                                    style="float: right;cursor: pointer;"
                                    class="glyphicon glyphicon-plus btnAddVehDetailsPitched"></span></h2>
                            <div class="table-responsive divVehDetailsPitched">
                                <table id="datatable-responsive"
                                    class="table table-striped table-bordered dt-responsive nowrap tbl" cellspacing="0"
                                    width="100%">
                                    <thead>
                                        <tr>
                                        <tr>
                                        ...
                                        <th colspan="11">
                                            ...
                                            <select style="width: 170px;float: left;"
                                                class="cmbSearchList select2_group form-control cmbStock"
                                                name="vehicle[pitched][veh_stock_id][]"
                            ...
                            <!-- @Pitched2 -->
                            <h2 class="StepTitle lblBuy"
                                style="<?php echo ($enquiry['enq_cus_status'] == 2 || $enquiry['enq_cus_status'] == 3) ? "" : "display:none;"; ?>width: 100%;">
                                Purchase<small> (Vehicle from customer)</small><span
                                    style="float: right;cursor: pointer;"
                                    class="glyphicon glyphicon-plus btnAddVehDetailsBuy"></span></h2>
                            <div class="table-responsive divVehDetailsBuy"
                                style="<?php echo ($enquiry['enq_cus_status'] == 2 || $enquiry['enq_cus_status'] == 3) ? "" : "display:none;"; ?>">
                                <?php
                                ...
                                <table id="datatable-responsive"
                                    class="vehDetailsBuy tblVehicleBuy<?php echo $buy['veh_id']; ?> tblVehicle<?php echo $buy['veh_id']; ?> table table-striped table-bordered dt-responsive nowrap"
                                    cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Brand</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <input
                                                    value="<?php echo isset($buy['veh_exch_cus_expect']) ? $buy['veh_exch_cus_expect'] : ''; ?>"
                                                    placeholder="Customeer expectation" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="text"
                                                    name="vehicle[buy][veh_exch_cus_expect][]">
                                            </td>
                                            <td colspan="2">
                                                <input
                                                    value="<?php echo isset($buy['veh_exch_estimate']) ? $buy['veh_exch_estimate'] : ''; ?>"
                                                    placeholder="Market estimate" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                    name="vehicle[buy][veh_exch_estimate][]">
                                            </td>
                                            <td colspan="2">
                                                <input
                                                    value="<?php echo isset($buy['veh_exch_dealer_value']) ? $buy['veh_exch_dealer_value'] : ''; ?>"
                                                    placeholder="Dealer valued" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                    name="vehicle[buy][veh_exch_dealer_value][]">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                                                <?php
                                                                      ...
                                                                      ?>
                                                <input value="<?php echo $regNo[0]; ?>" required="true" placeholder="KL"
                                                    id="enq_cus_loan_emi" style="width: 50px;text-transform:uppercase;"
                                                    class="form-control col-md-3 col-xs-3" type="text"
                                                    name="vehicle[buy][veh_reg1][]" autocomplete="off">
                                                <input value="<?php echo $regNo[1]; ?>" required="true" placeholder="00"
                                                    id="enq_cus_loan_emi" style="width: 60px;"
                                                    class="form-control col-md-3 col-xs-3 numOnly" type="text"
                                                    name="vehicle[buy][veh_reg2][]" autocomplete="off">
                                                <input value="<?php echo $regNo[2]; ?>" required="true" placeholder="AA"
                                                    id="enq_cus_loan_emi" style="width: 60px;text-transform:uppercase;"
                                                    class="form-control col-md-3 col-xs-3" type="text"
                                                    name="vehicle[buy][veh_reg3][]" autocomplete="off">
                                                <input value="<?php echo $regNo[3]; ?>" required="true"
                                                    placeholder="0000" id="enq_cus_loan_emi" style="width: 99px;"
                                                    class="form-control col-md-3 col-xs-3 numOnly" type="text"
                                                    name="vehicle[buy][veh_reg4][]" autocomplete="off">
                                            </td>
                                            <td colspan="2">
                                                <input
                                                    value="<?php echo isset($buy['veh_owner']) ? $buy['veh_owner'] : ''; ?>"
                                                    placeholder="Owner" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12" type="number"
                                                    name="vehicle[buy][veh_owner][]">
                                            </td>
                                            <td colspan="2">
                                                <input
                                                    value="<?php echo isset($buy['veh_chassis_number']) ? $buy['veh_chassis_number'] : ''; ?>"
                                                    placeholder="Chassis number" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12" type="text"
                                        ...
                                        <tr>
                                            <td colspan="8">
                                                <input
                                                    value="<?php echo isset($buy['veh_remarks']) ? $buy['veh_remarks'] : ''; ?>"
                                                    placeholder="Remarks" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12" type="text"
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <input
                                                    value="<?php echo isset($buy['veh_delivery_date']) ? date('d-m-Y', strtotime($buy['veh_delivery_date'])) : ''; ?>"
                                                    placeholder="First delivery date" id="veh_delivery_date"
                                                    class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12"
                                                    type="text" name="vehicle[buy][veh_delivery_date][]">
                                            </td>
                                            <td colspan="2">
                                                <input
                                                    value="<?php echo isset($buy['veh_first_reg']) ? date('d-m-Y', strtotime($buy['veh_first_reg'])) : ''; ?>"
                                                    placeholder="First reg date" id="veh_first_reg"
                                            ...
                                            <td colspan="1">
                                                <input
                                                    value="<?php echo isset($buy['veh_ac_zone']) ? $buy['veh_ac_zone'] : ''; ?>"
                                                    placeholder="Ac zone" id="veh_ac_zone"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="text"
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <input
                                                    value="<?php echo isset($buy['veh_cc']) ? $buy['veh_cc'] : ''; ?>"
                                                    placeholder="CC" id="veh_cc"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="text"
                                            ...
                                            <td colspan="2">
                                                <input
                                                    ...
                                                    placeholder="Engine number" id="veh_engine_num"
                                                    class="form-control col-md-7 col-xs-12" type="text"
                                            ...
                                            <td colspan="1">
                                                <input
                                                    ...
                                                    placeholder="No of seat" id="veh_seat_no"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="text"
                                ...
                                <?php
                                             ...
                                             ?>
                                <table id="datatable-responsive"
                                    class="vehDetailsBuy table table-striped table-bordered dt-responsive nowrap"
                                    cellspacing="0" width="100%">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input placeholder="Market estimate" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                    name="vehicle[buy][veh_exch_estimate][]">
                                            </td>
                                            <td colspan="2">
                                                <input placeholder="Dealer valued" id="enq_cus_loan_emi"
                                                    class="form-control col-md-7 col-xs-12 numOnly" type="number"
                                                    name="vehicle[buy][veh_exch_dealer_value][]">
                                            </td>
                                        </tr>
...
<div style="display: none;">
    <table id="datatable-responsive"
        class="tmpVehDetailsSale vehDetailsSale table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
        width="100%">
        ...
        <tbody>
            <tr>
                <td>
                    <select required="true" style="width: 170px;" class="select2_group form-control cmbBindModel"
                        data-url="<?php echo site_url('enquiry/bindModel'); ?>" name="vehicle[sale][veh_brand][]">
                        <option value="0">Select Brand</option>
                        <?php foreach ($brands as $key => $value) { ?>
                ...
                <td>
                    <select data-placeholder="Select Year" name="vehicle[sale][veh_year][]" style="width: 170px;"
                        class="select2_group form-control cmbMultiSelectmm">
                        <option value="">-Select Year-</option>
                        <?php
                              $earliest_year = YEAR_RANGE_START;
                ...
                <td>
                    <select data-placeholder="Select Color" name="vehicle[sale][veh_color][]" style="width: 170px;"
                        class="select2_group form-control  cmbMultiSelectjks">
                        <option value="0">-Select Color-</option>
                        <?php foreach ($vehicleColors as $vehicleColor) { ?>
                        <option value="<?php echo $vehicleColor['vc_id']; ?>"><?php echo $vehicleColor['vc_color'] ?>
                        </option>
                        <?php } ?>
                    </select>
                </td>
                <td>
                    <select data-placeholder="Select Price" name="vehicle[sale][veh_price_id][]" style="width: 170px;"
                        class="select2_group form-control  cmbMultiSelectjks">
                        <option value="">-Select Price-</option>
                        <?php foreach ($price_ranges as $price_range) { ?>
                        <option value="<?php echo $price_range['pr_id']; ?>"><?php echo $price_range['pr_range'] ?>
                        </option>
                ...
                <td>
                    <select data-placeholder="Select KM" name="vehicle[sale][veh_km_id][]" style="width: 170px;"
                        class="select2_group form-control  cmbMultiSelectjks">
                        <option value="">-Select KM-</option>
                        <?php foreach ($kms as $km) { ?>
                        <option value="<?php echo $km['kmr_id']; ?>"><?php echo $km['kmr_range_from'] ?> KM -
                            <?php echo $km['kmr_range_to'] ?> KM</option>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input required="true" placeholder="KL" id="enq_cus_loan_emi"
                        style="width: 50px;text-transform:uppercase;" class="form-control col-md-3 col-xs-3" type="text"
                        name="vehicle[sale][veh_reg1][]" autocomplete="off">
                    <input required="true" placeholder="00" id="enq_cus_loan_emi" style="width: 60px;"
                        class="form-control col-md-3 col-xs-3 numOnly" type="text" name="vehicle[sale][veh_reg2][]"
                        autocomplete="off">
                    <input required="true" placeholder="AA" id="enq_cus_loan_emi"
                        style="width: 60px;text-transform:uppercase;" class="form-control col-md-3 col-xs-3" type="text"
                        name="vehicle[sale][veh_reg3][]" autocomplete="off">
                    <input required="true" placeholder="0000" id="enq_cus_loan_emi" style="width: 99px;"
                        class="form-control col-md-3 col-xs-3 numOnly" type="text" name="vehicle[sale][veh_reg4][]"
                        autocomplete="off">
                </td>
                <td colspan="1">
                    <input placeholder="Owner" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12"
                        type="number" name="vehicle[sale][veh_owner][]">
                </td>


                <td colspan="5">
                    <input placeholder="Remarks" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12"
                        type="text" name="vehicle[sale][veh_remarks][]">
                </td>
            </tr>
    ...
    <table id="datatable-responsive"
        class="tmpVehDetailsBuy vehDetailsBuy table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
        width="100%">
        <thead>
            <tr>
                <th colspan="11">
        ...
        <tbody>
            <tr>
                <td>
                    <select required="true" style="width: 170px;" class="select2_group form-control cmbBindModelBuy"
                        data-url="<?php echo site_url('enquiry/bindModel'); ?>" name="vehicle[buy][veh_brand][]">
                        <option value="0">Select Brand</option>
                        <?php foreach ($brands as $key => $value) { ?>
                        <option value="<?php echo $value['brd_id'] ?>"><?php echo $value['brd_title'] ?></option>
                        <?php } ?>
                ...
                <td>
                    <select data-placeholder="Select Year" name="vehicle[buy][veh_year][]" style="width: 170px;"
                        class="select2_group form-control cmbMultiSelectmm">
                        <option value="">-Select Year-</option>
                        <?php
                              $earliest_year = YEAR_RANGE_START;
                ...
                <td>
                    <select data-placeholder="Select Color" name="vehicle[buy][veh_color][]" style="width: 170px;"
                        class="select2_group form-control  cmbMultiSelectjks">
                        <option value="0">-Select Color-</option>
                        <?php foreach ($vehicleColors as $vehicleColor) { ?>
                        <option value="<?php echo $vehicleColor['vc_id']; ?>"><?php echo $vehicleColor['vc_color'] ?>
                ...
                <td>
                    <select data-placeholder="Select Price" name="vehicle[buy][veh_price_id][]" style="width: 170px;"
                        class="select2_group form-control  cmbMultiSelectjks">
                        <option value="">-Select Price-</option>
                        <?php foreach ($price_ranges as $price_range) { ?>
                        <option value="<?php echo $price_range['pr_id']; ?>"><?php echo $price_range['pr_range'] ?>
                ...
                <td>
                    <input style="width: 100px;" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12 numOnly"
                        type="number" name="vehicle[buy][veh_km_from][]">
                </td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <tr>
                <td colspan="4">
                    <input required="true" placeholder="KL" id="enq_cus_loan_emi"
                        ...
                        name="vehicle[buy][veh_reg1][]" autocomplete="off">
                    <input required="true" placeholder="00" id="enq_cus_loan_emi" style="width: 60px;"
                        class="form-control col-md-3 col-xs-3 numOnly" type="text" name="vehicle[buy][veh_reg2][]"
                        autocomplete="off">
                    <input required="true" placeholder="AA" id="enq_cus_loan_emi"
                        style="width: 60px;text-transform:uppercase;" class="form-control col-md-3 col-xs-3" type="text"
                        name="vehicle[buy][veh_reg3][]" autocomplete="off">
                    <input required="true" placeholder="0000" id="enq_cus_loan_emi" style="width: 99px;"
                        class="form-control col-md-3 col-xs-3 numOnly" type="text" name="vehicle[buy][veh_reg4][]"
                        autocomplete="off">
                </td>
                <td colspan="2">
                    <input placeholder="Owner" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12"
                        type="number" name="vehicle[buy][veh_owner][]">
                </td>
                <td colspan="2">
                    <input placeholder="Chassis number" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12"
                        type="text" name="vehicle[buy][veh_chassis_number][]">
                </td>
            </tr>
            <tr>
                <td colspan="8">
                    <input placeholder="Remarks" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12"
                        type="text" name="vehicle[buy][veh_remarks][]">
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <input placeholder="First delivery date" id="veh_delivery_date"
                        class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12" type="text"
                        name="vehicle[buy][veh_delivery_date][]">
                </td>
                <td colspan="2">
                    <input placeholder="First reg date" id="veh_first_reg"
                        class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12 numOnly" type="text"
                        name="vehicle[buy][veh_first_reg][]">
                </td>
                <td colspan="2">
                    <select data-placeholder="First manf year" name="vehicle[buy][veh_manf_year][]"
                        style="width: 270px;" class="select2_group form-control cmbMultiSelectmm">
                        <option value="">-Select First manf year-</option>
                        <?php
                              $earliest_year = YEAR_RANGE_START;
                              $latest_year = date('Y');
            ...
            <tr>
                <td colspan="2">
                    <input placeholder="CC" id="veh_cc" class="form-control col-md-7 col-xs-12 numOnly" type="text"
                        name="vehicle[buy][veh_cc][]">
                </td>
                <td colspan="2">
                ...
                <td colspan="1">
                    <select required class="select2_group form-control" name="vehicle[buy][veh_transmission][]"
                        id="val_transmission">
                        <option value="">Select Transmission</option>
                        <option value="1">M/T</option>
                        <option value="2">A/T</option>
