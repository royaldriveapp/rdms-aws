...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>New enquiry <a href="<?php echo site_url('customers/create'); ?>" class="btn btn-success" target="_blank">+Add New Customer</a>
 
                <!-- Button to open modal -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#customerSearchModal">
    Change Customer
</button>
<a href="<?php echo site_url('customers/edit/'.$datas['vreg_cust_id']); ?>" class="btn btn-success" target="_blank">Edit Customer</a>
                </h2>
...
<div class="modal" id="customerSearchModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="search-container">
                    <label for="searchField">Search Customers</label>
                    <input 
                        type="text" 
                        id="searchField" 
                        class="form-control" 
                        placeholder="Enter name, address, or phone"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="assignCustomer()">Assign Customer</button>
            </div>
        </div>
    </div>
</div>
                    ...
                    //  print_r($evaluation); 
                    // echo $this->evaluation->isVehicleEvaluated(6) ;
                    ?>
                    ...
                    <form id="wizard" data-url="<?php echo site_url('enquiry/punchEnquiry'); ?>" class="form_wizard wizard_horizontal" action="#" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
                        ...
                        <input type="hidden" value="<?php echo isset($datas['vreg_cust_id']) ? $datas['vreg_cust_id'] : ''; ?>" id="vreg_cust_id" name="vreg_cust_id" />
                                        ...
                                        <div class="row bg-clr top-tb">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 lbl" for="first-name">Customer Grade<span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select required="true" class="select2_group form-control form-control-enq" name="enquiry[enq_customer_grade]">
                                                ...
                                                <div class="form-group">
                                                    <label for="enq_cus_status" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Type<span class="required">*</span></label>
                                                    <?php //print_r($datas['vreg_department'])
                                                    ?>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select required="true" class="select2_group form-control cmbEnqStatus form-control-enq" name="enquiry[enq_cus_status]">
                                                            <option value="">-Select-</option>
                                                            <option <?php echo $datas['vreg_department'] == 4 ? 'selected="selected"' : ''; ?> value="1">Sales</option>
                                                            <option <?php echo $datas['vreg_department'] == 7 ? 'selected="selected"' : ''; ?> value="2">Purchase</option>
                                                ...
                                                ?>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12 lbl" for="first-name">Sales Executive
                                                            <span class="required">*</span>
                                                        </label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select required="true" class="select2_group form-control enq_se_id cmbSearchList form-control-enq" name="enquiry[enq_se_id]">
                                                                <option value="">Assign to sales executive</option>
                                                                <?php foreach ($salesExe as $key => $value) { ?>
                                                                    <option <?php echo (isset($datas['vreg_assigned_to']) == $value['usr_id']) ? 'selected="selected"' : ''; ?> value="<?php echo $value['usr_id']; ?>">
                                                ...
                                                ?>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 lbl" for="enq_cus_name"> Enquiry Date
                                                        <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="enquiry[enq_entry_date]" type="text" class="dtpEnquiryDate form-control col-md-7 col-xs-12 form-control-enq" required="true" value="<?php echo date('d-m-Y'); ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 lbl" for="enq_cus_name">Name
                                                        <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo isset($datas['cusd_name']) ? $datas['cusd_name'] : ''; ?>" name="enquiry[enq_cus_name]" type="text" id="enq_cus_name" class="form-control form-control-enq col-md-7 col-xs-12 enq_cus_name" required="">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="enq_cus_address" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Communication Address<span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input required="true" id="enq_cus_address" value="<?php echo $datas['cusd_address']; ?>" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_address]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_ofc_address" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Address(Office)
                                                        <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input required="true" id="enq_cus_ofc_address" value="<?php echo $datas['cusd_address_office']; ?>" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_ofc_address]">
    ...
    <?php foreach ($customer_phones as $index => $phone) : ?>
        <div class="form-group">
            <label for="enq_cus_mobile_<?= $index + 1; ?>" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">
                Mobile..<?= $index + 1; ?>
                <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input readonly
                    value="<?= htmlspecialchars($phone['cup_phone'], ENT_QUOTES, 'UTF-8'); ?>" 
                    id="enq_cus_mobile_<?= $index + 1; ?>" 
    ...
    <!-- @Phones -->
                                                <div class="form-group">
                                                    <label for="enq_cus_mobile" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Office No
                                                        <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12 lbl">
                                                    <input value="<?php echo isset($datas['cusd_phone_office']) ? $datas['cusd_phone_office'] : ''; ?>" id="enq_cus_office_no" class="form-control form-control-enq col-md-7 col-xs-12 numOnly enq_cus_office_no" type="text" name="enquiry[enq_cus_office_no]">
                                                    </div>
                                                </div>


                                                <div class="form-group">
                                                    <label for="enq_cus_city" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Place<span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input value="<?php echo isset($datas['cusd_place']) ? $datas['cusd_place'] : ''; ?>" id="enq_cus_city" class="autoComCity form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_city]">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="enq_cus_email" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Email</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_email" class="form-control form-control-enq col-md-7 col-xs-12 emailOnly" type="text" value="<?php echo isset($datas['cusd_email']) ? $datas['cusd_email'] : ''; ?>" name="enquiry[enq_cus_email]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_whatsapp" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Whatsapp</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_whatsapp" class="form-control form-control-enq col-md-7 col-xs-12 numOnly enq_cus_whatsapp" type="text" value="<?php echo isset($datas['cusd_whatsapp']) ? $datas['cusd_whatsapp'] : ''; ?>" name="enquiry[enq_cus_whatsapp]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_fbid" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Customer
                                                        FB Id</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_fbid" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_fbid]" value="<?php echo isset($datas['cusd_fb']) ? $datas['cusd_fb'] : ''; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <!--                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="select2_group form-control form-control-enq" name="enquiry[enq_cus_age_group]">
                                                            <?php foreach (unserialize(CUST_AGE_GROUP) as $key => $value) { ?>
                                                                <option value="<?php echo $key; ?>" <?php echo (isset($datas['cusd_age']) && $key == $datas['cusd_age']) ? 'selected' : ''; ?>>
                                                                    <?php echo $value; ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="select2_group form-control form-control-enq" name="enquiry[enq_cus_gender]">
                                                            <option value="0">- Select -</option>
                                                            <?php foreach (unserialize(GENDER) as $key => $value) { ?>
                                                                <option value="<?php echo $key; ?>" <?php echo (isset($datas['cusd_gender']) && $key == $datas['cusd_gender']) ? 'selected' : ''; ?>>
                                                                    <?php echo $value; ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group"><?php // print_r($Profession); 
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select required="true" class="select2 select2_group form-control form-control-enq" name="enquiry[enq_cus_occu]">
                                                            <option value="">-Select-</option>
                                                            <?php foreach ((array) $Profession as $value) { ?>
                                                                <option value="<?php echo $value['occ_id']; ?>" <?php echo (isset($datas['cusd_profession']) && $value['occ_id'] == $datas['cusd_profession']) ? 'selected' : ''; ?>>
                                                ...
                                                <!-- <div class="form-group">
                                                    <label for="enq_cus_age_group" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Category</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="enq_cus_company" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Company</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_company" value="<?php echo isset($datas['cusd_company']) ? $datas['cusd_company'] : ''; ?>" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_company]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_phone_res" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Resi
                                                        phone</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_phone_res" class="form-control form-control-enq col-md-7 col-xs-12" type="text" value="<?php echo isset($datas['cusd_phone_resi']) ? $datas['cusd_phone_resi'] : ''; ?>" name="enquiry[enq_cus_phone_res]">
                                                    </div>
                                                </div>
                                                <!--                                                            <div class="form-group">
                                                                                                                             <label for="enq_cus_state" class="control-label col-md-3 col-sm-3 col-xs-12 lbl"><span class="required">*</span>Country</label>
                                                                                                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                                                                                                  <select required data-placeholder="Select Country" name="enquiry[enq_cus_country]" id="country" class="BindState jselect2_group form-control cmbMultiSelect" data-url="<?php echo site_url('enquiry/bindState'); ?>" >
                                                            <?php //foreach ($countries as $country) {
                                                            ?>
                                                                                                                                                            <option <?php //echo $country['id'] == '101' ? 'selected' : ''
                                                ...
                                                <!--                                                            <div class="form-group india">
                                                            ...
                                                            ?>
                                                                                                                                                            <option value="<?php //echo $state['sts_id']
                                                                                                                                                                            ?>"><?php echo $state['sts_name'] ?></option>
                                                              <?php //}
                                                                ?>
                                                                                                                                  </select>
                                                                                                                             </div>
                                                                                                                        ...
                                                                                                                        <div class="form-group india">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 lbl">District</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12" id="distict">
                                                        <select required="true" class="select2_group form-control form-control-enq" name="enquiry[enq_cus_dist]">

                                                            <option value="">--</option>
                                                            <?php foreach ($districts as $district) { ?>
                                                                <option value="<?php echo $district['std_id'] ?>" <?php echo $datas['cusd_district'] == $district['std_id'] ? 'selected' : '' ?>>
                                                ...
                                                <div class="form-group">
                                                    <label for="enq_cus_pin" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Pin</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="enq_cus_pin" class="form-control form-control-enq col-md-7 col-xs-12 numOnly" type="number" value="<?php echo isset($datas['cusd_pin']) ? $datas['cusd_pin'] : ''; ?>" name="enquiry[enq_cus_pin]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="enq_cus_status" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Mode of
                                                        enquiry</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select required class="select2_group form-control form-control-enq enq_mode_enq cmbModeOfContact" name="enquiry[enq_mode_enq]" readonly>
                                                            <option value="">Select one</option>
                                                            <optgroup label="RD Mode of Enquiry">
                                                                ...
                                                                ?>
                                                                        <option <?php echo ($datas['vreg_contact_mode'] == $key) ? 'selected="selected"' : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?>
                                                                        </option>
                                                                <?php
                                                                    }
                                                                }
                                                            ...
                                                            <optgroup label="Own Mode of Enquiry">
                                                                ...
                                                                foreach (unserialize(MODE_OF_CONTACT) as $key => $value) {
                                                                    if (in_array($key, array(18, 17, 6, 19, 20))) {
                                                                ?>
                                                                        <option <?php echo ($datas['vreg_contact_mode'] == $key) ? 'selected' : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?>
                                                                        </option>
                                                                <?php
                                                                    }
                                                                }
                                                ...
                                                <div class="form-group">
                                                    <label for="enq_cus_remarks" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Referral
                                                        type</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <?php
                                                        $rfrl_nm = $datas['vreg_referal_name'];
                                                        if ($datas['vreg_referal_type'] == 4) {
                                                            ...
                                                            $rfrl_nm = $staff['usr_first_name'];
                                                            // print_r($staff['usr_first_name']);
                                                        } ?>
                                                        <input readonly placeholder="Referral type" type="text" class="form-control form-control-enq col-md-7 col-xs-12" value="<?php echo @unserialize(REFERAL_TYPES)[$datas['vreg_referal_type']]; ?>" />
                                                        <input type="hidden" value="<?php echo @$datas['vreg_referal_type']; ?>" name="enquiry[enq_ref_type]" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_remarks" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Referral
                                                        name</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input readonly placeholder="Referal name" type="text" class="form-control form-control-enq col-md-7 col-xs-12" value="<?php echo $rfrl_nm; ?>" />
                                                        <input type="hidden" value="<?php echo $datas['vreg_referal_name']; ?>" name="enquiry[enq_ref_name]" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_remarks" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Referral
                                                        phone</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input readonly placeholder="Referal phone" type="text" class="form-control form-control-enq col-md-7 col-xs-12" value="<?php echo $datas['vreg_referal_phone']; ?>" name="enquiry[enq_ref_phone]" />
                                                        <input type="hidden" value="<?php echo $datas['vreg_referal_enq_id']; ?>" name="enquiry[enq_ref_enq_id]" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="enq_cus_remarks" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Remarks</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <textarea class="form-control form-control-enq col-md-7 col-xs-12" id="flex" rows="8" cols="50" name="enquiry[enq_cus_remarks]"><?php echo isset($datas['vreg_customer_remark']) ? strip_tags($datas['vreg_customer_remark']) : ''; ?></textarea>
                                                    </div>
                                                </div>
                                                <!--                                                            <div class="form-group">
                                                ...
                                                <div class="form-group TypeSalej">
                                                    <label for="enq_cus_age_group" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Purpose<span class="required">*</span> </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select required="true" class="select2 select2_group form-control form-control-enq" name="enquiry[enq_cus_purpose]" id="purpose">
                                                            <option value="">-Select-</option>
                                                ...
                                                <div class="form-group TypeSale" style="display: none" id="otherPurpose">
                                                    <label for="enq_cus_remarks" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Enter
                                                        purpose<span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input required="true" placeholder="Enter purpose" type="text" class="form-control form-control-enq col-md-7 col-xs-12" name="enquiry[other_purpose]" />
                                                    </div>
                                                </div>


                                                <!-- <div class="form-group TypePurchase" style="display: none">
                                                    <label for="enq_cus_age_group" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Purpose of
                                                        the Sale</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="select2_group form-control form-control-enq" name="enquiry[enq_cus_purpose]" id="purposeOfSale">
                                                            <option value="">-Select-</option>
                                                            <?php foreach ((array) $puposes as $value) { ?>
                                                                <option value="<?php echo $value['purp_id']; ?>">
                                                                    <?php echo $value['purp_name']; ?></option>
                                                ...
                                                <div class="form-group otherPurchaseOfSale TypePurchase" style="display: none" id="other_prp_slae">
                                                    <label for="enq_cus_remarks" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Enter
                                                        purpose </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input placeholder="Enter purpose of sale" type="text" class="form-control form-control-enq col-md-7 col-xs-12" name="enquiry[other_purpose]" />
                                                    </div>
                                                </div> -->
                                        ...
                                        <table class="table table-striped table-bordered bg-clr tb-man">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input class="form-control form-control-enq  col-md-7 col-xs-12" type="text" name="money[name]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="money[phone]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="money[relation]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="money[remarks]"></td>
                                                </tr>
                                                <tr>
                                                    <th class="lbl">Need</th>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="need[name]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="need[phone]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="need[relation]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="need[remarks]"></td>
                                                </tr>
                                                <tr>
                                                    <th class="lbl">Authority</th>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="authority[name]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="authority[phone]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="authority[relation]"></td>
                                                    <td><input class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="authority[remarks]"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div><!-- @rw2 -->
                                            ...
                                            ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-3 col-xs-12">
                                                        ...
                                                        <?php } else { // Text box 
                                                        ?>
                                                            <textarea autocomplete="off" <?php echo $required; ?> id="enq_cus_need" type="text" class="form-control col-md-7 col-xs-12" name="saquestions[<?php echo $value['qus_id']; ?>]"><?php echo isset($defRegAnswer[$value['qus_id']]) ? $defRegAnswer[$value['qus_id']] : ''; ?></textarea>
                                                        <?php } ?>
                                            ...
                                            ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <?php if ($value['qus_is_togler'] == 1) { // Radio
                                                        ?>
                                                            <input <?php echo $required; ?> type="checkbox" class="chk" name="byquestions[<?php echo $value['qus_id']; ?>]" value="1" />
                                                        <?php } else { // Text box 
                                                        ?>
                                                            <textarea <?php echo $required; ?> id="enq_cus_need" class="form-control col-md-7 col-xs-12" type="text" name="byquestions[<?php echo $value['qus_id']; ?>]"><?php echo isset($defRegAnswer[$value['qus_id']]) ? $defRegAnswer[$value['qus_id']] : ''; ?></textarea><?php } ?>
                                                        <i style="font-size: 9px;"><?php echo $value['qus_desc']; ?></i>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            ...
                                            ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7 col-sm-6 col-xs-12">
                                                        <?php if ($value['qus_is_togler'] == 1) { // Radio
                                                        ?>
                                                            <input type="checkbox" <?php echo $required; ?> class="chk" name="exquestions[<?php echo $value['qus_id']; ?>]" value="1" />
                                                        <?php } else { // Text box 
                                                        ?>
                                                            <textarea <?php echo $required; ?> id="enq_cus_need" class="form-control col-md-7 col-xs-12" type="text" name="exquestions[<?php echo $value['qus_id']; ?>]"><?php echo isset($defRegAnswer[$value['qus_id']]) ? $defRegAnswer[$value['qus_id']] : ''; ?></textarea><?php } ?>
                                                        <i style="font-size: 9px;"><?php echo $value['qus_desc']; ?></i>
                                                    </div>
                                                </div>
                                            <?php } ?>
                        ...
                        <?php }*/ ?>
                        <div id="step-3">
                            <h2 class="StepTitle lblSale" style="width: 100%;">Customer required vehicle<span style="float: right;cursor: pointer;" class="glyphicon glyphicon-plus btnAddVehDetailsRqVeh"></span></h2>
                            <div class="table-responsive divVehDetailsSale">
                                <table id="datatable-responsive" class="tbl-blk vehDetailsSale table table-stripedj table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th colspan="11">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <select required="true" style="width: 170px;" class="select2_group form-control cmbBindModel" data-url="<?php echo site_url('enquiry/bindModel'); ?>" name="vehicle[sale][veh_brand][]">
                                                    ...
                                                    <?php foreach ($brands as $key => $value) { ?>
                                                        <option <?php echo $value['brd_id'] == $datas['vreg_brand'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['brd_id'] ?>">
                                                            <?php echo $value['brd_title'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </td>
                                            <td>
                                                <select style="width: 170px;" required="" data-url="<?php echo site_url('enquiry/bindVarient'); ?>" data-bind="cmbEvVariant" data-dflt-select="Select Variant" class="cmbEvModel select2_group form-control bindToDropdown" name="vehicle[sale][veh_model][]" id="vreg_model">
                                                    <?php foreach ((array) $model as $key => $value) { ?>
                                                        <option <?php echo $value['mod_id'] == $datas['vreg_model'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['mod_id']; ?>">
                                            ...
                                            <td>
                                                <select style="width: 170px;" required="" class="select2_group form-control cmbEvVariant" name="vehicle[sale][veh_varient][]" id="vreg_varient">
                                                    <?php foreach ((array) $variant as $key => $value) { ?>
                                                        <option <?php echo $value['var_id'] == $datas['vreg_varient'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['var_id']; ?>">
                                            ...
                                            <td>
                                                ...
                                                <select required="true" data-placeholder="Select Year" name="vehicle[sale][veh_manf_year_from][]" style="width: 85px;" class="select2_group form-control cmbMultiSelectmm">
                                                    ...
                                                    ?>
                                                        <option <?php echo $datas['vreg_year'] == $i ? 'selected' : '' ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="1">
                                                ...
                                                <input placeholder="Expected Date of Purchase" class="dtpDatePickerDMY form-control col-md-7 col-xs-12" type="text" name="vehicle[sale][veh_exptd_date_purchase][]">
                                            </td>
                                        ...
                                        <tr style="background-color:#949091c4;color: #fff;">
                                            <td colspan="1">
                            ...
                            <!-- existing -->
                            <!-- pitched -->
                            <h2 class="StepTitle lblSale" style="width: 100%;">Pitched vehicle <span style="float: right;cursor: pointer;" class="glyphicon glyphicon-plus btnAddVehDetailsPitched"></span></h2>
                            <div class="table-responsive divVehDetailsPitched TypeSale">
                                <table id="datatable-responsive" class="tbl-pitch vehDetailsSale table table-stripedj table-bordered dt-responsive nowrap tbl" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th colspan="11">
                                                ...
                                                <select style="width: 170px;float: left;" class="cmbSearchList select2_group form-control cmbStock" name="veh_stock_id" data-url="<?php echo site_url('enquiry/bindPitchedVehTable'); ?>">
                                                    <option value="0">Select Vehicle</option>
                                                    <?php
                            ...
                            <h2 class="StepTitle lblBuy" style="display: none; width: 100%;">Purchase vehicle<small>
                                    (Vehicle from customer)</small><span style="display: none; float: right;cursor: pointer;" class="glyphicon glyphicon-plus btnAddVehDetailsBuy btnAddVehDetailsPurchase"></span>
                            </h2>
                            <div class="table-responsive divVehDetailsBuy" style="display: none;">
                                <table id="datatable-responsive" class="vehDetailsBuy table table-stripedj table-bordered jdt-responsive nowrapk" cellspacing="0" width="100%">
                                    <thead>
                                        <!-- <tr>
                                            <th colspan="11">
                                    ...
                                    <tbody class="tbd">
                                        <tr>
                                            <td>
                                                <select required="true" style="width: 170px;" class="select2_group form-control cmbBindModelBuy" data-url="<?php echo site_url('enquiry/bindModel'); ?>" name="vehicle[buy][veh_brand][]">
                                                    <option value="0">Select Brand</option>
                                                    <?php foreach ($brands as $key => $value) { ?>
                                                        <option value="<?php echo $value['brd_id'] ?>" <?php echo $value['brd_id'] == $datas['vreg_brand'] ? 'selected="selected"' : ''; ?>>
                                                            <?php echo $value['brd_title'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </td>
                                            <td> <select style="width: 170px;" required="" data-url="<?php echo site_url('enquiry/bindVarient'); ?>" data-bind="cmbEvVariant" data-dflt-select="Select Variant" class="cmbEvModel select2_group form-control bindToDropdown" name="vehicle[buy][veh_model][]" id="vreg_model">
                                                    <?php foreach ((array) $model as $key => $value) { ?>
                                                        <option <?php echo $value['mod_id'] == $datas['vreg_model'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['mod_id']; ?>">
                                                            <?php echo $value['mod_title']; ?></option>
                                                    <?php } ?>
                                                </select></td>
                                            <td><select style="width: 170px;" required="" class="select2_group form-control cmbEvVariant" name="vehicle[buy][veh_varient][]" id="vreg_varient">
                                                    <?php foreach ((array) $variant as $key => $value) { ?>
                                                        <option <?php echo $value['var_id'] == $datas['vreg_varient'] ? 'selected="selected"' : ''; ?> value="<?php echo $value['var_id']; ?>">
                                                            <?php echo $value['var_variant_name']; ?></option>
                                                    <?php } ?>
                                            ...
                                            <td>
                                                <?php //print_r($datas); 
                                                ?>
                                                <input style="width: 100px;" id="enq_cus_loan_emi" class="form-control col-md-7 col-xs-12 numOnly" value="<?php echo $datas['vreg_km'] ?>" type="number" name="vehicle[buy][veh_km_from][]">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="8"><input placeholder="Insurance Company" id="veh_cc" class="form-control col-md-7 col-xs-12 " type="text" name="vehicle[buy][insurance_company][]"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input placeholder="Valid Up to " id="veh_first_reg" class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][valid_up_to][]">
                                            </td>
                                            <td colspan="2">
                                                <input placeholder="IDV" class=" form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][idv][]">
                                            </td>
                                            <td colspan="2">
                                                <input placeholder="NCB%" class=" form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][ncb_percentage][]">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input placeholder="Valid Up to " class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][val_insurance_ll_date][]">
                                            </td>
                                            <td colspan="2">
                                            ...
                                            <td colspan="2">
                                                <select class="select2_group form-control" name="vehicle[buy][ncb_req][]">
                                        ...
                                        <tr>
                                            <td colspan="1">
                                                <p class="labl">Finance Company </p><input placeholder="Finance Company" class=" form-control col-md-7 col-xs-12 " type="text" name="vehicle[buy][finance_company][]">
                                            </td>
                                            <td colspan="3">
                                                <p class="labl">Bank</p> <select class="cmbSearchList select2_group form-control cmbValHypoBank" name="vehicle[buy][bank][]" id="val_hypo_bank">
                                            ...
                                            <td colspan="2">
                                                <p class="labl">Branch</p><input placeholder="Branch" class=" form-control col-md-7 col-xs-12 " type="text" name="vehicle[buy][bank_branch][]">
                                            </td>
                                            <td colspan="2">
                                                <p class="labl">Hypothecation will close by customer</p><input class="chkHypoByCust" type="checkbox" name=vehicle[buy][val_hypo_close_by_cust][]" value="1">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <p class="labl">Loan Starting Date </p><input placeholder="Loan Starting Date " class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][loan_starting_date][]">
                                            </td>


                                            <td colspan="2">
                                                <p class="labl">Loan Ending Date </p><input placeholder="Loan Ending Date" class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][loan_ending_date][]">
                                            </td>

                                            <td colspan="1">
                                                <p class="labl">Loan amount </p><input placeholder="Loan amount" class=" form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][loan_amount][]">
                                            </td>
                                            <td colspan="1">
                                                <p class="labl">Forclousure value </p><input placeholder="Forclousure value" class=" form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][forclousure_value][]">
                                            </td>


                                            <td colspan="2">
                                                <p class="labl">Forclousure date </p><input placeholder="Forclousure date" class="dtpDatePickerEvaluation form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][forclousure_date][]">
                                            </td>

                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <p class="labl">Daily Interest </p><input placeholder="Daily Interest " class=" form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][daily_interest][]">
                                            </td>
                                            <td colspan="2">
                                                <p class="labl">Any Top up Loan </p><input class="chkHypoByCust" type="checkbox" name=vehicle[buy][any_top_up_loan][]" value="1">
                                            </td>
                                        </tr>
                                        <!-- @hypothi -->
                                    </tbody>
                            ...
                            <!-- existing -->
                            <h2 class="StepTitle lblBuyk" style="width: 100%;">Existing vehicle <span style="float: right;cursor: pointer;" class="glyphicon glyphicon-plus btnAddVehDetailsExisting"></span></h2>
                        ...
                        <div id="step-5">
                            <div class="form-horizontal form-label-left">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select required="true" class="select2_group form-control" name="followup[foll_status]" id="foll_status">
                                            ...
                                            <?php foreach (unserialize(FOLLOW_UP_STATUS) as $key => $value) { ?>
                                                <option <?php echo ($datas['vreg_customer_status'] == $key) ? 'selected="selected"' : ''; ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input required="true" value="" id="foll_remarks" class="form-control col-md-7 col-xs-12" type="text" name="followup[foll_remarks]">
                                    </div>
                                </div>
                                <?php //echo isset($datas['vreg_customer_remark']) ? strip_tags($datas['vreg_customer_remark']) : ''; ?>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input required="true" id="foll_action_plan" class="form-control col-md-7 col-xs-12" type="text" name="followup[foll_action_plan]">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input required="true" type="text" class="foll_next_foll_date form-control col-md-7 col-xs-12 dtpNextFollowDate" placeholder="Next follow up date" id="foll_next_foll_date" name="followup[foll_next_foll_date]">
                                    </div>
                                </div>
                            </div>
                        </div>
...
function fetchCustomers(searchTerm) {
    fetch(`${site_url}customers/searchCustomer?search_term=${encodeURIComponent(searchTerm)}`)
...
function displaySearchResults(results) {
    ...
    if (results.length > 0) {
        results.forEach(result => {
            ...
            resultItem.textContent = `${result.cusd_name} - ${result.phoneNumbers.join(', ')}`;
            resultItem.onclick = () => selectCustomer(result); // Assign customer when clicked
            searchResultsContainer.appendChild(resultItem);
        });
    } else {
        searchResultsContainer.innerHTML = '<div class="dropdown-item">No results found</div>';
    }

    // Show the dropdown (ensure it’s visible)
    searchResultsContainer.style.display = results.length > 0 ? 'block' : 'none';
}

// Select a customer from the search results
function selectCustomer(customer) {
    selectedCustomer = customer; // Store the selected customer in the global variable

    // Close the dropdown list and fill customer details in the modal fields
    document.getElementById('searchResults').style.display = 'none'; // Close the dropdown
    document.getElementById('searchField').value = customer.cusd_name; // Update the search field with the selected customer
}

// Assign the selected customer to the form fields
function assignCustomer() {
    if (selectedCustomer) {
        // Assign customer name and ID to the main form
        document.getElementById('enq_cus_name').value = selectedCustomer.cusd_name;
        document.getElementById('vreg_cust_id').value = selectedCustomer.cusd_id;
        document.getElementById('enq_cus_address').value = selectedCustomer.cusd_address;

        // Populate phone fields dynamically
        const phoneFieldsContainer = document.getElementById('phone-fields-container');
        phoneFieldsContainer.innerHTML = ''; // Clear existing fields

        selectedCustomer.phoneNumbers.forEach((phone, index) => {
            const phoneFieldHTML = `
                <div class="form-group">
                    <label for="enq_cus_mobile_${index + 1}" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">
                        Mobile${index + 1} <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="${phone}" 
                            id="enq_cus_mobile_${index + 1}" 
...
function debouncedSearch() {
    ...
    // If the search field is empty, hide the dropdown
    if (!searchTerm.trim()) {
