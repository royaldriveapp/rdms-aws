                    ...
                    <div class="x_content">
                         ...
                         <form action="<?php echo $fullURL; ?>" method="get">
                              ...
                              <table>
                                   <tr>
                                        <td>
                                             <select class="select2_group form-control cmbBindShowroomByDivision" name="vreg_division" id="vreg_division" data-url="<?php echo site_url('enquiry/bindShowroomByDivision'); ?>" data-bind="cmbShowroom" data-dflt-select="Select Showroom">
                                        ...
                                        <td>
                                             <select class="select2_group form-control cmbShowroom shorm_stf" name="vreg_showroom" id="vreg_showroom">
                                        ...
                                        <td>
                                             <select class="select2_group form-control" name="vreg_department">
                                                  ...
                                                  ?>
                                                       <option <?php echo $selected; ?> value="<?php echo $value['dep_id']; ?>"><?php echo $value['dep_name'] . ' (' . $value['div_name'] . ')'; ?></option>
                                                  <?php } ?>
                                             </select>
                                        </td>
                                        <td>
                                        ...
                                        <td class="divEvents" <?php echo $_GET['vreg_contact_mode'] == 5 ? '' : 'style="display: none;"' ?>">
                                             <!-- evnt dpnt-->
                                             <select class="select2_group form-control" name="vreg_event" id="vreg_event">
                                                  ...
                                                  foreach ($events as $key => $value) {
                                                       $selected = (isset($_GET['vreg_event']) && ($_GET['vreg_event'] == $value['evnt_id'])) ?
                                                            'selected="selected"' : '';
                                                  ?>
                                                       <option <?php echo $selected; ?> value="<?php echo $value['evnt_id']; ?>"><?php echo $value['evnt_title']; ?></option>
                                                  <?php
                                                  }
                                                  ?>
                                             </select>
                                        ...
                                        <td>
                                             <select class="select2_group form-control" name="vreg_is_effective">
                                                  ...
                                                  <option <?php echo (isset($_GET['vreg_is_effective']) && ($_GET['vreg_is_effective'] == '1')) ? 'selected="selected"' : ''; ?> value="1">Effective call</option>
                                                  <option <?php echo (isset($_GET['vreg_is_effective']) && ($_GET['vreg_is_effective'] == '0')) ? 'selected="selected"' : ''; ?> value="0">Ineffective call</option>
                                             </select>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                             <input autocomplete="off" name="vreg_added_on_fr" type="text" class="dtpDatePickerDMY form-control col-md-7 col-xs-12" placeholder="Date from" value="<?php echo isset($_GET['vreg_added_on_fr']) ? $_GET['vreg_added_on_fr'] : ''; ?>" />
                                        </td>
                                        <td style="padding-left: 10px;">
                                             <input autocomplete="off" name="vreg_added_on_to" type="text" class="dtpDatePickerDMY form-control col-md-7 col-xs-12" placeholder="Date to" value="<?php echo isset($_GET['vreg_added_on_to']) ? $_GET['vreg_added_on_to'] : ''; ?>" />
                                        </td>
                                        <td style="padding-left: 10px;">
                                             ...
                                             <td>
                                                  <select class="select2_group form-control enq_se_id" name="vreg_assigned_to">
                                                       ...
                                                       <?php foreach ($staff as $key => $value) { ?>
                                                            <option value="<?php echo $value['col_id']; ?>" <?php echo (isset($_GET['vreg_assigned_to']) && ($_GET['vreg_assigned_to'] == $value['col_id'])) ? 'selected="selected"' : ''; ?>><?php echo $value['col_title']; ?></option>
                                                       <?php } ?>
                                                  </select>
                                             </td>
                                             <td>
                                                  <select class="select2_group form-control enq_se_id" name="vreg_added_by">
                                                       ...
                                                       <?php foreach ($teleCallers as $key => $value) { ?>
                                                            <option value="<?php echo $value['col_id']; ?>" <?php echo (isset($_GET['vreg_added_by']) && ($_GET['vreg_added_by'] == $value['col_id'])) ? 'selected="selected"' : ''; ?>><?php echo $value['col_title']; ?></option>
                                                       <?php } ?>
                                                  </select>
                                             </td>
                                             <td>
                                                  <select class="select2_group form-control enq_se_id" name="vreg_first_owner">
                                                       ...
                                                       <?php foreach ($teleCallers as $key => $value) { ?>
                                                            <option value="<?php echo $value['col_id']; ?>" <?php echo (isset($_GET['vreg_first_owner']) && ($_GET['vreg_first_owner'] == $value['col_id'])) ? 'selected="selected"' : ''; ?>><?php echo $value['col_title']; ?></option>
                                                       <?php } ?>
                                                  </select>
                                             </td>
                                             <td>
                                                  <select class="select2_group form-control" name="vreg_is_punched">
                                                       <option <?php echo (isset($_GET['vreg_is_punched']) && ($_GET['vreg_is_punched'] < 0)) ? 'selected="selected"' : ''; ?> value="-1">All status</option>
                                                       <option <?php echo (isset($_GET['vreg_is_punched']) && ($_GET['vreg_is_punched'] == 0)) ? 'selected="selected"' : ''; ?> value="0">Register Pending</option>
                                                       <option <?php echo (isset($_GET['vreg_is_punched']) && ($_GET['vreg_is_punched'] == 1)) ? 'selected="selected"' : ''; ?> value="1">Punched</option>
                                                  </select>
                                             </td>
                                             <td>
                                                  Show all enquiry status <input type="checkbox" name="chkAllStatus" <?php echo (isset($_GET['chkAllStatus']) && $_GET['chkAllStatus'] == 1) ? "checked" : ''; ?> value="1"/>
                                             </td>
                                        <?php } ?>
                                        <td colspan="2">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                     <div class="x_panel tile fixed_height_320" style="overflow: scroll;">
                                          ...
                                          <div class="dashboard-widget-content">
                                               <div class="x_content">
                                                    <form class="frmQuickAssign" data-url="<?php echo site_url('enquiry/reassignregister');?>" method="get">
                                                         <input type="hidden" name="searchValues" value='<?php echo!empty($_GET) ? $_GET['vreg_assigned_to'] : '';?>'/>
                                                              ...
                                                              <tr>
                                                                   <td style="padding-left: 10px;">
                                                                        ...
                                                                        <select multiple="multiple" style="float: left;width: auto;" class="cmbMultiSelect select2_group form-control cmbSalesExecutives" name="executive[]">
                                                                             <?php
                                                                             foreach ((array) $salesStaff as $key => $value) {
                                                                                  /* if (!empty($showroom)) {
