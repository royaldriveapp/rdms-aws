                                   ...
                                   <div class="x_title">
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                             <li style="float: right;">
                                                  <?php if (check_permission('registration', 'export_excel')) { ?>
                                             ...
                                             <li style="float:right;">
                                                  <a data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" 
                                                     aria-controls="collapseExample"><i class="fa fa-chevron-up"></i><i class="fa fa-chevron-down"></i></a>
                                             </li>
                                        </ul>
                                        <div class="clearfix"></div>
                                   </div>
                                   <div class="x_content collapse1 collapse in" id="collapseExample">
                                        <?php if (check_permission('enquiry', 'myregistercallanalysis') && !empty($tc)) { ?>
                                             <h2>Today's calls analysis</h2>
                                             <div class="x_content">
                                                 ...
                                                 // echo $value['vreg_id'].'----------------';
                                                  ...
                                                  <tr data-url="<?php echo site_url('registration/view/' . encryptor($value['vreg_id'])); ?>"
                                                      style="<?php echo $color; ?>;background-color: <?php echo $bgColor; ?>">
                                                       ...
                                                       <?php
                                                       $enq_id = $this->enquiry->matchingInquiry($value['vreg_cust_phone']);
                                                       if ($enq_id) {
                                                            // print_r($enq_id);   
                                                       }

                                                       // $var_ph=matchingInquiry($value['vreg_cust_phone']);
                                                       //print_r($var_ph['enq_id']);
                                                       ?>
                                                       ...
                                                       <td><?php echo date('j M Y H:i', strtotime($value['vreg_added_on'])); ?></td>
                                                       ...
                                                       <?php } if (check_permission('registration', 'alloworeassign') && ($canPunch == 1)) { ?>
                                                            <td>
                                                                 <?php if ($enq_id) { ?>
                                                                      <a href='<?php echo site_url('enquiry/view_change/' . encryptor($enq_id, 'E') . '/' . encryptor($value['vreg_department'], 'E') . '/' . encryptor($value['vreg_id'], 'E')); ?>' class="fa fa-pencil-square"></a>
                                                                 <?php } else {
                                                                      ?>
                                                                                ...
                                                                                <div class="modal-content" style="color: black;">
                                                                                     ...
                                                                                     <div class="modal-body">
                                                                                          <div class="container">
                                                                                               <div class="row">
                                                                                                    <div class="col-sm">
                                                                                                         <div class="col-md-6 col-sm-12 col-xs-12">
                                                                                                              <div class="x_panel">
                                                                                                                   <div class="x_content">
                                                                                                                        <div class="row" style="text-align: center;font-weight: bolder;font-size: 25px;">Followup/New enquiry</div>
                                                                                               ...
                                                                                               <?php //if (($value['vreg_next_followup_cont'] >= 5) || $this->usr_grp == 'TL' || $this->usr_grp == 'TC'  || $this->usr_grp == 'AD') {      ?>
                                                                                                    ...
                                                                                                    <div class="col-sm">
                                                                                                         <?php if (check_permission('registration', 'canretnregister')) { ?>
                                                                                                              <div class="col-md-6 col-sm-12 col-xs-12">
                                                                                                                   <div class="x_panel">
                                                                                                                        <div class="x_content">
                                                                                                                             <div class="row" style="text-align: center;font-weight: bolder;font-size: 25px;">Re-assign to CRE</div>
                                                                                                                                            ...
                                                                                                                                            <div class="form-group" style="width: 100%;float: left;">
                                                                                                                                                 ...
                                                                                                                                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                                                                                                                                      <select required class="select2_group form-control cmbContactMode" name="call_type" id="vreg_contact_mode">
                                                                                                                                                           <option value="">Call type</option>
                                                                                                                                                           <?php
                                                                                                                                                           foreach (unserialize(CALL_TYPE) as $ctkey => $ctypeValue) {
                                                                                                                                                                ?>
                                                                                                                                                                <option value="<?php echo $ctkey; ?>"><?php echo $ctypeValue; ?></option>
                                                                                                                                                                <?php
                                                                                                                                                           }
                                                                                                                                                           ?>
                                                                                                                                                      </select>
                                                                                                         ...
                                                                                                         <div class="col-md-6 col-sm-12 col-xs-12">
                                                                                                              <div class="x_panel">
                                                                                                                   <div class="x_content">
                                                                                                                        <div class="row" style="text-align: center;font-weight: bolder;font-size: 25px;">Drop register</div>
                                                            ...
                                                            <?php if (check_permission('registration', 'reassigntosalesstaff')) { ?>        
                                                                 <td>
                                                                      ...
                                                                      <!-- -->
                                                                      <div class="modal fade" id="reg<?php echo $value['vreg_id']; ?>" tabindex="-1" role="dialog" 
                                                                                          ...
                                                                                          <div class="modal-body">
                                                                                               ...
                                                                                               <table class="table table-striped" style="color:#000;">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                              ...
                                                                                                              if ($value['vreg_inquiry'] > 0) {
                                                                                                                   ...
                                                                                                                   echo '<br> Inquiry already associated with sales executive ' . $value['exstse_usr_username'];
                                                                                                              }
                                                                                                              ?>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                              <input type="text" class="numOnly form-control col-md-7 col-xs-12" name="vreg_year" id="vreg_year"
                                                                                                                     value="<?php echo $value['vreg_year'] ?>" autocomplete="off" placeholder="Year"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                              <input type="text" class="numOnly form-control col-md-7 col-xs-12" name="vreg_investment" id="vreg_investment"
                                                                                                                     value="<?php echo $value['vreg_investment'] ?>" autocomplete="off" placeholder="Investment"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                              <input type="text" class="numOnly form-control col-md-7 col-xs-12" 
                                                                                                                     value="<?php echo $value['vreg_km'] ?>" name="vreg_km" id="vreg_km" autocomplete="off" placeholder="KM"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         ...
                                                                                                         <td>
                                                                                                              <input type="text" class="numOnly form-control col-md-7 col-xs-12" 
                                                                                                                     value="<?php echo $value['vreg_ownership'] ?>" name="vreg_ownership" id="vreg_ownership" autocomplete="off" placeholder="Ownership"/>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         <td>Appointment</td>
                                                                                                         <td>
                                                                                                              <input type="text" class="dtpDateTimePickerhms form-control col-md-7 col-xs-12" 
                                                                                                                     name="vreg_appointment" id="vreg_appointment" autocomplete="off" placeholder="Appointment"/>
                                                                                                         </td>
                                                                                                    </tr>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                     <div class="x_panel tile fixed_height_320">
                                          ...
                                          <div class="dashboard-widget-content">
                                               <div class="x_content">
                                                    <form class="frmQuickAssign" data-url="<?php echo site_url('registration/reassignregister');?>" method="get">
