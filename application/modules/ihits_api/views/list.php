...
<textarea name='pr_approve_remarks' class="form-control col-md-7 col-xs-12 " placeholder="Remarks"></textarea>
                         ...
                         <div class="row">
                              ...
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <div class="form-check">
                                        <input class="form-check-input radio-btn" type="radio" name="pr_approve"  value="1" id="flexRadioDisabled">
                         ...
                         "mRender": function (data, type, row) {
                           if (1) {
                                //   return '<button type="button" class="approvalModalk btn btn-success mdl-btn" data-toggle="modal" data-id="'+data.pr_id+'" data-target="#approvalModal">Approve</button>';
                                  ...
                                  return '<a class="approvalModalk btn btn-success mdl-btn" data-toggle="modal" data-id="'+data.pr_id+'" data-target="#approvalModal"><i class="fa fa-plus ficon "></i><span> Approve </span></a> &nbsp <a class="btn btn-info addStock-btn  tip addStock-' + data.pr_id + '" href="' + editUrl + '/' + data.pr_id + '"><i class="fa fa-edit ficon"></i><span>Edit </span></a>';
                              } 
                         }
                    },
               ],
