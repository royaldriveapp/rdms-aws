...
<?php if (check_permission('productenquires', 'quickassign_veh_enq')) { ?>
<!-- assign -->
                                ...
                                <div class="dashboard-widget-content">
                                    <div class="x_content">
                                        <form class="frmQuickAssign"
                                            data-url="<?php echo site_url('productenquires/quickassign_veh_enq'); ?>" method="get">
...
<script>
    const apiUrl = 'https://royaldrivesmart.in/api/rdms/vehicle-enquiries';
    let currentPage = 1;
    const limit = 10;
