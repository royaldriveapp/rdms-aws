...
//            $this->db->query("SET time_zone = '+05:30'");
           ...
           //$this->tbl_enquiry_history = TABLE_PREFIX . 'enquiry_history_1';
            ...
            //$this->tbl_followup_view_log = TABLE_PREFIX . 'followup_view_log_1';
            ...
            //$this->tbl_vehicle_booking_documents = TABLE_PREFIX . 'vehicle_booking_documents_1';
            ...
            //$this->tbl_vehicle_booking_confirmations = TABLE_PREFIX . 'vehicle_booking_confirmations_1';
       ...
       function getFollowupEnquires_Old($id = '') {
       ...
       function getFollowupByEnquiry($enqId) { //
          if (!empty($enqId)) {
               ...
               if (!empty($enq)) {
                    ...
                    //folloup_added_by_id,folloup_added_by
       ...
       function missedOld($userId, $search = '', $limit = 0, $page = 0) {
...
//     ->join($this->tbl_users, $this->tbl_users . '.usr_id  = ' . $this->tbl_test_drives . '.hmv_travel_with', 'left')
       ...
       function getHomeVisitVsEnq() {
            ...
            $qry = $this->db->select($this->tbl_home_visits . '.*,' .
                            ', enqaddedby.usr_first_name AS enq_added_by_name, enqaddedby.usr_id AS enq_added_by_id,enqaddedby.usr_departments,' . $this->tbl_travel_modes . '.dtm_title,' . $this->tbl_enquiry .
                            '.enq_cus_name,' . $this->tbl_enquiry .
                            '.enq_cus_address,' . $this->tbl_enquiry .
                            '.enq_cus_mobile,' . $this->tbl_enquiry .
                            '.enq_cus_city,' . $this->tbl_enquiry .
