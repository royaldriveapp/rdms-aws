          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <div class="x_content">
                                   ...
                                   <?php
                                     foreach ((array) $enquires as $key => $value) {
                                          ...
                                          <tr title="<?php echo empty($value['foll_id']) ? 'Pending to set followup date' : '';?>"
                                              ...
                                              data-url="<?php echo site_url('followup_new/viewFollowup/' . encryptor($value['enq_id']));?>">
                                               ...
                                               <td><a style="<?php echo $color;?>" href="https://api.whatsapp.com/send?phone=<?php echo $indWPNumber;?>"><?php echo $value['enq_cus_mobile'];?></a></td>
                                               <td class="trVOE"><a style="<?php echo $color;?>" href="https://api.whatsapp.com/send?phone=<?php echo $value['enq_cus_whatsapp'];?>"><?php echo $value['enq_cus_whatsapp'];?></a></td>
                         ...
                         <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite"><?php echo 'Total '. $totalRow; ?> products</div>
