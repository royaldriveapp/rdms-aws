               ...
               <div class="x_panel">
                    <div class="x_title">
                         <h2>Follow up details of <?php echo $vehicles['enq_cus_name'];?> 
                              ...
                              <?php //}?><?php if (check_permission('homevisit', 'hw_can_add_request')) {?>
                                     <button type="button" class="homeVisit btn btn-success" data-toggle="modal" data-target="#homeVisit">Home Visit <div id="ov_hmvst"></div> 

                                     <?php }?> <?php //if (check_permission($controller, 'submitprocrmntreq')) { ?>
                                   <button type="button" class="testDrive btn btn-success" data-toggle="modal" data-target="#testDrive">Test Drive</button>
                                   <?php //} ?>
                         </h2>
                         <div id="uxTooltip"><p style="color: rgb(255, 255, 255);">Here you can have some related text</p><button id="uxGotIt" style="border: none; background: none; color: rgb(255, 255, 255); padding: 0px; outline: none; font-size: 16px; cursor: pointer;">GOT IT</button></div>
                         </button>
                         <ul class="nav navbar-right panel_toolbox">
                              <li class="dropdown" style="float: right;">
                                   <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
                                   <ul class="dropdown-menu" role="menu">
                                        <li><a target="blank" href="<?php echo site_url('enquiry_new/printTrackCard/' . encryptor($vehicles['enq_id']));?>">View tracking card</a></li>
                                        <li><a target="blank" href="<?php echo site_url('enquiry_new/view/' . encryptor($vehicles['enq_id']));?>">Edit enquiry</a></li>
                                   </ul>
                              </li>
                         </ul>
                    ...
                    <div class="x_content">
                         <div class="col-md-8 col-sm-12 col-xs-12">
                              <div class="panel panel-default">
                                   <div class="panel-heading" id="allf">All followup
                                                         ...
                                                         <li>
                                                              <div class="block">
                                                                   ...
                                                                   <div class="tags">
                                                                        ...
                                                                        ?>
                                                                        <a data-url="<?php echo site_url('followup_new/getSingleFollowup') . '/' . encryptor($vehicles['enq_id']) . '/' . $folDateYmd . '/' . $callBack . '/' . $enqType;?>" 
                                                                   ...
                                                                   <div class="modal" tabindex="-1" role="dialog" id="cmdModel<?php echo $value['foll_id'];?>">
                                                                        <div class="modal-dialog" role="document">
                                                                             <form class="modal-content" method="post" class="panel-body" action="<?php echo site_url('followup_new/updateComments');?>" onsubmit="return validateForm(this)">
                         ...
                         <div class="col-md-4 col-sm-12 col-xs-12">
                              <div class="panel panel-default">
                                   <?php if (check_permission('booking', 'takebooking')) {?>
                                          <div class="panel-heading">
                                               <div>Customer details 
                                                    <button data-url="<?php echo site_url('booking_new/reserveVehicleView/' . encryptor($vehicles['enq_id']));?>" 
                                   ...
                                   <div class="panel-body">
                                        <ul class="list-group">
                                             ...
                                             <?php if (!empty($vehicles['vehicle_sale_req'])) {?>
                                                    ...
                                                    foreach ($vehicles['vehicle_sale_req'] as $key => $value) {   // print_r($value);
                                                         ...
                                                         ?>
                                                         <li class="list-group-item"><i class="fa fa-car"></i> <?php echo $value['brd_title'] . ' ' . $value['mod_title'] . ' ' . $value['var_variant_name']?> <span class="glyphicon glyphicon-edit text-success model-change-veh" data-url="<?php echo site_url('followup_new/change_veh_form') . '/' . encryptor($value['veh_type']) . '/' . encryptor($value['veh_id']) . '/' . encryptor($value['veh_enq_id']) . '/' . encryptor($value['veh_brand']) . '/' . encryptor($value['veh_model']) . '/' . encryptor($value['veh_varient']) . '/' . encryptor($veh_details) . '/' . encryptor($veh_reg);?>"></span></li>
                                                         <?php
                                                    }
                                                    ...
                                                    foreach ($vehicles['vehicle_sale_pitched'] as $key => $value) {
                                                         ...
                                                         ?>
                                                         <li class="list-group-item"><i class="fa fa-car"></i> <?php echo $pitchedVev['brd_title'] . ' ' . $pitchedVev['mod_title'] . ' ' . $pitchedVev['var_variant_name']?> <span class="glyphicon glyphicon-edit text-success model-change-veh" data-url="<?php echo site_url('followup_new/change_veh_form') . '/' . encryptor($value['veh_type']) . '/' . encryptor($value['veh_id']) . '/' . encryptor($value['veh_enq_id']) . '/' . encryptor($pitchedVev['val_brand']) . '/' . encryptor($pitchedVev['val_model']) . '/' . encryptor($pitchedVev['val_variant']) . '/' . encryptor($veh_details) . '/' . encryptor($veh_reg);?>"></span></li>
                                                         <?php
                                                    }
                                               }
                                        ...
                                        <form id="demo-form2" method="post" action="<?php echo site_url('followup_new/changevehicle');?>" data-parsley-validate class="form-horizontal form-label-left frmVehicleStatus">
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <div class="col-md-9 col-sm-12 col-xs-12">
                                                       <select required data-url="<?php echo site_url('enquiry_new/bindModel');?>" data-bind="cmbEvModel" 
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <div class="col-md-9 col-sm-6 col-xs-12">
                                                       <select data-url="<?php echo site_url('enquiry_new/bindVarient');?>" data-bind="cmbEvVariant" data-dflt-select="Select Variant"
                              ...
                              <?php if (check_permission('followup', 'chghotwarmcold')) {?>
                                     <div class="panel panel-default">
                                          ...
                                          <div class="panel-body">
                                               <form id="demo-form2" method="post" action="<?php echo site_url('followup_new/changehotwarmcold');?>" data-parsley-validate class="form-horizontal form-label-left frmVehicleStatus">
                              ...
                              <?php if (check_permission('folup_trck_comment', 'generalcomment')) {?>
                                     <div class="panel panel-default">
                                          ...
                                          <form method="post" class="panel-body" action="<?php echo site_url('followup_new/updateComments');?>" onsubmit="return validateForm(this);">
          ...
          <div class=" modal-content bg-gray brd-radi cus-fdbk-content">
               ...
               <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btnSaveFollowUpFeedBack" 
                            data-url="<?php echo site_url('followup_new/editFollowUp');?>">Save changes</button>
               </div>
          </div>
     </div>
</div>
...
<div class="modal fade changeVehModal" id="changeVehModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document" style="width:64%;">
          <div class=" modal-content bg-gray brd-radi cus-fdbk-content">
               <form id="frmChangeVehicle" method="post" action="<?php echo site_url('followup_new/store_change_vehicle');?>" data-parsley-validate class="submitChangeVehicle form-horizontal form-label-left frmChangeVehicle">
...
<div class="modal fade" id="popPreferences" role="dialog">
     <div class="modal-dialog">
          <!-- Modal content-->    
          <?php echo form_open_multipart("followup_new/submit_preference", array('id' => "frmOfferPrice", 'class' => "submitPrefrnc modal-content form-horizontal form-label-left"))?>
          <div class="modal-header">
...
<div class="modal fade" id="procModal" role="dialog">
     <div class="modal-dialog">
          <?php echo form_open_multipart("followup_new/submitProcrmntReq", array('id' => "frmOfferPrice", 'class' => "submitProcReq modal-content form-horizontal form-label-left"))?>
          <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="brand" id="var_brand_id"  class="form-control col-md-7 col-xs-12 bindToDropdown" 
                                                ...
                                                data-url="<?php echo site_url('enquiry_new/bindModel');?>">
                                             <option value="">Select Brand</option>
                                             <?php
                                               if (!empty($brands)) {
                                                    foreach ($brands as $key => $value) {
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="model" id="var_brand_id" data-bind="cmbEvVariant" data-dflt-select="Select Model"
                                                data-url="<?php echo site_url('enquiry_new/bindVarient');?>"  class="form-control col-md-7 col-xs-12 cmbModel bindToDropdown"></select>
                                   </div>
                              </div>
                              <div class="form-group">
...
<div class="modal fade" id="homeVisit" role="dialog" >
     ...
     <div class="modal-dialog ">
          <?php echo form_open_multipart("followup_new/storeHomeVisit", array('id' => "home_Visit", 'class' => "submitHomeVisit  modal-content form-horizontal form-label-left"))?>
...
<div class="modal fade" id="testDrive" role="dialog">
     <div class="modal-dialog test_drive">
          <?php echo form_open_multipart("followup_new/storeTestDrive", array('id' => "test-Drive", 'class' => "test-drive test_drive modal-content form-horizontal form-label-left"))?>
...
<style>
     ...
     #ov_hmvst {
          ...
          display: none;
          border-radius: 50%;
          box-shadow: rgb(0 0 0 / 70%) 2px 0px 6px 99831px;
          top: -29px;
          left: 46px;
...
<script>
     ...
     $(document).ready(function () {
          alert();
//http://localhost/royalportal/rdportal/index.php/followup_new/viewfollowup_new/21001/#allf
          var type = window.location.hash.substr(1);
          //if (type && type == "ov_hmvst") {
               document.getElementById(type).style.display = "block";
               document.getElementById("uxTooltip").style.display = "block";
          //}  
          $(document).click(function () {
               document.getElementById("ov_hmvst").style.display = "none";
               document.getElementById("uxTooltip").style.display = "none";
...
<?php if ($vehicles['enq_cus_when_buy'] == 1) {?>
  ...
  <?php }?>
     ...
     $(document).on('click', '.Addbtn', function () {
          ...
          $.ajax({
               type: 'get',
               "url": site_url + "followup_new/add_preference",
               data: {count: count},
     ...
     $('.prfSel').on('change', function (e) {
          ...
          $.ajax({
               type: 'get',
               "url": site_url + "followup_new/append_pref_flds",
