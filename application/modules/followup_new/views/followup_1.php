               ...
               <div class="x_panel">
                    <div class="x_title">
                         <h2>Follow up details of <?php echo $vehicles['enq_cus_name']; ?> 
                              ...
                              <?php }if (check_permission($controller, 'submitprocrmntreq')) { ?>
                                   <button type="button" class="homeVisit btn btn-success" data-toggle="modal" data-target="#homeVisit">Home Visit Details</button>
                              <?php }if (check_permission($controller, 'submitprocrmntreq')) {?>
...
<div class="modal fade" id="homeVisit" role="dialog">
     <div class="modal-dialog ">
          <?php echo form_open_multipart("followup/submitHomeVisit", array('id' => "homeVisit", 'class' => "submitHomeVisit  modal-content form-horizontal form-label-left")) ?>
         
          <div class="modal-header bg-gray h-brd-radi">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               <h4 class="modal-title lbl"> Home Visit Details  <span class="msg"></span></h4>
          </div>
                         ...
                         <div class="row">
                              ...
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                               ...
                               <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerDMY" name="date" id="date" placeholder="Date"> 
                              </div>
                               </div>
                         <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <input type="text" class="form-control col-md-7 col-xs-12 " name="place" id="place" placeholder="Place"> 
                              </div>
                                </div>
                          <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="lbl" for="first-name">Variant</label>
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <input type="text" class="form-control col-md-7 col-xs-12 " name="travel_with" placeholder="Travel with"> 
                              </div>
                               </div>
...
<div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <input type="text" class="form-control col-md-7 col-xs-12 " name="out_km" placeholder="Out km"> 
                                   
                              </div>
        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="lbl">In Km</label>
                                   <input type="text" class="form-control col-md-7 col-xs-12 " name="In km"  placeholder="In km"> 
                              </div>
      </div>
                         <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">Approved home visit</label>
                                        ...
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">Discussion Time</label>
                                 
                                       <input type="text" class="form-control col-md-7 col-xs-12 " name="discussion_time"  placeholder="Discussion Time ">
                                   <input type="hidden" name="enq_id" value="<?php echo $vehicles['enq_id']; ?>">
                              <input type="hidden" name="enq_se_id" value="<?php echo $vehicles['enq_se_id']; ?>">
                              </div>
...
<div class="modal fade" id="testDrive" role="dialog">
     <div class="modal-dialog test_drive">
          <?php echo form_open_multipart("followup/submitTestDrive", array('id' => "test-Drive", 'class' => "test-drive  modal-content form-horizontal form-label-left")) ?>
         
          <div class="modal-header bg-gray h-brd-radi">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               <h4 class="modal-title lbl"> Test Drive Details  <span class="msg"></span></h4>
          </div>
          <div class="modal-body bg-gray brd-radi">
               <div class="mdl_div">
                    <div class='flds'>
                         <div class="row">
                              ...
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                               ...
                               <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <div>
                                              <input required placeholder="KL" id="enq_cus_loan_emi" style="width: 90px;text-transform:uppercase;" class="form-control col-md-7 col-xs-12" type="text" name="vehicle[buy][veh_reg1][]" autocomplete="off">
                                                            <input required placeholder="00" id="enq_cus_loan_emi" style="width: 90px;" class="form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][veh_reg2][]" autocomplete="off">
                                                            <input required placeholder="AA" id="enq_cus_loan_emi" style="width: 90px;text-transform:uppercase;" class="form-control col-md-7 col-xs-12" type="text" name="vehicle[buy][veh_reg3][]" autocomplete="off">
                                                            <input required placeholder="0000" id="enq_cus_loan_emi" style="width: 115px;" class="form-control col-md-7 col-xs-12 numOnly" type="text" name="vehicle[buy][veh_reg4][]" autocomplete="off">
                                   </div>
                              </div>
                               </div>
                         <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <input type="text" class="form-control col-md-7 col-xs-12 " name="test_drive_at" placeholder="Test Drive at "> 
                              </div>
                                </div>
                          <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="lbl">Stage of Lead</label>
                                   <input type="text" class="form-control col-md-7 col-xs-12 " name="stage_of_lead" id="place" placeholder="Stage of Lead"> 
                              </div>
                               </div>
...
<div class="row">
        ...
        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                         ...
                         <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">Required/Pitched Vehicle</label>
                                        ...
                                        <input type="text" class="form-control col-md-7 col-xs-12 " name="req_or_pitched"  placeholder="Required or Pitched Vehicle">
                              </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">Test Drive Date</label>
                                 
                                       <input type="text" class="form-control col-md-7 col-xs-12 " name="test_drive_date"  placeholder="Test Drive Date">
                                   <input type="hidden" name="enq_id" value="<?php echo $vehicles['enq_id']; ?>">
                              <input type="hidden" name="enq_se_id" value="<?php echo $vehicles['enq_se_id']; ?>">
                              </div>
                          ...
                          <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">Price Difference after Test Drive </label>
                                 
                                        <input type="text" class="form-control col-md-7 col-xs-12 " name="price_diff"  placeholder="Price Difference after Test Drive ">
                              </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">Executive Reamrk</label>
                                 
                                       <input type="text" class="form-control col-md-7 col-xs-12 " name="executive_remark"  placeholder="Executive Reamrk">
                         ...
                         <div class="row">
                              <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">TL Remark </label>
                                 
                                        <input type="text" class="form-control col-md-7 col-xs-12 " name="tl_remark"  placeholder="TL Remark">
                              </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                   <label class="control-label lbl">SM Reamrk</label>
                                 
                                       <input type="text" class="form-control col-md-7 col-xs-12 " name="sm_remark"  placeholder="SM Reamrk">
  ...
  <input class="form-check-input radio-btn" type="radio" name="expet_booking"  value="1" id="flexRadioDisabled">
  <label class="form-check-label" for="expet_booking">
       <span class="lbl">Yes</span>
  </label>
  <input class="form-check-input radio-btn" type="radio" name="expet_booking" value="0" id="flexRadioDisabled">
  <label class="form-check-label" for="expet_booking">
