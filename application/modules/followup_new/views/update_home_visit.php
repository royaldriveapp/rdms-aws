...
<div class='flds'>
     <div class="panel pnl-bg-color panel-default enq-sts-bg">
          <div class="panel-heading cusfdbkhcolor lbl"><span class="glyphicon glyphicon-user"></span>&nbsp;<font color='Black'><?php echo $homeVisit['enq_added_by_name']; ?> </font><center><font color='red'><?php echo (empty($approval))? 'Your request is not approved.!':'' ?> </font></center> </div>
          <div class="panel-body">
               ...
               <div class="row">
                         ...
                         <label class="lbl">Vehicle</label> :<span class="txt"><?php 
                           ...
                           //echo $homeVisit['brd_title'] . ' ' . $homeVisit['mod_title'] . ' ' . $homeVisit['var_variant_name']?></span>
                    </div>
                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
    ...
    <?php } ?>
     <div class="row">
          <div class="form-group col-md-6 col-sm-6 col-xs-12">
               ...
               <input required="" type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerDMY" name="hmv_in_date" id="date" placeholder="In Date " value="<?php echo $homeVisit['hmv_in_date']?>" autocomplete="off"> 
