...
<div class='flds'>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
            <?php //print_r($approval['hmva_approval_status']);?>
             <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $key ?>"><span class="glyphicon <?php echo $apprvl['hmva_approval_status']==2 ? ' glyphicon-remove':'glyphicon-ok'?>"></span>&nbsp;  <label class="lbl2"><?php echo $apprvl['hmva_approval_status']==2 ? ' Rejected by':'Approved by'?></label>:<span class="txt2"><?php echo $apprvl['approved_by']?></span></center></a>
        </h4>
      </div>
     ...
     <div class="row">
          <div class="form-group col-md-12 col-sm-12 col-xs-12">
               ...
               <input type="text" class="form-control col-md-7 col-xs-12 " name="hmva_remarks"  placeholder="Enter Remark">
          </div>
          <input type="hidden" name="hmva_master_id" value="<?php echo $homeVisit['hmv_id'];?>">
