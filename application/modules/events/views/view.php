     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <div class="x_content">
                         <br />
                         <?php echo form_open_multipart($controller . "/update", array('id' => "frmBrand", 'class' => "form-horizontal form-label-left frmEmployee"))?>
                         <input  type="hidden" value="<?php echo $data['evnt_id']?>" name="evnt_id"/>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input required="true" type="text" class="form-control col-md-7 col-xs-12" 
                                          value="<?php echo $data['evnt_title']?>" name="evnt_title" id="evnt_title" placeholder="Event Title"/>
                              </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <textarea required="true" placeholder="Event Description" class="editor" name="evnt_desc"><?php echo $data['evnt_desc']?></textarea>
                              </div>
                         </div>

                         <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Place <span class="required">*</span></label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input required="true" type="text" class="form-control col-md-7 col-xs-12" 
                                          value="<?php echo $data['evnt_place']?>"
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <input required="true" type="text" class="form-control col-md-7 col-xs-12 dtpDatePicker" 
                                          value="<?php echo date('d-m-Y', strtotime($data['evnt_date']))?>"
