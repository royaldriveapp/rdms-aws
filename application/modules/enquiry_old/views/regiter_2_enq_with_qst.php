                                        ...
                                        <div class="row bg-clr top-tb">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="enquiry[enq_entry_date]" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12 form-control-enq" required="true" value="<?php echo date('d-m-Y'); ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input value="<?php echo isset($datas['vreg_cust_name']) ? $datas['vreg_cust_name'] : ''; ?>" name="enquiry[enq_cus_name]" type="text" id="enq_cus_name" class="form-control form-control-enq col-md-7 col-xs-12 enq_cus_name" required="">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="enq_cus_address" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Address<span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input required="true" id="enq_cus_address" value="<?php echo $datas['vreg_address']; ?>" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_address]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input required="true" id="enq_cus_ofc_address" value="" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_ofc_address]">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="enq_cus_mobile" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Mobile
                                                        <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input value="<?php echo isset($datas['vreg_cust_phone']) ? $datas['vreg_cust_phone'] : ''; ?>" id="enq_cus_mobile" class="form-control form-control-enq col-md-7 col-xs-12 numOnly enq_cus_mobile" type="text" name="enquiry[enq_cus_mobile]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12 lbl">
                                                        <input value="<?php echo isset($datas['enq_cus_office_no']) ? $datas['enq_cus_office_no'] : ''; ?>" id="enq_cus_office_no" class="form-control form-control-enq col-md-7 col-xs-12 numOnly enq_cus_office_no" type="text" name="enquiry[enq_cus_office_no]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input value="<?php echo isset($datas['vreg_cust_place']) ? $datas['vreg_cust_place'] : ''; ?>" id="enq_cus_city" class="autoComCity form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_city]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input id="enq_cus_email" class="form-control form-control-enq col-md-7 col-xs-12 emailOnly" type="text" value="<?php echo isset($datas['vreg_email']) ? $datas['vreg_email'] : ''; ?>" name="enquiry[enq_cus_email]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_whatsapp" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Whatsapp</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input id="enq_cus_whatsapp" class="form-control form-control-enq col-md-7 col-xs-12 numOnly enq_cus_whatsapp" type="text" name="enquiry[enq_cus_whatsapp]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_fbid" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Customer
                                                        FB Id</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input id="enq_cus_fbid" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_fbid]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="enq_cus_age_group" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Age
                                                        group</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group"><?php // print_r($Profession); 
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select required="true" class="select2_group form-control form-control-enq" name="enquiry[enq_cus_occu]">
                                                            <option value="">-Select-</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input id="enq_cus_company" value="<?php echo $datas['vreg_company']; ?>" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_company]">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="enq_cus_phone_res" class="control-label col-md-3 col-sm-3 col-xs-12 lbl">Resi
                                                        phone</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input id="enq_cus_phone_res" class="form-control form-control-enq col-md-7 col-xs-12" type="text" name="enquiry[enq_cus_phone_res]">
                                                    </div>
                                                </div>
                                                <!--                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12" id="distict">
                                                        <select required="true" class="select2_group form-control form-control-enq" name="enquiry[enq_cus_dist]">
                                                            ...
                                                            <?php foreach ($districts as $district) { ?>
                                                                <option value="<?php echo $district['std_id'] ?>" <?php echo $datas['vreg_district'] == $district['std_id'] ? 'selected' : '' ?>>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input id="enq_cus_pin" class="form-control form-control-enq col-md-7 col-xs-12 numOnly" type="number" name="enquiry[enq_cus_pin]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group TypeSalej">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select required="true" class="select2_group form-control form-control-enq" name="enquiry[enq_cus_purpose]" id="purpose">
                                                            <option value="">-Select-</option>
                        ...
                        <div id="step-5">
                            <div class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="<?php echo isset($datas['vreg_customer_remark']) ? strip_tags($datas['vreg_customer_remark']) : ''; ?>" id="foll_remarks" class="form-control col-md-7 col-xs-12" type="text" name="followup[foll_remarks]">
                                    </div>
                                </div>
