                                   ...
                                   <?php
                                     if (!empty($enquires)) {
                                          foreach ($enquires as $key => $value) {
                                             $moile = clean_whatsapp_num($value['enq_cus_mobile']);
                                               $whatap = clean_whatsapp_num($value['enq_cus_whatsapp']);
                                               ?>
                                               <tr data-url="<?php echo site_url($controller . '/view/' . $value['shr_id']);?>" id="trQuickFollow<?php echo $value['qtr_id']?>">
                                                    ...
                                                    <td>
                                                       <a target="blank" <?php echo 'href="https://api.whatsapp.com/send?phone=' . $moile . '"'; ?>><?php echo $value['enq_cus_mobile'];?></a>
                                                       <a href="sip:<?php echo $moile;?>"><i class="fa fa-phone" style="font-size:15px;"></i></a>
                                                    </td>
                                                    <td>
                                                       <?php if(!empty($value['enq_cus_whatsapp'])) { ?>
                                                            <a target="blank" <?php echo 'href="https://api.whatsapp.com/send?phone=' . $whatap . '"'; ?>><?php echo $value['enq_cus_whatsapp'];?></a>
                                                       <?php } ?>
                                                    </td>
