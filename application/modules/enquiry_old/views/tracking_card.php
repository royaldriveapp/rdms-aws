        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <?php echo (isset($trackCard['val_status']) && ($trackCard['val_status'] == 0)) ?  ' - <a href="' . site_url('evaluation/printevaluation/' . $trackCard['val_id']) . '">Valuate</a>' : ''; ?>
                ...
                <div class="x_content">
                    <form class="form_wizard wizard_horizontal" action="#" role="form" data-toggle="validator"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                        <?php echo isset($showRoom['shr_address']) ? $showRoom['shr_address'] : ''; ?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr style="height: 35px;">
                                    <td style="width: 670px; height: 35px;" colspan="7">
                                        <p style="text-align: center;"><strong>ROYAL DRIVE Pre Owned Cars LLP
                                                <?php echo $trackCard['shr_location']; ?></strong></p>
                                    </td>
                                </tr>
                                <tr style="height: 48px;">
                                    <td style="width: 498px; height: 48px;" colspan="4">
                                        <p style="text-align: left;"><strong>Name of Executive :
                                                <?php echo $trackCard['usr_username']; ?></strong></p>
                                    </td>
                                    <td style="width: 166px; height: 48px;" colspan="3">
                                        <p>
                                            <strong>Enquiry Date :
                                                <?php echo date('j M Y', strtotime($trackCard['enq_entry_date'])); ?></strong><br>
                                            <strong>Entry Date :
                                                <?php echo date('j M Y h:i A', strtotime($trackCard['enq_added_on'])); ?></strong>
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr style="height: 35px;">
                                    <td style="width: 150px; height: 35px;">
                                        <p><strong>Customer ID : <?php echo $trackCard['enq_number']; ?></strong></p>
                                    </td>
                                ...
                                <tr style="height: 35px;">
                                    ...
                                    <td style="width: 157px; height: 35px;">
                                        <p><strong>Pin:
                                                <?php echo !empty($trackCard['enq_cus_pin']) ? $trackCard['enq_cus_pin'] : ''; ?></strong>
                                        </p>
                                    </td>
                                </tr>
                                <tr style="height: 35px;">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th><?php echo !empty($trackCard['enq_cus_loan_amount']) ? $trackCard['enq_cus_loan_amount'] : ''; ?>
                                </th>
                                <th><?php echo !empty($trackCard['enq_cus_loan_emi']) ? $trackCard['enq_cus_loan_emi'] : ''; ?>
                                </th>
                                <th><?php echo !empty($trackCard['enq_cus_loan_period']) ? $trackCard['enq_cus_loan_period'] : ''; ?>
                                </th>
                            </tr>
                        </table>
                        <?php }
                        ...
                        <ul class="list-unstyled timeline">
                            ...
                            <li>
                                <div class="block">
                                    ...
                                    <div class="block_content">
                                        <p class="excerpt" style="font-weight: bolder;font-size: 15px;">
                                            <span><i class="fa fa-clock-o"></i>
                                                <?php echo date('Y-m-d h:i:s', strtotime($value['foll_entry_date'])); ?></span>
                                        </p>
                                        <?php
                                    ...
                                    <!-- Repeated contents -->
                                    <div
                                        style="font-style: italic;background: #E7E7E7;padding: 10px;border-radius: 10px;">
                                        <p class="excerpt">
                            ...
                            <li>
                                <div class="block">
                                    ...
                                    <?php }
                                                            if ($value['folloup_added_by_id'] != $this->uid) { ?>
                                    <p class="excerpt alignright">Added by : <?php
                        ...
                        <?php } ?>
                        <p style="text-align: center;"><strong><u><br />Enquiry Analysis (Reasons for the
                                    Drop/Close/Lose of Purchase or Sale/ Delete)</u></strong></p>
                        <table class="table table-striped table-bordered" style="margin-left: auto; margin-right: auto;"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="165">
                                        <p><strong><?php echo $value['brd_title'] . ', ' . $value['mod_title'] . ', ' . $value['var_variant_name']; ?></strong>
                                        </p>
                                    </td>
                                    <td width="165">
                                ...
                                <?php }
                                        foreach ((array) $trackCard['vehicle_buy'] as $key => $value) { ?>
                                <tr>
                                    <td width="165">
                                        <p><strong><?php echo $value['brd_title'] . ', ' . $value['mod_title'] . ', ' . $value['var_variant_name']; ?></strong>
                                        </p>
                        ...
                        <p style="text-align: center;"><strong>Executive
                                signature:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                SM/TL
                                Signature:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                MD Signature :</strong></p>
