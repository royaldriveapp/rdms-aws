...
class enquiry_model extends CI_Model
{
     ...
     public function readVehicleRegTesting($id = '', $limit = 0, $page = 0, $filter = array())
     { //cpd to api 17171
          ...
          $isPunched = (isset($filter['vreg_is_punched'])) ? $filter['vreg_is_punched'] : 0;
     ...
     { //cpd to api 17171
          ...
          if (!$assign) {
               ...
               $selectArray = array(
                   ...
                   // $this->tbl_customer_details . '.cusd_phone',
