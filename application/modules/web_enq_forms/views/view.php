               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                         <div class="x_title">
                              ...
                              &nbsp; &nbsp; 
                                <?php if (check_permission('web_enq_forms', 'updatefellowship')) { ?>
                              <a class="btn btn-info" href="<?php echo site_url('web_enq_forms/edit'); ?>/<?php echo $master['web_id']?>"> <i class="fa fa-edit" style="font-size:15px;color:green"></i> Edit</a>
                             <?php } ?>
...
<?php endif; ?>
                         ...
                         <form action="<?php echo site_url('web_enq_forms/addToReg'); ?>" method="post" class="form-horizontal" onsubmit="disableSubmitButton()">
