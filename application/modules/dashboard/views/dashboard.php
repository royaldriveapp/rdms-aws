        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel tile" style="padding: 5px;margin: 1px;">
                <div class="x_title" style="border: none;margin: 0px;">
                    <marquee style="font-size: 18px;color: brown;font-style: italic;font-style:italic;"
                        onmouseover="this.stop();" onmouseout="this.start();" SCROLLAMOUNT=3>
                        <?php echo get_settings_by_key('dashboard_news');?></marquee>
                        ...
                        <div class="w_center w_55">
                            <div class="progress">
                                <div class="progress-bar bg-green" role="progressbar"
                                    aria-valuenow="<?php echo $value['total_no'];?>" aria-valuemin="0"
                                    aria-valuemax="<?php echo $dashboardMeterials['mode_of_enq_total_count']?>"
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo site_url('reports/enquiries?status=' . $value['enq_cus_when_buy']);?>"
                                                target="blank"><i class="fa fa-square"
                                                    style="<?php echo 'color: ' . $color;?>"></i>
                ...
                <div class="x_content">
                    <div class="dashboard-widget-content">
                        <ul class="quick-list" style="width: 100%;">
                            ...
                            <li><i class="fa fa-hand-o-right"></i><a target="blank"
                                    href="<?php echo site_url('followup/running');?>">Running Followup
                                    <?php echo isset($analytics['count_running_followup']) && $analytics['count_running_followup'] > 0 ? '<span class="label label-success pull-right">' . $analytics['count_running_followup'] . '</span>' : '';?></a>
                            </li>
                            <li><i class="fa fa-hand-o-right"></i><a target="blank"
                                    href="<?php echo site_url('followup/missed');?>">Missed Followup
                                    <?php echo isset($analytics['count_missid_followup']) && $analytics['count_missid_followup'] > 0 ? '<span class="label label-success pull-right">' . $analytics['count_missid_followup'] . '</span>' : '';?></a>
                            </li>
                            ...
                            <?php }?>
                            <li><i class="fa fa-hand-o-right"></i><a target="blank"
                                    href="<?php echo site_url('evaluation/index/0');?>">Pending Evaluation
                                    <?php echo isset($analytics['count_pending_evaluation']) && $analytics['count_pending_evaluation'] > 0 ? '<span class="label label-success pull-right">' . $analytics['count_pending_evaluation'] . '</span>' : '';?></a>
                            </li>
                            <li><i class="fa fa-hand-o-right"></i><a target="blank"
                                    href="<?php echo site_url('evaluation/index/1');?>">Evaluated Vehicles
                                    <?php echo isset($analytics['count_evaluated_vehicle']) && $analytics['count_evaluated_vehicle'] > 0 ? '<span class="label label-success pull-right">' . $analytics['count_evaluated_vehicle'] . '</span>' : '';?></a>
                            </li>
                            <!--<li><i class="fa fa-hand-o-right"></i><a target="blank" href="<?php //echo site_url('enquiry/add');?>">New Enquiry</a></li>-->
                            <li><i class="fa fa-hand-o-right"></i><a target="blank"
                                    href="<?php echo site_url('evaluation/add');?>">Evaluate New Vehicle</a></li>
                            <?php if (check_permission('enquiry', 'changestatusrequest')) {?>
                            <!-- <li>
                                                  <i class="fa fa-hand-o-right"></i><a target="blank" href="<?php //echo site_url('enquiry/changeStatusRequest/8');?>">Request For Delete
                            ...
                            <li><i class="fa fa-hand-o-right"></i><a target="blank"
                                    href="<?php echo site_url('enquiry/changeStatusRequest/2');?>">Request For Drop
                                    <?php echo isset($analytics['count_drop_req']) && $analytics['count_drop_req'] > 0 ? '<span class="label label-success pull-right">' . $analytics['count_drop_req'] . '</span>' : '';?></a>
                            </li>
                            <li><i class="fa fa-hand-o-right"></i><a target="blank"
                                    href="<?php echo site_url('enquiry/changeStatusRequest/6');?>">Request For Close
                                    <?php echo isset($analytics['count_sale_req']) && $analytics['count_sale_req'] > 0 ? '<span class="label label-success pull-right">' . $analytics['count_sale_req'] . '</span>' : '';?></a>
                            </li>
                            <?php } if (is_roo_user()) {?>
                            <!-- <li><i class="fa fa-hand-o-right"></i><a target="blank" href="<?php echo site_url('enquiry/freezedEnquires');?>">Freezed Enquires
                                                       <?php //echo isset($analytics['count_freezed_enquiry']) && $analytics['count_freezed_enquiry'] > 0 ? '<span class="label label-success pull-right">' . $analytics['count_freezed_enquiry'] . '</span>' : '';?></a></li> -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?php echo site_url('enquiry/myregister');?>" class="btn btn-primary">View all <i
