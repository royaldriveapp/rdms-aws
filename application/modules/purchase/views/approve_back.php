                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label for="foll_contact" class="control-label col-md-3 col-sm-3 col-xs-12">MOU</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12"><?php echo $data['pr_mou_no']; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="select2_group form-control cmbFollStatus select2 vehicleSelect" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <?php if (get_settings_by_key('show_bl_on_sales') == 1) { ?>
                                            <spam class="spnLabel">Bank part remove three zero from last</spam>
                                        <?php } ?>
                                    </div>
                                </div>
