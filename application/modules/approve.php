                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="foll_contact"
                                            class="control-label col-md-3 col-sm-3 col-xs-12">Division <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select class="select2_group form-control cmbBindShowroomByDivision"
                                                name="moum_division" id="moum_division"
                                    ...
                                    <div class="form-group">
                                        <label for="foll_contact"
                                            class="control-label col-md-3 col-sm-3 col-xs-12">Showroom <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select required class="select2_group form-control cmbShowroom shorm_stf"
                                                name="moum_showroom" id="moum_showroom">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Regn Number <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12 regNumber"
                                                name="moum_reg_num" required id="moum_reg_num"
                                                placeholder="KL00AA0000" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                            for="first-name">Vehicle</label>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <select data-url="<?php echo site_url('enquiry/bindVarient'); ?>"
                                                ...
                                                name="moum_model" id="invv_model">
                                            </select>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <select class="select2_group form-control cmbEvVariant" name="moum_varient"
                                                id="invv_varient"></select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Purchase Place <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12"
                                                name="moum_purchase_place" required id="moum_purchase_place"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <div class="input-group date" id="dtpMOUDate">
                                                <input required type="text" class="form-control" name="moum_date"
                                                    placeholder="Date" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12"
                                                name="moum_customer_name" required id="moum_customer_name"
                                                placeholder="Customer Name" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Customer Phone <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control col-md-7 col-xs-12"
                                                name="moum_cust_phone" required id="moum_customer_name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="email" class="form-control col-md-7 col-xs-12"
                                                name="moum_cust_email" id="moum_cust_email"
                                                placeholder="Customer Email" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Name of father <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12"
                                                name="moum_father_name" required id="moum_father_name"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Address <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <textarea class="form-control col-md-7 col-xs-12" required
                                                placeholder="Address" name="moum_address"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Pin <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control col-md-7 col-xs-12" required
                                                name="moum_pin" id="moum_pin" placeholder="Pin" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">District <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select required class="select2_group form-control" name="moum_dist"
                                                id="moum_dist">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Purchase Staff <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select required class="select2_group form-control" name="moum_pur_staff"
                                                id="moum_pur_staff">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Net Price <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control col-md-7 col-xs-12" required
                                                name="moum_net_price" id="moum_net_price" placeholder="Net Price" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control col-md-7 col-xs-12" required
                                                name="moum_bl_amt" id="moum_bl_amt" placeholder="Evaluation charges" />
                                            <?php if (get_settings_by_key('show_bl_on_sales') == 1) { ?>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Advance Token <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control col-md-7 col-xs-12" required
                                                name="moum_adv_token" id="moum_adv_token" placeholder="Advance Token" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="foll_contact"
                                            class="control-label col-md-3 col-sm-3 col-xs-12">Sourcing type*</label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select class="select2_group form-control" name="moum_purchase_type"
                                                required>
                                    ...
                                    <div class="form-group">
                                        <label for="foll_contact"
                                            class="control-label col-md-3 col-sm-3 col-xs-12">Vehicle Category*</label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select class="select2_group form-control cmbFollStatus"
                                                name="moum_vehicle_category" required>
                                                <option value="">Select</option>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <div class="input-group date" id="dtpConveyOn">
                                                <input required type="text" class="form-control" name="moum_convey_on"
                                                    placeholder="First Party convey on" />
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Agreement Days <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control col-md-7 col-xs-12"
                                                name="moum_agrmnt_days" required id="moum_agrmnt_days"
                                                placeholder="Agreement Days" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th><span style="cursor: pointer;"
                                                        class="glyphicon glyphicon-plus btnComponents"></span></th>
                                            </tr>
                                        </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control col-md-7 col-xs-12" required
                                                        name="AA[number][]" id="mou_engine_number"
                                                        placeholder="Engine Number" />
                                                </td>
                                                <td colspan="2">
                                                    <input type="text" class="form-control col-md-7 col-xs-12" required
                                                        name="AA[remarks][]" id="mou_engine_number"
                                                        placeholder="Remarks" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control col-md-7 col-xs-12" required
                                                        name="AA[number][]" id="mou_chassis_number"
                                    ...
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Remarks</th>
                                                <th><span style="cursor: pointer;"
                                                        class="glyphicon glyphicon-plus btnWarranty"></span></th>
                                            </tr>
                                        </thead>
                                        <tbody class="tbWarranty">
                                            <tr>
                                                <td><input class="form-control col-md-7 col-xs-12" type="text"
                                                        name="AB[component][]" placeholder="Particulars" /></td>
                                                <td>
                                                    <input type="text" class="form-control col-md-7 col-xs-12"
                                                        placeholder="Identification Number" id="mou_engine_number"
                                                        name="AB[number][]" />
                                                </td>
                                                <td colspan="2">
                                                    <input type="text" class="form-control col-md-7 col-xs-12"
                                                        placeholder="Remarks" id="mou_engine_number"
                                                        name="AB[remarks][]" />
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="foll_contact"
                                            class="control-label col-md-3 col-sm-3 col-xs-12">Company <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select class="select2_group form-control" name="moum_fin_year_code"
                                                id="moum_fin_year_code" required>
                                                <option value="0">Select company</option>
                                                <?php foreach ($company as $key => $value) { ?>
                                                <option
                                                    <?php echo ($this->div == $value['div_id']) ? 'selected' : ''; ?>
                                                    value="<?php echo $value['cmp_finance_year_code']; ?>">
                                    ...
                                    <div class="form-group">
                                        <label for="foll_contact"
                                            class="control-label col-md-3 col-sm-3 col-xs-12">Color <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select class="select2 select2_group form-control" name="moum_color"
                                                id="moum_color" required>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Model Year <span
                                                class="required">*</span></label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input required type="text" class="form-control col-md-7 col-xs-12"
                                                name="moum_model_year" id="moum_model_year" placeholder="Model Year" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input required type="number" class="form-control col-md-7 col-xs-12"
                                                name="moum_aadhaar" id="moum_aadhaar" placeholder="Aadhaar number" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input required type="text" class="form-control col-md-7 col-xs-12"
                                                name="moum_pan" id="moum_pan" placeholder="PAN Card number" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Remarks</th>
                                                <th><span style="cursor: pointer;"
                                                        class="glyphicon glyphicon-plus btnRefurb"></span></th>
                                            </tr>
                                        </thead>
