...
WHERE   datediff(current_date,date(val_purchased_date)) $gl $no AND val_type=$type AND val_re_evaluated=0";
     ...
     function getMtdPaginate($postDatas, $sl_staff)
     {
          ...
          $totalRecords = $this->getMtdTotal($searchValue, $sl_staff);
          ...
          $selArray = array(
               ...
               'addedby.usr_first_name AS addedby_usr_first_name',
               'addedby.usr_last_name AS addedby_usr_last_name',
               $this->tbl_register_master . '.vreg_id', $this->tbl_register_master . '.vreg_assigned_to', $this->tbl_register_master . '.vreg_added_by', $this->tbl_register_master . '.vreg_contact_mode', $this->tbl_register_master . '.vreg_district', $this->tbl_register_master . '.vreg_tsc_comments', $this->tbl_register_master . '.vreg_added_on', $this->tbl_register_master . '.vreg_cust_name', $this->tbl_register_master . '.vreg_cust_phone', $this->tbl_register_master . '.vreg_email', $this->tbl_register_master . '.vreg_cust_place', $this->tbl_register_master . '.vreg_existing_vehicle', $this->tbl_register_master . '.vreg_occupation', $this->tbl_register_master . '.vreg_brand', $this->tbl_register_master . '.vreg_model', $this->tbl_register_master . '.vreg_varient', $this->tbl_register_master . '.vreg_year', $this->tbl_register_master . '.vreg_investment', $this->tbl_register_master . '.vreg_km', $this->tbl_register_master . '.vreg_customer_status', $this->tbl_register_master . '.vreg_type_of_visit', $this->tbl_register_master . '.vreg_tsc_comments', $this->tbl_register_master . '.vreg_appointment', $this->tbl_register_master . '.vreg_second_d_hpy_cal', $this->tbl_register_master . '.vreg_second_d_hpy_cal', $this->tbl_register_master . '.vreg_division', $this->tbl_register_master . '.vreg_showroom', $this->tbl_register_master . '.vreg_call_type', $this->tbl_register_master . '.vreg_event', $this->tbl_register_master . '.vreg_is_effective', $this->tbl_register_master . '.vreg_entry_date', $this->tbl_register_master . '.vreg_is_punched', $this->tbl_register_master . '.vreg_customer_remark', $this->tbl_register_master . '.vreg_inquiry', $this->tbl_register_master . '.vreg_is_verified', $this->tbl_register_master . '.vreg_next_followup', $this->tbl_register_master . '.vreg_cust_place', $this->tbl_register_master . '.vreg_referal_type', $this->tbl_register_master . '.vreg_referal_name', $this->tbl_register_master . '.vreg_referal_phone', $this->tbl_register_master . '.vreg_last_action',
               $this->tbl_brand . '.brd_id', $this->tbl_brand . '.brd_title',
               $this->tbl_model . '.mod_id', $this->tbl_model . '.mod_title',
               $this->tbl_variant . '.var_id', $this->tbl_variant . '.var_variant_name',
     ...
     function getMtdTotal($searchValue, $sl_staff)
     {
          $firstDayOfMonth = date('Y-m-01');
          $lastDayOfMonth = date('Y-m-t');
     ...
     function getFtdPaginate($postDatas, $sl_staff)
     {
          ...
          $totalRecords = $this->getFtdTotal($searchValue, $sl_staff);
     ...
     function getFtdTotal($searchValue, $sl_staff)
     {
          $today = date('Y-m-d');
          $this->db->from($this->re_assign_reports)->where('DATE(re_added_on)', $today)->where('re_staff', $sl_staff);
          if (check_permission('reports', 'reassignreport_showmyself')) {
               $this->db->where('cpnl_re_assign_reports.re_added_by', $this->uid);
          }
          if (!empty($searchValue)) {
