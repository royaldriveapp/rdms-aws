          ...
          <div class="card card-stats">
               ...
               <div class="card-body">
                    ...
                    <p class="mt-3 mb-0 text-sm">
                         ...
                         <span class="text-nowrap">Customer cut the call</span>
                    </p>
               </div>
          </div>
     </div>
     ...
     <div class="col-md-3 col-sm-4 col-xs-6">
          <div class="card card-stats">
               ...
               <div class="card-body">
                    ...
                    <p class="mt-3 mb-0 text-sm">
                         <span class="text-success mr-2"><i class="fa fa-arrow-up"></i></span>
                         <span class="text-nowrap">Calicut DID</span>
                    </p>
               </div>
          </div>
     </div>
     ...
     <div class="col-md-3 col-sm-4 col-xs-6">
          <div class="card card-stats">
               ...
               <div class="card-body">
                    ...
                    <p class="mt-3 mb-0 text-sm">
                         <span class="text-success mr-2"><i class="fa fa-arrow-up"></i></span>
                         <span class="text-nowrap">Kochi DID</span>
                    </p>
               </div>
          </div>
     </div>
     ...
     <div class="col-md-3 col-sm-4 col-xs-6">
          <div class="card card-stats">
               ...
               <div class="card-body">
                    ...
                    <p class="mt-3 mb-0 text-sm">
                         <span class="text-success mr-2"><i class="fa fa-arrow-up"></i></span>
                         <span class="text-nowrap">Malappuram DID</span>
                    </p>
               </div>
          </div>
     </div>
