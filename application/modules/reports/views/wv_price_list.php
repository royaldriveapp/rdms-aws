          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <div class="x_content">
                                             ...
                                             <td>
                                                  <select class="select2_group form-control cmbBindShowroomByDivision" name="vreg_division" id="vreg_division"
                                                       ...
                                                       <?php foreach ($division as $key => $value) { 
                                                            if($value['div_id']==1 OR $value['div_id']==2){
                                                            ?>
                                                            <option <?php
                         ...
                         <input type="hidden" id="id-2" value="Model">
                         <input type="hidden" id="id-3" value="Varient">
                         <input type="hidden" id="id-4" value="Mode">
                         <input type="hidden" id="id-5" value="Color">
                         <input type="hidden" id="id-6" value="Fuel">
                         <input type="hidden" id="id-7" value="Mnr Year">
                         <input type="hidden" id="id-8" value="Month & Year of">
                         <input type="hidden" id="id-9" value="Reg no">
                         <input type="hidden" id="id-10" value="Km">
                         <input type="hidden" id="id-11" value="No.Owners ">
                         <input type="hidden" id="id-12" value="INS">
                         <input type="hidden" id="id-13" value="IDV">
                         <input type="hidden" id="id-14" value="Price">
                         <input type="hidden" id="id-15" value="Booking Date">
                         <input type="hidden" id="id-16" value="Booked Staff Name">
                         <input type="hidden" id="id-17" value="Status">
                                             ...
                                             <div class="row">
                                                  <div class="table-responsive">
                                                       <table id="example" class="table table-striped table-bordered bg-clr display"  id="rowClick" cellspacing="0" width="10%">
                                                            <thead >
                                                                 <tr class="">
                                                                      <th width="5%">Sl No</th> <th width="10%" data-0="Brand"> <span></span></th><th  width="5%" data-1="Model"><span></span></th> <th  width="5%" data-2="Varient"><span></span></th><th  width="2%" data-3="Mode"><span></span> </th><th  width="2%" data-id="123"><span></span></th><th width="2%" class="singleline"><span></span></th> <th width="2%" class="singleline"><span></span></th><th width="2%" class="singleline"><span></span></th><th width="2%" class="singleline"> <span></span></th> <th width="2%" class="singleline"><span></span></th> <th width="2%" class="singleline"> <span></span></th> 
                                                            ...
                                                            <tbody id="ajx_contentjs"> <?php
                                                                 if (!empty($details)) {
                                                                      foreach ($details as $key => $value) {
                                                                           // if($value['val_id']!=4361 AND $value['val_id']!=4511 AND $value['val_id']!=4583 AND $value['val_id']!=4528 AND $value['val_id']!=4944 
                                                                           // AND $value['val_id']!=4970 AND $value['val_id']!=5110 AND $value['val_id']!=5018 AND $value['val_id']!=5068 AND $value['val_id']!=5130 AND $value['val_id']!=5159 
                                                                           // AND $value['val_id']!=5099 AND $value['val_id']!=5181 AND $value['val_id']!=5132 
                                                                           ...
                                                                           <tr class="hdr singleline txtBlk" title="<?php echo $value['val_id'] . '-' . $value['prd_valuation_id']; ?>">
                                                                                ...
                                                                                <td><?php //echo $value['val_id'] ?><?php echo $value['brd_title'] ?> </td> 
                                                                                ...
                                                                                <td><?php echo unserialize(FUAL)[$value['val_fuel']] ?>  </td>              
                                                                                <td><?php echo $value['val_minif_year'] ?>  </td>  
                                                                                <td><?php echo $value['val_manf_date'] ?>  </td>  
                                                                                <td><?php echo strtoupper($value['reg_no']);//$value['val_veh_no'] ?>  </td> 
