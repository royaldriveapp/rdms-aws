...
<th style="background-color: #1f487c; color: white;">HV Pending</th>
				...
				?>
										...
										<tr>
											...
											?>
											<td><?= $sales_consultant->usr_id ?> - <?= $sales_consultant->usr_username ?></td>
                                            ...
                                            <td><?= findPercentage($sales_consultant->home_visit_hot_plus_achieved_count,0,$sales_consultant->home_visit_hot_plus_count)?></td>
                                            <td><?= $sales_consultant->home_visit_hot_plus_achieved_count ?: '' ?></td>
                                            <td><?= $sales_consultant->home_visit_hot_plus_count-$sales_consultant->home_visit_hot_plus_achieved_count ?: '' ?></td>

                                            <td><?= $sales_consultant->home_visit_hot_count ?: '' ?></td>
                                            <td><?= findPercentage($sales_consultant->home_visit_hot_achieved_count,0,$sales_consultant->home_visit_hot_count)?></td>
                                            <td><?= $sales_consultant->home_visit_hot_achieved_count ?: '' ?></td>
                                            <td><?= $sales_consultant->home_visit_hot_count-$sales_consultant->home_visit_hot_achieved_count ?: '' ?></td>
                                            <td><?= $sales_consultant->home_visit_warm_count ?: '' ?></td>
                                            <td><?= $sales_consultant->home_visit_cold_count ?: '' ?></td>
                                            <td><?= $sales_consultant->home_visit_hot_plus_achieved_count+$sales_consultant->home_visit_hot_achieved_count+$sales_consultant->home_visit_warm_achieved_count+$sales_consultant->home_visit_cold_achieved_count ?: 0 ?></td>
...
$hot_hmv_pending=$total_count_info['home_visit_hot_count']-$total_count_info['home_visit_hot_achieved_count'];
				...
				<?php
					...
					if ($is_empty_sales_consultant == false) {
                        $total_hmv_hot_plus_pending=$info['home_visit_hot_plus_count']-$info['home_visit_hot_plus_achieved_count'];
                        $total_hmv_hot_pending=$info['home_visit_hot_count']-$info['home_visit_hot_achieved_count'];
                ...
                <td style="background-color: #E2E0ED;">' . ($info['home_visit_hot_plus_count'] ?: '') . '</td>
                <td style="background-color: #E2E0ED;">' . findPercentage($info['home_visit_hot_plus_achieved_count'],0,$info['home_visit_hot_plus_count']) . '</td>
                <td style="background-color: #E2E0ED;">' . ($info['home_visit_hot_plus_achieved_count'] ?: 0) . '</td>
                <td style="background-color: #E2E0ED;">' . @$total_hmv_hot_plus_pending. '</td>
             
                <td style="background-color: #E2E0ED;">' . ($info['home_visit_hot_count'] ?: 0) . '</td>
                <td style="background-color: #E2E0ED;">' . findPercentage($info['home_visit_hot_achieved_count'],0,$info['home_visit_hot_count']) . '</td>
                <td style="background-color: #E2E0ED;">' . ($info['home_visit_hot_achieved_count'] ?: 0) . '</td>
                <td style="background-color: #E2E0ED;">' . @$total_hmv_hot_pending. '</td>

                <td style="background-color: #E2E0ED;">' . ($info['home_visit_warm_count'] ?: 0) . '</td>
                <td style="background-color: #E2E0ED;">' . ($info['home_visit_cold_count'] ?: 0) . '</td>
                <td style="background-color: #E2E0ED;">' . ($info['home_visit_done'] ?: 0) . '</td>
                
       
                <td style="background-color: #d9d7e3;">' . ($info['pending_reg'] ?: 0) . '</td>
                <td style="background-color: #d9d7e3;">' . ($info['missed_followup_count'] ?: 0) . '</td>
                <td style="background-color: #d9d7e3;">' . ($info['booking_enq'] ?: 0) . '</td>
        ...
        <td></td>
        <td>' . ($total_count_info['home_visit_hot_plus_count'] ?: 0) . '</td>
        <td>' . findPercentage($total_count_info['home_visit_hot_plus_achieved_count'],0,$total_count_info['home_visit_hot_plus_count']) . '</td>
        <td>' . ($total_count_info['home_visit_hot_plus_achieved_count'] ?: 0) . '</td>
        <td>' .    $hot_plus_hmv_pending  . '</td>
        <td>' . ($total_count_info['home_visit_hot_count'] ?: 0) . '</td>
        <td>' . findPercentage($total_count_info['home_visit_hot_achieved_count'],0,$total_count_info['home_visit_hot_count']) . '</td>
        <td>' . ($total_count_info['home_visit_hot_achieved_count'] ?: 0) . '</td>
        <td>' .    $hot_hmv_pending  . '</td>
        <td>' . ($total_count_info['home_visit_warm_count'] ?: 0) . '</td>
        <td>' . ($total_count_info['home_visit_cold_count'] ?: 0) . '</td>
        <td>' . ($total_count_info['home_visit_done'] ?: 0) . '</td>
      
        <td>' . ($total_count_info['pending_reg'] ?: 0) . '</td>
        <td>' . ($total_count_info['missed_followup_count'] ?: 0) . '</td>
        <td>-' . ($total_count_info['booking_enq'] ?: 0) . '</td>
