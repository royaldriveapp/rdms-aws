...
<table id="myTable">
    ...
    ?>
                            ...
                            <tr>
                                ...
                                <td style="background-color: #E2E0ED;"> <a href="<?php echo site_url('reports/re_assign_ftd/' . $sales_consultant->usr_id.'/'.$date);?>"> <?= $sales_consultant->today_count ?: '' ?> </a> </td>



                                <td><a href="<?php echo site_url('reports/re_assign_mtd/' . $sales_consultant->usr_id.'/'.$date); ?>"> <?= $sales_consultant->this_month_count ?: '' ?> </a></td>
