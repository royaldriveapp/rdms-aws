        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content" style="overflow-x: auto;">
                    ...
                    <table id="myTable">
                        <tr class="header-row">
                            <th rowspan="2" style="background-color: #B9DDEB;">PM</th>
                            <th rowspan="2" style="background-color: #B9DDEB;">APM</th>
                            <th rowspan="2" style="background-color: #B9DDEB;">FTD</th>
                            <th rowspan="2" style="background-color: #B9DDEB;">MTD</th>
                            <th rowspan="2" style="background-color: #B9DDEB;">Purchase Consultant</th>
                            ...
                            foreach ($sales_managers as $sales_manager_key => $sales_manager) {
                                if (!empty($sales_manager->asm)) {
                                    foreach ($sales_manager->asm as $asm_key => $asm) {
                                       $asmData = $this->reports->getAsmData($asm->usr_id);
