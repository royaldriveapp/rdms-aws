                        ...
                        <tbody>
                            <?php if (!empty($pendingRegister['yesterday'])) {
                                foreach ($pendingRegister['yesterday'] as $key => $value) { ?>
                                    <tr data-url="<?php echo site_url('reports/registerPendingByUserDetails/' . $value['vreg_assigned_to'] . '/1'); ?>">
                                        <td class="trVOE"><?php echo $value['assign_usr_first_name']; ?></td>
                                        <td class="trVOE"><?php echo $value['cnt']; ?></td>
                                    </tr>
                                    <?php
                                }
                            }
                        ...
                        <tbody>
                            <?php if (!empty($pendingRegister['today'])) {
                                foreach ($pendingRegister['today'] as $key => $value) { ?>
                                    <tr data-url="<?php echo site_url('reports/registerPendingByUserDetails/' . $value['vreg_assigned_to']); ?>">
                                        <td class="trVOE"><?php echo $value['assign_usr_first_name']; ?></td>
                                        <td class="trVOE"><?php echo $value['cnt']; ?></td>
                                    </tr>
                                    <?php
