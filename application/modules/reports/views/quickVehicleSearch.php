                         ...
                         <form action="<?php echo site_url('reports/quickVehicleSearch/');?>" method="get">
                              <table>
                                   ...
                                   <tr>
                                        ...
                                        <td style="padding-left: 10px;">
                                             <select name="veh_category" class="form-control col-md-7 col-xs-12">
                                                  <option value="">Select Veh Category</option>
                                                  <option value="1" <?php echo (isset($_GET['veh_category']) && $_GET['veh_category'] == 1) ? 'selected="selected"' : ''; ?>>Four wheeler</option>
                                                  <option value="2" <?php echo (isset($_GET['veh_category']) && $_GET['veh_category'] == 2) ? 'selected="selected"' : ''; ?>>Two wheeler</option>
                                             </select>
                                        </td>
                                        <td style="padding-left: 10px;">
                                                            ...
                                                            <td style="padding-left: 10px;">
                                                                      <select multiple="multiple" style="float: left;width: auto;" class="muliSelectCombo select2_group form-control cmbSalesExecutives" name="executive[]">
                                                                           ...
                                                                           foreach ((array) $teleCallers as $key => $value) {
                                                                                ...
                                                                                ?>
                                                                                <option value="641">Reshma</option>
                                                                      </select>
                                                                 </td>
                                                            </tr>
                                                            <tr>
