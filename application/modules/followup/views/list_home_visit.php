                    ...
                    <div class="x_content">
                         <form method="get">
                              <table>
                                   <tr>
                                        <td>
                                             <input autocomplete="off" name="hmv_date_from" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" placeholder="Requested date from" value="<?php echo $hmv_date_from; ?>" />
                                        </td>
                                        <td style="padding-left: 10px;">
                                             <input autocomplete="off" name="hmv_date_to" type="text" class="dtpEnquiry form-control col-md-7 col-xs-12" placeholder="Requested date to" value="<?php echo $hmv_date_to ?>" />
                                        </td>
                                        <td style="padding-left: 10px;">
