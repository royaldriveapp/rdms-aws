                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr style="<?php echo ($value['vreg_status'] == 0) ? 'color: #fff;background-color: red;' : ''; ?>"
                                    ...
                                    <?php } ?>
                                    <td class="<?php echo $trVOE; ?>"><?php echo $value['cusd_name']; ?></td>
                                    <td>
                                    <?php if (!empty($value['cusd_whatsapp'])): ?>
                                        <a style="<?php echo ($value['vreg_status'] == 0) ? 'color: #fff;background-color: red;' : ''; ?>"
                                            <?php echo 'href="https://api.whatsapp.com/send?phone=' . $value['cusd_whatsapp'] . '"'; ?>>
                                            <i class="fa fa-whatsapp" style="color: #25D366; margin-right: 5px;"></i> <?php echo $value['cusd_whatsapp']; ?></a>
                                            <?php endif; ?>
                                    </td>
                                    <td>
...
?>
                                    ...
                                    <td class="<?php echo $trVOE; ?>"><?php echo $value['cusd_place']; ?></td>
                                    <td class="<?php echo $trVOE; ?>">
                                        <?php
