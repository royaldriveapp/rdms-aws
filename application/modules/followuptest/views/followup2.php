<div class="right_col" role="main">
     <?php
     // $color = $this->followup->getColors(2);
    // $otherState = $this->followup->getStates(2);
    //$rto = $this->followup->getRto(2);
    $travel_mods = $this->followup->getTravelModes();
     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    <div class="x_title">
                         <h2>Follow up details of2 <?php echo $vehicles['enq_cus_name']; ?> </h2>
                         &nbsp;
                         <?php if (check_permission('purchase', 'add')) { ?>
                              <a href="<?php echo site_url('purchase/create/' . encryptor($vehicles['enq_id'])); ?>" class="btn btn-success"> <i class="fa fa-plus"></i> Purchase</a>
                         <?php } ?>
                         ...
                         <ul class="nav navbar-right panel_toolbox">
                              <li class="dropdown" style="float: right;">
                                   ...
                                   <ul class="dropdown-menu" role="menu">
                                        <li><a target="blank" href="<?php echo site_url('enquiry/printTrackCard/' . encryptor($vehicles['enq_id'])); ?>">View
                                                  tracking card</a></li>
                                        <?php if ($this->usr_grp == 'SE' || $this->usr_grp == 'TC') {
                                             if ($vehicles['enq_se_id'] == $this->uid) {
                                        ?> <li><a target="blank" href="<?php echo site_url('enquiry/view_change/' . encryptor($vehicles['enq_id'])); ?>">Edit
                                                            enquiry</a></li>
                                             <?php
                                             }
                                        } else { ?>
                                   ...
                                   <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                             <div class="form-horizontal form-label-left">
                                                  <form id="form-step-0" class="frmFlupEnquiryQuestion" role="form" data-toggle="validator" data-url="<?php echo site_url($controller . '/editEnquiryQuestions'); ?>">
                                                       ...
                                                       <div>
                                                            ...
                                                            ?>
                                                                 <div class="form-group">
                                                                      <label for="enq_cus_address" class="control-label col-md-6 col-sm-6 col-xs-12" style="font-size: 10px;">
                                                                      ...
                                                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                                                           ...
                                                                           <?php } else { // Text box 
                                                                           ?>
                                                                                <textarea autocomplete="off" <?php echo $required; ?> id="enq_cus_need" class="form-control col-md-7 col-xs-12" type="text" name="questions[<?php echo $value['qus_id']; ?>][<?php echo $enqQuesId; ?>]"><?php echo $answer; ?></textarea>
                                                                           <?php } ?>
                              ...
                              <div class="panel panel-default">
                                   <?php if (check_permission('booking', 'takebooking')) { ?>
                                        <div class="panel-heading">
                                             <div>Customer details <button data-url="<?php echo site_url('booking/reserveVehicleView/' . encryptor($vehicles['enq_id'])); ?>" class="btnBookingForm btn btn-primary">Reserve</button></div>
                                             <div class="divBookingForm"></div>
                                        </div>
                                   <?php } ?>
                                   <div class="panel-body">
                                        <ul class="list-group">
                                             <li class="list-group-item" style="font-size: 15px; font-weight: bolder; text-align: center;">Customer :
                                                  <?php echo $vehicles['enq_cus_name']; ?></li>
                                             <li class="list-group-item" style="font-size: 15px;font-weight: bolder; text-align: center;">Mobile :
                                                  <?php echo $vehicles['enq_cus_mobile']; ?></li>
                                             <li class="list-group-item" style="font-size: 15px;font-weight: bolder; text-align: center;">Sales Executive
                                        ...
                                        <div class="panel-body">
                                             ...
                                             ?>
                                                  <form id="demo-form2" method="post" action="<?php echo site_url('followup/changeStatus'); ?>" data-parsley-validate class="form-horizontal form-label-left frmVehicleStatus">
                                                       ...
                                                       <input type="hidden" name="pool_id" value="<?php echo isset($_GET['p']) ? $_GET['p'] : ''; ?>" />
                                                       <div class="form-group">
                                                            <?php if ($this->uid == 100) { ?>
                                                                 <div class="col-md-12 col-sm-6 col-xs-12">
                                                                      <select class="select2_group form-control cmbFollStatus" name="enh_status" required="required">
                                                                           ...
                                                                           <?php foreach ((array) $statuses as $key => $value) { ?>
                                                                                <option data-slug="<?php echo $value['sts_slug']; ?>" value="<?php echo $value['sts_value']; ?>">
                    ...
                    <div class='flds'>
                         <div class="row">
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="brand" id="var_brand_id" class="form-control col-md-7 col-xs-12 bindToDropdown" data-bind="cmbModel" data-dflt-select="Select Model" data-url="<?php echo site_url('enquiry/bindModel'); ?>">
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="model" id="var_brand_id" data-bind="cmbEvVariant" data-dflt-select="Select Model" data-url="<?php echo site_url('enquiry/bindVarient'); ?>" class="form-control col-md-7 col-xs-12 cmbModel bindToDropdown"></select>
                                   </div>
                              </div>
                              <div class="form-group">
                    ...
                    <div class='flds'>
                         ...
                         <div class="row company_vehicle vehicle" style="display:none">
                              ...
                              <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                   ...
                                   <select class="com_veh cmbSearchList select2_group form-control cmbStockj form-control col-md-7 col-xs-12" name="hmv_veh_comp">
                         ...
                         <div class="row stock_vehicle vehicle" style="display:none">
                              ...
                              <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                   ...
                                   <select class="stk_veh cmbSearchList select2_group form-control cmbStockj form-control col-md-7 col-xs-12" name="hmv_veh_stock">
                                        <option value="0">Select Vehicle</option>
                                        <?php
                         ...
                         <div class="row">
                              ...
                              <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                   ...
                                   <select name="hmv_travel_with" id="travel_with" class="sumoSearchListj select2_groupj form-control cmbStockj form-control col-md-7 col-xs-12">
                         ...
                         <div class="row">
                              <div class="form-group col-md-3 col-sm-3 col-xs-6">
                                   ...
                                   <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerHmVstDMY" name="hmv_date" id="date" placeholder="Date" autocomplete="off">
                              </div>
                              <div class="form-group col-md-3 col-sm-3 col-xs-6">
                              ...
                              <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                   ...
                                   <input required type="text" class="form-control col-md-7 col-xs-12" id="pac-input" name="hmv_place" placeholder="Enter Place" autocomplete="off">
                                   ...
                                   <input type="hidden" name="hmv_cust_status" value="<?php echo isset($vehicles['enq_cus_when_buy']) ? $vehicles['enq_cus_when_buy'] : 0; ?>">
...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyDPVCcSKQ-MtW2t0pYsimh5rvQSuUOUm7g">
</script>
<script>
