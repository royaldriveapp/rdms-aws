                                   ...
                                   <div id="step-1" class="">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 dtpDatePickerEvaluation" 
                                                                   value="<?php echo $vehicles['val_reg_date'];?>"
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12" required
                                                                   value="<?php echo $vehicles['val_color'];?>"
                                        ...
                                        <div class="row">
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tr>
                                                       <td>Comprehensive</td>
                                                       <td><input value="<?php echo $vehicles['val_insurance_comp_date'];?>" placeholder="Valid UP to (comprehensive)" 
                                        ...
                                        <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <input value="<?php echo!empty($vehicles['val_last_service']) ? date('d-m-Y', strtotime($vehicles['val_last_service'])) : '';?>" name="valuation[val_last_service]" 
                                                                        id="val_last_service" type="text" class="form-control dtpDatePicker" style="width: 100%;"/>
                                                            </td>
                                             ...
                                             <div class="row">
                                                  <table class="table table-striped table-bordered">
                                                       <thead>
                                                            <tr>
                                                                 <th style="text-align: center;font-size: 20px;" colspan="10">Up-gradation Details
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <input value="<?php echo $vehicles['val_battery_year'];?>" required class="form-control numOnly" type="text" id="val_tyre_2_wek" name="valuation[val_battery_year]" placeholder="Year"/>
                                                            </td>
                                                            <td class="td-head"> Description</td>
                                                            <td>
                                                                 <input value="<?php echo $vehicles['val_battery_desc'];?>" required class="form-control" type="text" id="val_tyre_1_wek" name="valuation[val_battery_desc]" placeholder="Description">
                                                            </td>
                                                       </tr>
                                                  </tbody>
                                             </table>
                                             ...
                                             <table class="table table-striped table-bordered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                         ...
                                                         <div class="form-group">
                                                              <?php foreach ($vehicles['complaints'] as $key => $value) {?>
                                                                   <div class="col-md-2 col-sm-6 col-xs-12">
                                                                        <div class="input-group">
                                                                             <?php echo img(array('src' => '../assets/uploads/evaluation/' . $value['comp_pic'], 'height' => '80', 'width' => '100', 'id' => 'imgBrandImage'));?>
                                                                        </div>
                                                                        <?php if ($value['comp_pic']) {?>
                                                                             <span class="help-block">
                                                                                  <a  data-url="<?php echo site_url($controller . '/removeImage/' . $value['comp_id']);?>" href="javascript:void(0);" style="width: 100px;" 
                                                              ...
                                                              <div class="gallery deleteRow<?php echo $value['vdoc_id'];?> col-md-6 col-sm-6 col-xs-12" style="padding: 10px;">
                                                                   <a target="_blank" href="javascript:;">
                                                                        ...
                                                                        if (is_image($value['vdoc_doc'])) {
                                                                             echo img(array('class' => 'img', 'src' => '../assets/uploads/evaluation/' . $value['vdoc_doc'], 'style' => "width:200px;float:left;"));
                                                                        } else {
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div class="frame01 dropzone" id="fileupload" action="<?= base_url('evaluation/uploadFile?frame=1')?>">
                                                            <?php if (!empty($img)) {?>
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div class="frame02 dropzone" action="<?= base_url('evaluation/uploadFile?frame=2')?>" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div class="frame03 dropzone" id="fileupload" action="<?= base_url('evaluation/uploadFile?frame=3')?>">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=4')?>" class="frame04 dropzone" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=5')?>" class="frame05 dropzone" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=6')?>" class="frame06 dropzone" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=7')?>" class="dropzone frame07" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=8')?>" class="dropzone frame08" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=9')?>" class="dropzone frame09" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=10')?>" class="dropzone frame10" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=11')?>" class="dropzone frame11" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                                  ...
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=12')?>" class="dropzone frame12" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
                                             ...
                                             <div class="form-group divFile">
                                                  <div class="content">
                                                       ...
                                                       ?>
                                                       <div action="<?= base_url('evaluation/uploadFile?frame=13')?>" class="dropzone frame13" id="fileupload">
                                                            <?php if (!empty($img)) {?>
                                                                   <div style="position: relative;" class="deleteRow<?php echo $imgId;?>">
                                                                        <?php
                                                                        echo img(array('src' => '../assets/uploads/evaluation/vehicle/' . $img, 'width' => "286", 'height' => "296"));
