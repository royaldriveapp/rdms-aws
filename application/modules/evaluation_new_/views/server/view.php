                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <select <?php //echo ($readOnly == 1) ? 'disabled' : '';?> 
                                                                 class="select2_group form-control" name="valuation[val_added_by]" id="shr_added_by">
                                                                 <option value="">Select Evaluator</option>
                                                                 <?php
                                                                   if (!empty($evaluators)) {
                                                                        foreach ($evaluators as $key => $value) {
                                                                             ?>
                                                                             <option <?php echo ($vehicles['val_added_by'] == $value['col_id']) ? 'selected="selected"' : '';?>
                                             ...
                                             <div class="col-sm-12">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="col-md-9 col-sm-6 col-xs-12">
                                                            <input type="text" class="form-control col-md-7 col-xs-12"
                                                                   name="valuation[val_rc_owner]" value="<?php echo $vehicles['val_rc_owner'];?>" 
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td colspan="4">
                                                                 <input type="text" class="form-control dtpDatePickerEvaluation" style="width: 100%;" 
                                                                        value="<?php echo $vehicles['val_next_serv_date'];?>"
                                                  ...
                                                  <tbody class="tbDamages">
                                                       <?php if ($vehicles['complaints']) {?>
                                                              <?php foreach ($vehicles['complaints'] as $comkey => $comvalue) {?>
                                                                   <tr>
                                                                        <td>
                                                                             <?php echo img(array('src' => '../assets/uploads/evaluation/' . $comvalue['comp_pic'], 'height' => '80', 'width' => '100', 'id' => 'imgBrandImage'));?>
                                                                        </td>
                                                                        <td><?php echo $comvalue['comp_complaint'];?></td>
                                                                        <td>
                                                                             <a  data-url="<?php echo site_url($controller . '/deleteImage/' . encryptor($comvalue['comp_id']));?>" href="javascript:void(0);" style="width: 100px;" 
