     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <div class="x_content">
                         <table id="voxbayInvestorCallList" class="table table-striped table-bordered">
                              <thead>
                                   <tr>
                                        <th>Date</th>
                                        <th>DID</th>
...
<script>
     $(document).ready(function () {
          $('#voxbayInvestorCallList').dataTable({
               "order": [],
               "processing": true,
               "serverSide": true,
               'serverMethod': 'post',
               "ajax": "<?php echo site_url($controller . '/fetchData'); ?>",
               ...
               'columns': [
                    ...
                    },
                    {
                         sortable: false,
                         "render": function (data, type, full, meta) {
                              var url = site_url + "investors/newContribution/" + full.ccb_id;
