               ...
               <div class="x_panel">
                    ...
                    <div class="x_content">
                         ...
                         <div class="form-group">
                              <label for="usr_showroom" class="control-label col-md-3 col-sm-3 col-xs-12">Role*</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                             <input required type="text" class="form-control col-md-7 col-xs-12 " name="rol_name" autocomplete="off" placeholder="Enter role name" >
                                                                 
                              </div>
                         </div>

                         <div class="form-group">
                              <label for="usr_showroom" class="control-label col-md-3 col-sm-3 col-xs-12">Copy role</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                   <?php if (!empty($roles)) { ?>
                                   <select class="select2_group form-control cmbRole" data-url="<?php echo site_url('user_permission/getRolePermission'); ?>">
