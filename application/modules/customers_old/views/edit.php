                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control cusd_gender" name="cusd_gender">
                                            <option value="0">- Select -</option>
                                            <option value="1" <?php echo ($customer['cusd_gender'] == 1) ? 'selected' : ''; ?>>Male</option>
                                            <option value="2" <?php echo ($customer['cusd_gender'] == 2) ? 'selected' : ''; ?>>Female</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" class="form-control col-md-7 col-xs-12" name="cusd_company" id="cusd_company" autocomplete="off" placeholder="Company" value="<?php echo isset($customer['cusd_company']) ? $customer['cusd_company'] : ''; ?>" />
                                    </div>
                                </div>
