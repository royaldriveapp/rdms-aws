     ...
     <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                    ...
                    <div class="x_content">
                    <div class="columns">
                    <?php echo form_open_multipart("grid/calcGrid", array('id' => "calc_grid", 'class' => "calcGrid")) ?>
  ...
  <ul class="price">
    ...
    <li class="grey"> <?php //if (isset($model) && !empty($model)) {?>
        ...
        <select required="true" style="float: center;width: 100%;" class="select2_group form-control" 
                                                ...
                                                <li class="grey">
                                                <select required="true" style="float: center;width: 100%;" id="owner" class="select2_group form-control" 
                                                  name="owner" id="owner">
    ...
    <li class="grey">Grid Price Kerala: <span id="price"></span> </li>
    <li class="grey">Years:<span id="years"></span> </li>


    <li class=""><button type="submit" class="button">Submit</button></li>
  </ul>
  <?php echo form_close() ?>
</div>
