        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                        ...
                        <li class="dropdown open" style="float: right;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php if (check_permission('booking', 'editbooking')) { ?>
                                    <li>
                                        <a title="Update booking" href="<?php echo site_url('booking/editBooking/' . encryptor($bookingDetails['vbk_id'])); ?>">
                                            <i title="Update booking" class="fa fa-pencil"></i> Update
                                        </a>
                                    </li>
                                <?php } ?>
                                <li>
                                    <a title="Print OBF" href="<?php echo site_url('booking/print_obf/' . encryptor($bookingDetails['vbk_id'])); ?>">
                ...
                <div class="x_content">
                    ...
                    <form method="post" action="<?php echo site_url('booking/decisionMaking'); ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        |
                                        <a target="blank" href="<?php echo site_url('followup/viewFollowup/' . encryptor($bookingDetails['vbk_enq_id'])); ?>">
                                        ...
                                        <tr class="trBokDocs">
                                            ...
                                            <td>
                                                <?php if (!empty($value['vbd_doc_file'])) { ?>
                                                    <a target="_blank" file="<?php echo $value['vbd_doc_file']; ?>" href="<?php echo '../../assets/uploads/documents/booking/' . $value['vbd_doc_file']; ?>">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (check_permission('booking', 'allowconfirmbooking')) { ?>
                                                <input required type="text" class="txtVehiclePrice decimalOnly" name="vbk_vehicle_amt" value="<?php echo $bookingDetails['vbk_vehicle_amt']; ?>" id="mod_title" placeholder="Vehicle sold price" />
                                            <?php } else {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (check_permission('booking', 'allowconfirmbooking')) { ?>
                                                <input required type="text" class="txtAdvanceAmt decimalOnly" name="vbk_advance_amt" value="<?php echo $booking['vbk_advance_amt']; ?>" id="mod_title" placeholder="Advance Amount" />
                                            <?php } else {
                        ...
                        <input type="hidden" name="vbk_evaluation_veh_id" value="<?php echo $bookingDetails['vbk_evaluation_veh_id']; ?>" />
                        <input type="hidden" name="val_stock_num" value="<?php echo $bookingDetails['val_stock_num']; ?>" />
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-sm-6 col-xs-12">
                                <textarea required type="text" class="form-control col-md-7 col-xs-12" name="confim[vbc_verify_desc]" placeholder="Description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <?php if (($bookingDetails['vbk_status'] == vehicle_booked) && (check_permission('booking', 'allowconfirmbooking'))) { ?>
                                    <button value="<?php echo confm_book; ?>" name="status" type="submit" class="btnSubmit btn btn-success">Verify booking</button>
                                    <!-- <input type="hidden" name="status" value="<?php //echo confm_book; 
                                                                                    ?>" /> -->
                                <?php } else if (check_permission('booking', 'allowrejectbooking')) { ?>
                                    <button value="<?php echo reject_book; ?>" name="status" type="submit" class="btn btn-danger">Reject booking</button>
                                    <!-- <input type="hidden" name="status" value="<?php //echo reject_book; 
                                                                                    ?>" /> -->
                                <?php } else if (($bookingDetails['vbk_status'] == confm_book) && check_permission('booking', 'allowdeliverybooking')) { ?>
                                    <input type="text" placeholder="Delivery Date" name="confim[vbk_delivery_date]" class="dtpDatePicker form-control col-md-7 col-xs-12" />
                                    <button value="<?php echo book_delvry; ?>" name="status" type="submit" class="btn btn-primary">Vehicle delivered</button>
                                ...
                                if (check_permission('booking', 'allowcancelbooking')) { ?>
                                    <!-- <input type="hidden" name="status" value="<?php //echo cancl_book; 
                                                                                    ?>" /> -->
                                    <button value="<?php echo cancl_book; ?>" name="status" type="submit" class="btn btn-group">Cancel booking</button>
                                <?php } ?>
                            </div>
                        </div>
                    </form>
