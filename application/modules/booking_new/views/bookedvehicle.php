                              ...
                              <tbody>
                                   ...
                                   foreach ((array) $bookedVehicle as $key => $value) {
                                        ...
                                        <tr data-url="<?php echo $url; ?>">
                                             ...
                                             <td style="<?php echo $trColor; ?>" class="trVOE"><?php echo date('j M Y h:i A', strtotime($value['vbk_added_on'])); ?></td>
                                             ...
                                             <td style="<?php echo $trColor; ?>" title="<?php echo $value['rfi_sts_title']; ?>" class="trVOE"><?php echo $value['rfi_sts_title']; ?></td>
