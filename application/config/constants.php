...
define('EVALUATION_TYPES', serialize(array('1' => 'Own', '4' => 'Park and sale with dealer', '3' => 'Park and sale with customer', '5' => 'Exchange', '6' => 'Buy back', '7' => 'Sales return', '8' => 'Conditional purchase')));
...
define('lostDrop', serialize(array(
  ...
  '2' => 'Lost to New Car Dealer',
  '3' => 'Customer Shifted to Other Country',
  '4' => 'Took Used Car from Friend',
  //'5' => 'Took Used Car from Friend',
  '6' => 'Took Used Car from Third Party',
  '7' => 'Customer Not at all Interested',
  // '8' => 'Transferred to Smart Section',
  '9' => 'Pricing',
  '10' => 'Duplicate Entry',
  '13' => 'Preferred stock not available',
  '14' => 'No response from customer',
  '15' => 'Invalid number',
  '16' => 'Plan postponed',
  '12' => 'Others'
))); //jsk
...
define('SERVICE_STATION', serialize(array(
  ...
  '20' => 'Automall (MPM)',
  '21' => 'Pro colour (COK)',
  '22' => 'New Bharat tyres (COK)',
  '23' => 'Mark Audio (COK)',
  '24' => 'Audi Kochi (COK)',
  '25' => 'Volvo kochi (COK)',
  '26' => 'EVM BMW (COK)',
  '27' => 'Global tyres (COK)',
  '28' => 'DX auto Detailers (COK)'
)));
define('FINE_CATEGORY', serialize(array(1 => 'MVD', 2 => 'Police', 3 => 'Challan', 4 => 'e-court', 5 => 'Camera')));
define('WEB_FORM_ENQ_TYPE', serialize(array('1' => 'Sales', '2' => 'Purchase', '3' => 'Exchange', 'RD Care (Service)')));
define('insurance_company', serialize([
  '1' => 'Bajaj Allianz General Insurance Company Limited',
  '2' => 'Bharti AXA General Insurance Company Limited',
  '3' => 'Future Generali India Insurance Company Limited',
  '4' => 'Go Digit General Insurance Limited',
  ...
  '8' => 'Kotak Mahindra General Insurance Company Limited',
  '9' => 'National Insurance Company Limited',
  '10' => 'New India Assurance Company Limited',
...
define('DRIVE_TRAINS', serialize(array(
