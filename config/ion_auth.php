<?php
  ...
  /*
    ...
    |
   */
  $config['collections']['users'] = TABLE_PREFIX . 'users';
  $config['collections']['groups'] = TABLE_PREFIX . 'groups';
  $config['collections']['login_attempts'] = TABLE_PREFIX . 'login_attempts';
  ...
  $config['tables']['user_access'] = TABLE_PREFIX . 'user_access';
  ...
  $config['identity'] = 'usr_email';             // A database column which is used to login with
